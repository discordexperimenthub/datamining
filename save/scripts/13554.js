    ...
    162848: function (e, t, s) {
      ...
      let P = e => {
          let { avatarDecoration: t } = e,
            s = (0, u.useStateFromStores)([p.default], () =>
              p.default.getCurrentUser()
            ),
            { avatarDecorationSrc: l } = (0, c.default)({
              user: s,
        ...
        g = e => {
          ...
          let {
            ...
            title: d,
          } = null !== (t = null == a ? void 0 : a.config) && void 0 !== t
            ? t
            : {};
          return (0, n.jsxs)("div", {
            ...
            children: [
              ...
              (0, n.jsx)("img", { className: N.profileEffect, src: o, alt: d }),
            ],
          });
        };
      var O = e => {
        let { selectedSkuId: t, selectedSkuPricePreview: s, className: l } = e,
          { product: a } = (0, C.useFetchCollectiblesProduct)(t),
          { giftRecipient: d, giftRecipientError: c } = (0, S.useGiftContext)(),
          E = (0, u.useStateFromStores)([p.default], () =>
            p.default.getCurrentUser()
          );
        if (null == a || null == s) return null;
        let [I] = a.items,
          h = null != d && d.id !== (null == E ? void 0 : E.id);
        return (0, n.jsxs)("div", {
          className: l,
          children: [
            (0, n.jsxs)("div", {
              ...
              children: [
                ...
                h &&
                  (0, n.jsx)(
                    ...
                    {
                      preload: () =>
                        (0, _.default)(d.id, d.getAvatarURL(null, 80)),
                      renderPopout: e =>
                        (0, n.jsx)(f.default, {
                          ...e,
                          user: d,
                          ...
                          pendingAvatarDecoration:
                            I.type === r.CollectiblesItemType.AVATAR_DECORATION
                              ? I
                              : null,
                          pendingProfileEffectId:
                            I.type === r.CollectiblesItemType.PROFILE_EFFECT
                              ? I.id
                              : null,
            ...
            (0, n.jsxs)("div", {
              ...
              children: [
                I.type === r.CollectiblesItemType.AVATAR_DECORATION &&
                  (0, n.jsx)(P, { avatarDecoration: I }),
                I.type === r.CollectiblesItemType.PROFILE_EFFECT &&
                  (0, n.jsx)(g, { profileEffect: I }),
                (0, n.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, n.jsx)(o.Heading, {
                      ...
                      children:
                        I.type === r.CollectiblesItemType.AVATAR_DECORATION
                          ? A.default.Messages.USER_SETTINGS_AVATAR_DECORATION
                          : I.type === r.CollectiblesItemType.PROFILE_EFFECT
                            ? A.default.Messages.USER_SETTINGS_PROFILE_EFFECT
                            : null,
                    }),
                  ],
                }),
        ...
        f = e => {
          let { selectedSkuId: t, className: s } = e,
            ...
            E = (0, l.useStateFromStoresArray)(
              [o.default],
              () => o.default.filter(e => f.includes(e.id) && !e.bot),
              [f]
            ),
            {
              giftRecipient: I,
...
//# sourceMappingURL=bdd648cd50124d1d8c22.js.map
