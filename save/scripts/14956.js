    ...
    145079: function (e, t, n) {
      ...
      var E = e => {
        ...
        return (0, i.jsx)(c.default, {
          ...
          botType: v(n),
          botVerified: n.isVerifiedBot(),
          discriminator: m || _ !== C ? null : null != u ? u : n.discriminator,
          ...h,
        });
      };
    },
      ...
      var i = n("37983"),
        ...
        a = s.memo(function (e) {
          ...
          let {
            ...
            v = s.useContext(l.default);
          return (0, i.jsx)(r.Avatar, {
            src:
              ((t = u),
              (n = (0, r.getAvatarSize)(c)),
              (a = d),
              (o = v),
        ...
        v = e => {
          let [t, n] =
              e instanceof l.default
                ...
                : h(e),
            [s, u, v, p] = (0, r.useStateFromStoresArray)([a.default], () => [
            ...
            m = i.useCallback(e => f(e, E, u, s), [s, u, E]),
    ...
    300322: function (e, t, n) {
      ...
      function _(e) {
        let t = (0, l.useStateFromStores)(
          ...
          () =>
            h.default.can(
              r.default.combine(E.Permissions.CREATE_PRIVATE_THREADS),
              e
            ),
          [e]
        );
      ...
      function T(e) {
        return (0, l.useStateFromStoresObject)([p.default, h.default], () => {
          let t = p.default.getActiveJoinedThreadsForParent(e.guild_id, e.id),
            ...
            a = s(i).some(e => h.default.can(E.Permissions.VIEW_CHANNEL, e));
          return {
      ...
      let h = {
        ...
        v = e => {
          let {
            ...
            g = t;
          if ((!0 === C ? (g = h.DOWN) : !1 === C && (g = h.RIGHT), _)) {
            let e = {
...
//# sourceMappingURL=d5ae0de818d362c9b343.js.map
