(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["1727"],
  {
      ...
      let r = null,
        ...
        o = (e, t) => {
          ...
          let C = {
            ...
            avatarDecoration:
              null != c.avatarDecoration ? { ...c.avatarDecoration } : void 0,
            premiumSince:
    ...
    341329: function (e, t, n) {
      ...
      function D(e) {
        ...
        T.AttachmentLinkRefreshExperiment.getCurrentConfig({
          ...
          _.some(S.messageHasExpiredAttachmentUrl) &&
          (R.log("Found expired attachment link, clearing messages"),
          c.default.clear(n),
          (_ = c.default.getOrCreate(n))),
          null != _.jumpTargetId &&
            null == a &&
            ((_ = _.mutate({
              jumpTargetId: null,
          ...
          null != _.focusTargetId &&
            null == a &&
            ((_ = _.mutate({ focusTargetId: null })), c.default.commit(_));
        let m = i;
        if (
          (!d || E.default.isConnected() || _.loadingMore
          ...
          if ((c.default.commit(_.mutate({ loadingMore: !0 })), null != a))
            ...
            (function (e) {
              ...
              if (null == l) {
                var t;
                l =
                  null !== (t = u.default.get(O, {})) && void 0 !== t ? t : {};
              }
              if (e in l) return !1;
              l[e] = Date.now();
              let n = Date.now() - b;
            ...
            (null == g ? void 0 : g.isThread()) &&
            h.default.hasTrackedUnread(g.id) &&
            !_.ready
          ) {
      ...
      function G(e) {
        ...
        D({ guildId: t, channelId: n, messageId: l, jumpType: a }), w(t, n);
      }
      function H(e) {
      ...
      function w(e, t) {
        ...
        D({ guildId: e, channelId: n, messageId: l });
      }
      function k() {
        let e = m.default.getChannelId(),
      ...
      function U(e) {
        ...
        l === v.CURRENT_APP_CONTEXT &&
          (D({ guildId: t, channelId: n }), w(t, n));
      }
      function W(e) {
        let { channel: t, messageId: n } = e,
          l = t.guild_id;
        null != l &&
          m.default.getChannelId(l) === t.id &&
          D({ guildId: l, channelId: t.id, messageId: n });
      }
      function V(e) {
        let { channelId: t } = e;
        s.default.fetchMessages({
      ...
      class Z extends f.default {
        ...
        constructor(...e) {
          super(...e),
            ...
            (this.stores = new Map().set(_.default, k)),
            (this.actions = {
              APP_STATE_UPDATE: X,
    ...
    764828: function (e, t, n) {
      ...
      ((i = l || (l = {}))[(i.STRANGER_DANGER = 1)] = "STRANGER_DANGER"),
        ...
        ((u = a || (a = {}))[(u.UPVOTE = 0)] = "UPVOTE"),
        (u[(u.DOWNVOTE = 1)] = "DOWNVOTE");
      let c = [],
        E = {},
        C = new Set();
      function g(e) {
      ...
      var N = new p(r.default, {
        ...
        CHANNEL_SAFETY_WARNING_FEEDBACK: function (e) {
          let { channelId: t, warningId: n, feedbackType: l } = e,
            a = E[t];
          null != a &&
            (E[t] = a.map(e => (e.id === n ? { ...e, feedback_type: l } : e)));
        },
