  ...
  ["18493"],
  {
    ...
    636905: function (e, t, r) {
      ...
      function C(e, t) {
        ...
        "" === e
          ? G()
          : (u.default.dispatch({ type: "GIF_PICKER_QUERY", query: e }),
            r ? v(e, t, s) : T(e, t, s));
      }
      function A(e) {
        "" !== e &&
      ...
      function G() {
        u.default.dispatch({ type: "GIF_PICKER_QUERY", query: "" });
      }
      function x(e) {
        let {
            type: t,
        ...
        y(_.GIFPickerResultTypes.TRENDING_GIFS),
          i.default
            ...
            .then(
              ...
              () => {
                u.default.dispatch({ type: "GIF_PICKER_QUERY_FAILURE" });
              }
            );
      }
      function M(e) {
        ...
        h.FrecencyUserSettingsActionCreators.updateAsync(
          ...
          t => {
            ...
            if (
              ...
              a.FavoriteGIFs.toBinary(t).length > E.MAX_FAVORITE_GIFS_SIZE)
            )
              return (
                g.default.show({
    ...
    355623: function (e, t, r) {
      ...
      var s,
        ...
        l = r("470079"),
        i = r("467006");
      ((s = n || (n = {})).ARROW_UP = "ARROW_UP"),
        (s.ARROW_DOWN = "ARROW_DOWN"),
        (s.ARROW_LEFT = "ARROW_LEFT"),
        (s.ARROW_RIGHT = "ARROW_RIGHT");
      ...
      var n = r("803997"),
        ...
        a = e => {
          let {
            ...
            o = null != n ? { backgroundImage: `url(${n})` } : {};
          return (0, s.jsx)("div", {
            className: l()({ [i.forceLightTheme]: a }, r),
            children: (0, s.jsxs)("div", {
              className: i.wrapper,
              children: [
                (0, s.jsx)("div", { className: i.sadImage, style: o }),
    ...
    228708: function (e, t, r) {
      ...
      let u = Object.freeze({
        ...
        h = e => {
          let t = o.getState();
          null == t.activeView
            ? c(t.lastActiveView ?? a.ExpressionPickerViewType.EMOJI, e)
            : d();
        },
        f = (e, t) => {
        ...
        p = function (e) {
          ...
          o.setState({ searchQuery: e, isSearchSuggestion: t });
        },
        I = o;
    },
    ...
    691035: function (e, t, r) {
      ...
      var l = (0, r("395802").default)(
        class extends s.Component {
          static #e = (this.defaultProps = { desiredItemWidth: 200 });
    ...
    992433: function (e, t, r) {
      ...
      var T = n.forwardRef((e, t) => {
        ...
        let {
          ...
          u = (0, d.useExpressionPickerStore)(e => e.searchQuery),
          o = (0, I.useSortedFavoriteGIFs)();
        return (0, s.jsx)(v, {
          ...e,
          forwardedRef: t,
          query: null != u && "" !== u ? u : r,
    ...
    252442: function (e, t, r) {
      ...
      var s = r("735250"),
        ...
        S = r("30175"),
        y = r("924781");
      let F = (e, t) => (0, s.jsx)(_.CategoryColumn, { columns: e }, t);
      class v extends n.PureComponent {
        componentDidMount() {
        ...
        constructor(...e) {
          super(...e),
            ...
            (this.renderItem = (e, t, r, n) => {
              ...
              if (null == l) return;
              let { onSelectItem: i, imagePool: a, videoPool: u } = this.props,
    ...
    229819: function (e, t, r) {
      ...
      var s = r("735250"),
        ...
        o = r("512056");
      let c = [
        u.default.unsafe_rawColors.PREMIUM_TIER_1_PURPLE.css,
        u.default.unsafe_rawColors.PREMIUM_TIER_1_BLUE.css,
        "#929AFA",
      ];
      ...
      class h extends n.Component {
        static #e = (this.defaultProps = { direction: -1 });
        constructor(e) {
          super(e),
            (this.animateSlide = () => {
              let {
      ...
      let f = e => {
        ...
        return (0, s.jsx)("div", {
          ...
          children: [, , , ,]
            .fill(null)
            .map((e, t) =>
              (0, s.jsx)("div", { className: o.categoryLoader }, t)
            ),
        });
      };
    ...
    490167: function (e, t, r) {
      ...
      class P extends n.PureComponent {
        constructor(e) {
          ...
          (this.state = { color: null == r ? u().sample(F) : r, loaded: !1 }),
            !N(t) &&
        ...
        render() {
          ...
          return (0, s.jsxs)(h.Clickable, {
            ...
            style: { backgroundColor: u ? void 0 : a, ...n },
            ...
            (this.renderItem = (e, t, r, n) => {
              ...
              return (0, s.jsx)(
                P,
                {
                  ...
                  renderExtras: () =>
                    (0, s.jsx)(g.default, { className: y.favButton, ...a }),
    ...
    409913: function (e, t, r) {
      ...
      let u = new Set([
          ...
          window.GLOBAL_ENV.MEDIA_PROXY_ENDPOINT?.substring(2),
        ]),
        o = new Set(["/attachments/", "/ephemeral-attachments/"]),
        c = 1 * n.default.Millis.HOUR;
      function d(e) {
        return (
          u.has(e.hostname) && Array.from(o).some(t => e.pathname.startsWith(t))
        );
      }
      function h(e) {
          ...
          return (0, s.jsx)(a.Tooltip, {
            ...
            children: e =>
              (0, s.jsx)(a.Clickable, {
                ...
                children: (0, s.jsx)(F, { className: p.icon }),
              }),
          });
        });
    },
      ...
      function a() {
        return (
          ...
          (0, n.useStateFromStores)(
            [i.default],
            () => i.default.frecencyWithoutFetchingLatest
          )
        );
      }
    },
    ...
    628941: function (e, t, r) {
      ...
      function n(e, t, r) {
        let n = null != t ? { [t]: 1 } : {},
          { offset: l, limit: i, results: a, totalResults: u } = r ?? {};
        return {
