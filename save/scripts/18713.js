  ...
  ["18713"],
  {
    ...
    145079: function (e, t, n) {
      ...
      var m = e => {
        ...
        return (0, l.jsx)(d.default, {
          ...
          botType: h(n),
          botVerified: n.isVerifiedBot(),
          discriminator: _ || T !== N ? null : null != o ? o : n.discriminator,
          ...f,
        });
      };
    },
    ...
    152475: function (e, t, n) {
      ...
      function v(e) {
        ...
        let { guild_id: f, channel_id: v } = e,
          ...
          _ = m ? t.getDefaultChannel(e.guild_id) : n.getChannel(v),
          N = l.getGuild(f),
          I = d.getStageInstanceByChannel(v);
        return (
          !!(0, a.canViewInviteModal)(o.default, N, _, I) &&
          null != _ &&
          h(e, [n])
        );
      }
      ...
      function y(e) {
        let { channel: t, onClick: n } = e,
          ...
          a = (0, o.useStateFromStores)(
            [h.default],
            () => !t.isGuildVocal() || h.default.can(M.Permissions.CONNECT, t),
            [t]
          ),
          ...
          : (0, s.jsxs)(d.Clickable, {
              ...
              children: [
                ...
                (0, s.jsx)(d.Text, {
                  ...
                  variant: "text-sm/normal",
                  children: (0, N.guildEventDetailsParser)(i, !0),
                }),
              ],
            });
      }
      function G(e) {
        let {
          ...
          $ = (0, o.useStateFromStores)([_.default], () =>
            _.default.getGuildScheduledEvent(W)
          ),
          ee = [];
        if (null != q && null != $) {
        ...
        return (0, s.jsxs)(d.ClickableContainer, {
          ...
          children: [
            (0, s.jsxs)("div", {
              ...
              children: [
                0 === E && (0, s.jsx)(g.default, { source: f }),
                (0, s.jsx)(C.default, {
                  creator: a,
                  name: i,
                  description: c,
    ...
    953143: function (e, t, n) {
      ...
      function f(e) {
        ...
        let T = null,
          x = v.startDate,
          g = s(),
          C = s().add(o.MAX_DAYS_AHEAD_AN_EVENT_CAN_START, "days"),
          S = s().add(o.MAX_DAYS_AHEAD_AN_EVENT_CAN_END, "days");
        null != m &&
          (C.add(o.MAX_YEARS_AHEAD_RECURRING_EVENT, "years"),
          ...
          children: [
            (0, l.jsx)("div", {
              ...
              children:
                ...
                !B &&
                U > 0 &&
                (0, l.jsx)(c.BlockedUsersNotice, { channelId: R }),
            }),
            (0, l.jsxs)("div", {
              className: T.form,
              children: [
                (0, l.jsxs)(r.FormItem, {
                  ...
                  children: [
                    (0, l.jsx)(r.TextInput, {
                      ...
                      maxLength: _.GUILD_EVENT_MAX_NAME_LENGTH,
                      value: y,
                      autoComplete: "off",
                      inputRef: w,
                    }),
                ...
                (0, l.jsx)(m.default, {
                  ...
                  onScheduleChange: e => {
                    ...
                    null != t &&
                      ...
                      null != t &&
                        null != F &&
                        (l.recurrenceRule = (0,
                        h.recurrenceOptionToRecurrenceRule)(F, t)),
                      A(l);
                  },
                  onRecurrenceChange: e => {
                    ...
                    A({ recurrenceRule: n }), P(e);
                  },
                  schedule: b,
                  recurrenceRule: O,
                  showEndDate: M === _.GuildScheduledEventEntityTypes.EXTERNAL,
                  requireEndDate:
                    M === _.GuildScheduledEventEntityTypes.EXTERNAL,
                            ...
                            (0, l.jsx)(u.default, {
                              ...
                              makeURL: e => {
                                ...
                                if (null != g) {
                                  ...
                                  return null !==
                                    (n = (0, v.default)(
                                      (0, f.convertToFakeGuildEvent)(t, g, s)
                                    )) && void 0 !== n
                                    ? n
                                    : null;
                                }
                ...
                (0, l.jsx)(x, { editBroadcastInfoData: C }),
              ],
            }),
          ],
        });
    ...
    590942: function (e, t, n) {
      ...
      var l,
        ...
        O = n("782340"),
        U = n("872994");
      let { INVITE_OPTIONS_7_DAYS: B, INVITE_OPTIONS_UNLIMITED: b } = N.default;
      function F(e) {
        let { modal: t } = e,
        ...
        return (
          ...
          (0, s.jsx)(s.Fragment, {
            children: (0, s.jsxs)(o.ModalRoot, {
              ...
              children: [
                !W && Z ? (0, s.jsx)(F, { modal: X.current }) : null,
      ...
      function w(e) {
        let {
          ...
          _ = (0, S.getInitialGuildEventData)(E, m),
          [N, L] = i.useState(_),
          [M] = i.useState((0, S.isEditingEvent)(E)),
          [R, j] = i.useState(null),
          y = e => {
            var t;
          ...
          U = (0, f.default)(c, null == E ? void 0 : E.id, N),
          [F, { loading: w, error: k }] = (0, I.default)(async () => {
            if (null != R) return;
            let e = {
              broadcastToDirectoryChannels: U.broadcastToDirectoryChannels,
            };
            if (M && null != l)
              return await x.default.saveEvent(l, N, t, e), r();
            let n = await x.default.createGuildEvent(N, t, e);
            return y(n.body), n;
          }),
          H = i.useMemo(() => (0, D.default)(N, M), [N, M]);
        return (0, s.jsx)(P, {
          guildId: t,
          guildEvent: N,
          guildEventId: l,
            ...
            if (null != e.entityType) {
              ...
              (e.channelId =
                ...
                e.entityType !== G.GuildScheduledEventEntityTypes.EXTERNAL &&
                  N.entityType === G.GuildScheduledEventEntityTypes.EXTERNAL &&
                  (e.entityMetadata = null);
            }
            L(t => ({ ...t, ...e }));
          },
          onSave: () => {
            null != N.recurrenceRule && M && (0, A.hasScheduleChanges)(E, N)
    ...
    560309: function (e, t, n) {
      ...
      let y = e => e === L.GuildScheduledEventEntityTypes.EXTERNAL,
        ...
        G = e => {
          let {
            ...
            d = n === M.ChannelTypes.GUILD_STAGE_VOICE,
            c = (0, S.isChannelPublic)(a, r),
            E = (0, g.useGetEventChannelsByType)(t, n);
          return (0, l.jsxs)(u.FormItem, {
            title: d
              ? R.default.Messages.START_STAGE_MODAL_SET_TOPIC_SELECT_LABEL
              : R.default.Messages.GUILD_EVENT_LOCATION_VOICE_FIELD_LABEL,
            className: j.options,
            disabled: i,
            required: !0,
            children: [
      ...
      function V(e, t, n, l) {
        return t
          ? {
              disabled: !0,
              tooltipText:
                R.default.Messages.GUILD_EVENT_LOCATION_DISABLED_CANNOT_EDIT,
            }
          : n
      ...
      function b(e) {
        ...
        let h = O(s),
          ...
          _ = (0, p.getChannelTypeFromEntity)(o),
        ...
        return null == o || o === L.GuildScheduledEventEntityTypes.NONE
          ...
          : y(o)
            ? (0, l.jsx)(u.FormItem, {
                title:
                  R.default.Messages.GUILD_EVENT_LOCATION_ELSEWHERE_FIELD_LABEL,
                className: j.options,
                required: !0,
      ...
      function F(e) {
        let { guildId: t, guildEvent: n, onChange: s } = e,
          ...
          d = (0, x.default)(t, M.ChannelTypes.GUILD_VOICE),
          E = (0, x.default)(t, M.ChannelTypes.GUILD_STAGE_VOICE),
          f = (0, g.useGetEventChannelsByType)(t, M.ChannelTypes.GUILD_VOICE),
          h = (0, C.useChannelsUserCanStartStageIn)(i),
          _ = null == i ? void 0 : i.hasFeature(M.GuildFeatures.COMMUNITY),
      ...
      function P(e) {
        let {
          ...
          v = (0, r.useStateFromStores)([E.default], () =>
            E.default.can(M.Permissions.MANAGE_CHANNELS, f)
          ),
          m = null == f ? void 0 : f.hasFeature(M.GuildFeatures.COMMUNITY),
          _ = B(i, a),
          N = m && !y(d) && 0 === h.length && v && null != d;
        return (0, l.jsxs)("div", {
          ...
          children: [
            ...
            (0, l.jsx)(F, { guildId: t, guildEvent: a, onChange: i }),
            (0, l.jsx)(b, {
              guildId: t,
              guildEvent: a,
              isFocusReady: o,
    ...
    151859: function (e, t, n) {
      ...
      function T(e) {
        var t, n, T;
        let { guildId: x, guildEvent: g, guildEventId: C, error: S } = e,
          p = a.useMemo(() => (0, f.convertToFakeGuildEvent)(g, x), [g, x]),
          { channel_id: A, name: L, image: M, description: R } = p,
          j = (0, s.useStateFromStores)(
            [o.default],
            () => o.default.getChannel(A),
            [A]
          ),
          y = (0, s.useStateFromStores)(
            [d.default],
          ...
          O = (0, r.getChannelIconComponent)(j, y);
        return (0, l.jsxs)("div", {
          className: I.content,
          children: [
            (0, l.jsx)(m.default, {
              ...
              description: R,
              imageSource:
                ((n = (0, f.convertToFakeGuildEvent)(g, x, C)),
                null == (T = M) && null == n.image
                  ? null
                  : null != T && /^data:/.test(T)
                    ? T
                    : (0, v.default)(n)),
                ...
                (0, l.jsx)(i.Text, {
                  ...
                  children:
                    null != location
                      ...
                      : N.default.Messages.GUILD_EVENT_PREVIEW_BODY.format({
                          channelName:
    ...
    499950: function (e, t, n) {
      ...
      var a = n("446674"),
        ...
        x = n("782340"),
        g = n("154585");
      let { INVITE_OPTIONS_7_DAYS: C, INVITE_OPTIONS_UNLIMITED: S } = N.default;
      function p(e) {
        var t, n, p;
        let { onClose: A, event: L } = e,
          ...
          R = (0, a.useStateFromStores)(
            ...
            () => {
              var e;
              return null != M
                ? null === (e = c.default.getDefaultChannel(M)) || void 0 === e
                  ? void 0
                  : e.id
                : null;
            },
          ...
          { enabled: D } = r.default.useExperiment(
            {
              guildId: null != M ? M : T.EMPTY_STRING_SNOWFLAKE_ID,
              location: "bd50e8_1",
            },
            { autoTrackExposure: y }
          ),
    ...
    656913: function (e, t, n) {
      ...
      function m(e) {
        let {
          ...
          m = (0, r.default)(),
          _ = (0, i.isThemeDark)(m) ? h : v,
          N = { height: 18, width: 18, color: (0, u.getColor)(_) };
    ...
    608684: function (e, t, n) {
      ...
      class m extends a.PureComponent {
        ...
        render() {
          ...
          if (
            (null != (t = null != r && /^data:/.test(r) ? r : _(r))
              ? (n = 'url("'.concat(t, '")'))
              : null != m &&
                (a = (0, l.jsx)("div", {
            ...
            return (0, l.jsx)("div", {
              className: i(h.imageUploader, h.disabled, g),
              children: (0, l.jsxs)("div", {
                className: i(h.imageUploaderInner, C),
                style: { ...M, backgroundImage: n },
                children: [
                  a,
                  x &&
                    (0, l.jsx)("div", {
    ...
    652453: function (e, t, n) {
      ...
      let p = u.default.connectStores([E.default], () => ({
          ...
          return (
            ...
            (0, l.jsxs)("div", {
              className: i(g.input, C.flexJustifyBetween, C.flexCenter, {
                [g.success]: f,
                [g.focused]: c,
              }),
              children: [
                ...
                : (0, l.jsxs)(d.Text, {
                    ...
                    children: [
                      ...
                      s
                        ? (0, l.jsx)(d.Anchor, {
                            onClick: () =>
                              M(N.InstantInviteModalPages.SETTINGS),
      ...
      let f = {
        ...
        h = e => {
          let {
            ...
            x = t;
          if ((!0 === N ? (x = f.DOWN) : !1 === N && (x = f.RIGHT), T)) {
            let e = {
...
//# sourceMappingURL=5855ad9d8d13c1e3127a.js.map
