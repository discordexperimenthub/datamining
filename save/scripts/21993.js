  ...
  ["21993"],
  {
    ...
    823026: function (e, t, n) {
      ...
      function m(e) {
        let { user: t, guildId: n, channel: m, context: M } = e,
          ...
          v = (0, d.useContextIndexState)(m, !0, !0),
          T = (0, d.useUserIndexState)(!0, !0),
          { isUserApp: I, isGuildApp: h } = i.useMemo(() => {
            var e, n, l, i;
          ...
          g = M === E.AppContext.POPOUT;
        if (!(null == t ? void 0 : t.bot) || !A || g || (!h && !I)) return null;
        let N = [];
        return (
          h &&
            N.push(
    ...
    85166: function (e, t, n) {
      ...
      function _(e, t, n) {
        ...
        return null != m && null != M && (v || A) && S.speaker
          ? (0, l.jsx)(u.MenuItem, {
              id: "audience",
              label: A
          ...
          (0, r.default)(
            function (e) {
              let {
                ...
                W = (0, L.default)(t.id, n, r.id),
                X = (0, O.default)(t, n, V),
                Y = (0, R.default)(t.id, V),
                z = (0, G.default)(t.id),
                K = (0, p.default)(t, V),
                Z = (0, T.default)({ user: t, guildId: n, context: V }),
                Q = (0, v.default)(t),
                q = (0, D.default)(t.id),
                J = (0, U.default)(t.id),
                $ = (0, m.default)({
      ...
      var l = n("37983"),
        ...
        v = e => {
          let t,
            ...
            C = (0, a.useStateFromStores)([_.default], () =>
              _.default.getGuild(null != T ? T : v.guild_id)
            ),
            ...
            U = i.useRef(R.current);
          i.useEffect(() => {
            R.current !== U.current &&
              ((U.current = R.current), null == I || I());
          }, [R, I]);
          let L = i.useCallback(
            e => {
              r(null != v, "menu item should not show if channel is null");
...
//# sourceMappingURL=96929510e9031ca6abec.js.map
