(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["23414"],
  {
              ...
              d = {
                  ...
                  window,
                    (e.exports = (function (e) {
                      ...
                      function i(r) {
                        ...
                        return (
                          e[r].call(o.exports, o, o.exports, i),
                          (o.l = !0),
                          o.exports
                        );
                      }
                      ...
                      function (e, t, i) {
                        !(function () {
                          ...
                          function n(e, t, i) {
                            var o =
                              i.audioContext || n.initSharedAudioContext();
                            if (
                              ((this._context = o),
                              ...
                              (this.channels = 2),
                              i.bufferSize &&
                                (this.bufferSize = 0 | i.bufferSize),
                              (this.bufferThreshold = 2 * this.bufferSize),
                              (this._bufferQueue = new r(
                                this.channels,
                                this.bufferSize
                              )),
                              ...
                              (this._dropped = 0),
                              (this._liveBuffer =
                                this._bufferQueue.createBuffer(
                                  this.bufferSize
                                )),
                              o.createScriptProcessor)
                            )
                              this._node = o.createScriptProcessor(
                                this.bufferSize,
                                0,
                                this.channels
                              );
                              ...
                              this._node = o.createJavaScriptNode(
                                this.bufferSize,
                                0,
                                this.channels
                              );
                          ...
                          (n.prototype.bufferSize = 4096),
                            ...
                            (n.prototype._audioProcess = function (e) {
                              ...
                              if (
                                ...
                                for (t = 0; t < this.channels; t++)
                                  for (
                                    r = e.outputBuffer.getChannelData(t), n = 0;
                                    n < this.bufferSize;
                                    n++
                                  )
                                    r[n] = 0;
                            ...
                            (n.prototype._samplesQueued = function () {
                              return (
                                this._bufferQueue.sampleCount() +
                                Math.floor(
                                  this._timeAwaitingPlayback() * this.rate
                                )
                              );
                            }),
                                  ...
                                  var R = r.float_array(A),
                                    ...
                                    G = {
                                      mapOutputToInputTime: function (e) {
                                        ...
                                        var i = C[t];
                                        return (
                                          i.in_time + i.tempo * (e - i.out_time)
                                        );
                                      },
                                      flush: function (e) {
                                        (I = 0),
                                  ...
                                  (i.unpack = function (e, r, o, n) {
                                    ...
                                    for (var a = 1; a < h; a++)
                                      (e[a] = (i.m_re[a] + i.m_re[t - a]) / 2),
                                        (r[a] =
                                          (i.m_im[a] - i.m_im[t - a]) / 2),
                                        (o[a] =
                                          (i.m_im[a] + i.m_im[t - a]) / 2),
                                        (n[a] =
                                          (-i.m_re[a] + i.m_re[t - a]) / 2);
                                  }),
                      ...
                      return (
                        (0, n.default)(e, [
                          ...
                          },
                          {
                            ...
                            value: function () {
                              return (
                                (this.upper = this.position), this.iterate()
                              );
                            },
                          },
                          {
                            ...
                            value: function () {
                              return (
                                (this.lower = this.position), this.iterate()
                              );
                            },
                          },
                        ]),
                ...
                408: (e, t, i) => {
                  ...
                  var o = r(i(575)),
                    ...
                    d = (function (e) {
                      ...
                      function d() {
                        return (
                          (0, o.default)(this, d), r.apply(this, arguments)
                        );
                      }
                      return (
                        (0, n.default)(d, [
                  ...
                  var o = r(i(575)),
                    ...
                    u = {
                      ...
                      OGVDecoderVideoVP9SIMDW:
                        "ogv-decoder-video-vp9-simd-wasm.js",
                      ...
                      OGVDecoderVideoAV1SIMDW:
                        "ogv-decoder-video-av1-simd-wasm.js",
                        ...
                        (0, n.default)(e, [
                          ...
                          },
                          {
                            ...
                            value: function (e) {
                              ...
                              throw Error(
                                "asked for URL for unknown class " + e
                              );
                            },
                          },
                          {
                            ...
                            value: function (e) {
                              ...
                              throw Error(
                                "asked for URL for unknown script " + e
                              );
                            },
                          },
                          {
                        ...
                        (0, n.default)(c, [
                          ...
                          },
                          {
                            ...
                            value: function (e, t) {
                              ...
                              if (!i)
                                throw Error(
                                  "Requested worker for class with no proxy: " +
                                    e
                                );
                              var r,
                                o = i.proxy,
                        ...
                        [
                          ...
                          },
                          {
                            ...
                            value: function () {
                              var e = this,
                                ...
                                i = { bufferSize: 8192 };
                              t.audioContext &&
                                (i.audioContext = t.audioContext),
                                t.audioDestination &&
                                  (i.output = t.audioDestination),
                                t.audioBackendFactory &&
                                  (i.backendFactory = t.audioBackendFactory);
                            ...
                            value: function (e) {
                              return this._prebufferingAudio || this._paused
                                ...
                                : (this._audioFeeder
                                    ? (e =
                                        e ||
                                        this._audioFeeder.getPlaybackState())
                                        .playbackPosition
                                    : (this._playbackRate * T()) / 1e3) -
                                    this._initialPlaybackPosition +
                                    this._initialPlaybackOffset;
                            ...
                            value: function () {
                              ...
                              this._codec &&
                                ...
                                (!this._lastTimeUpdate ||
                                  i - this._lastTimeUpdate >=
                                    this._timeUpdateInterval) &&
                                  ((this._lastTimeUpdate = i),
                          ...
                          },
                          {
                            ...
                            value: function (e, t) {
                              ...
                              if (this._stream && !this._stream.seekable)
                                throw Error(
                                  "Cannot seek a non-seekable stream"
                                );
                              if (this._codec && !this._codec.seekable)
                                throw Error(
                                  "Cannot seek in a non-seekable file"
                                );
                              var r = function (r) {
                                i._stream &&
                                  i._stream.buffering &&
                                ...
                                if (
                                  ...
                                  return (
                                    this._codec.decodeFrame(function (i) {
                                      i && e._drawFrame(e._codec.frameBuffer),
                                        t();
                                    }),
                              ...
                              this._videoInfo.fps > 0
                                ...
                                c.styleManager.appendRule(
                                  "." + this._instanceId,
                                  {
                                    ...
                                    height:
                                      this._videoInfo.displayHeight + "px",
                                  }
                                );
                              var e = {};
                              void 0 !== this._options.webGL &&
                                (e.webGL = this._options.webGL),
                                this._options.forceWebGL &&
                                  (e.webGL = "required"),
                              ...
                              if (this._codec.loadedMetadata) {
                                ...
                                this._codec.process(function (t) {
                                  if (t) e._pingProcessing();
                                    ...
                                    e._log(
                                      "reading more cause we are out of data"
                                    ),
                                      e._readBytesAndWait();
                                  }
                                });
                            ...
                            value: function () {
                              ...
                              if (
                                ...
                                this._muted
                                  ? i()
                                  : (this._initAudioFeeder(),
                                    this._audioFeeder.waitUntilReady(i));
                              }
                            },
                          },
                          {
                          ...
                          },
                          {
                            ...
                            value: function () {
                              ...
                              if (this._paused)
                                this._log(
                                  "paused during playback; stopping loop"
                                );
                              else if (
                                (!t.hasAudio ||
                                  t.audioReady ||
                                ...
                                if (
                                  (t.hasAudio && this._audioFeeder
                                    ? ((n =
                                      ...
                                      this._prebufferingAudio &&
                                        ((this._audioFeeder.durationBuffered >=
                                          2 *
                                            this._audioFeeder.bufferThreshold &&
                                          (!t.hasVideo ||
                                            this._decodedFrames.length >=
                                  ...
                                  if (this._prebufferingAudio)
                                    ...
                                    for (
                                      var c = -1, h = 0;
                                      h < this._decodedFrames.length - 1;
                                      h++
                                    )
                                      this._decodedFrames[h].frameEndTimestamp <
                                        a && (c = h - 1);
                                    if (c >= 0)
                                      for (; c-- >= 0; ) {
                                        this._lateFrames++;
                                ...
                                if (o) {
                                    ...
                                    E = this._time(function () {
                                      e._codec.decodeAudio(function (t) {
                                        if (
                                          ...
                                          if (
                                            i &&
                                            ((e._bufferTime += e._time(
                                              function () {
                                                e._audioFeeder &&
                                                  e._audioFeeder.bufferData(i);
                                              }
                                            )),
                                            !e._codec.hasVideo)
                                          ) {
                                  ...
                                  var x = u;
                                  this._log(
                                    "play loop: setting a timer for drawing " +
                                      x
                                  ),
                            ...
                            value: function () {
                              return {
                                ...
                                audioDecodingTime: this._codec
                                  ...
                                  : 0,
                                bufferTime:
                                  this._bufferTime - this._lastBufferTime,
                                drawingTime:
                                  this._drawingTime - this._lastDrawingTime,
                                proxyTime:
                                  this._proxyTime - this._lastProxyTime,
                                droppedAudio: this._droppedAudio,
                                delayedAudio: this._delayedAudio,
                                jitter:
                                  this._totalJitter / this._framesProcessed,
                        ...
                        [
                          {
                            ...
                            value: function () {
                              ...
                              (e.src = b.default),
                                e.play(),
                                l.default.initSharedAudioContext();
                            },
                          },
                        ]
                      ),
                              ...
                              if (
                                ...
                                if (t.props)
                                  for (var n in t.props)
                                    t.props.hasOwnProperty(n) &&
                                      (this[n] = t.props[n]);
                                o &&
                                  (delete this.pendingCallbacks[i],
                                  o.apply(this, r));
                              }
                            },
                          },
                    ...
                    return (
                      (0, n.default)(e, [
                        ...
                        },
                        {
                          ...
                          value: function (e) {
                            this.videoDecoder &&
                              this.videoDecoder.recycleFrame(e);
                          },
                        },
                        {
                                ...
                                a.default.loadClass(
                                  ...
                                  function (i) {
                                    ...
                                    t.demuxer.videoFormat &&
                                      (o.videoFormat = t.demuxer.videoFormat),
                              ...
                              if (!this.tested) {
                                try {
                                  ...
                                  ("undefined" == typeof WebAssembly
                                    ? "undefined"
                                    : (0, o.default)(WebAssembly))
                                    ? (this.testResult =
                                        ((e = new Uint8Array([
                                          0, 97, 115, 109, 1, 0, 0, 0, 1, 6, 1,
                                          96, 1, 127, 1, 127, 3, 2, 1, 0, 5, 3,
                                          1, 0, 1, 7, 8, 1, 4, 116, 101, 115,
                                          116, 0, 0, 10, 16, 1, 14, 0, 32, 0,
                                        ...
                                        (e.headers =
                                          ...
                                          n
                                            ...
                                            .forEach(function (e) {
                                              var t = e.split(/:\s*/, 2);
                                              t.length > 1 &&
                                                (a[t[0].toLowerCase()] = t[1]);
                                            }),
                                          a)),
                                        e.onXHRStart())
                                      : (r(),
                                        i(Error("HTTP error " + e.xhr.status)));
                                  }
                                },
                                a = function () {
                        ...
                        },
                        {
                          ...
                          value: function () {
                            ...
                            (this.offset || this.length) &&
                              (t = "bytes=" + this.offset + "-"),
                              this.length &&
                                (t += this.offset + this.length - 1),
                              null !== t &&
                                this.xhr.setRequestHeader("Range", t);
                          },
                        },
                        {
                          key: "onXHRStart",
                      ...
                      return (
                        ...
                        r(t, [
                          ...
                          },
                          {
                            key: "onXHRProgress",
                            value: function () {
                              var e = this.xhr.responseText.slice(
                                this.bytesRead
                              );
                              e.length > 0 &&
                ...
                761: (e, t, i) => {
                  ...
                  e.exports = function (e) {
                    ...
                    if (
                      (a || (a = r.supported() ? r : o.supported() ? o : null),
                      !a)
                    )
                        ...
                        t(e, [
                          {
                            ...
                            value: function (e) {
                              return (
                                e >= this.start && (e < this.end || this.eof)
                              );
                            },
                          },
                          {
                      ...
                      return (
                        r(e, [
                          ...
                          },
                          {
                            ...
                            value: function () {
                              for (
                                var e = 0, t = [], i = this.head;
                                i;
                                i = i.next
                              )
                                i.empty ||
                                  ((e += i.length),
                                  (i.end < this.readOffset ||
                                    i.start >
                          ...
                          },
                          {
                            ...
                            value: function (e, t, i, r) {
                              ...
                              (e.prev = null),
                                ...
                                (this.readCursor = this.head.first(
                                  function (e) {
                                    return e.contains(o.readOffset);
                                  }
                                )),
                                (this.writeCursor = this.head.first(
                                  function (e) {
                            ...
                            value: function () {
                              ...
                              return new Promise(function (t, i) {
                                if (e._backend) t(e._backend);
                                  ...
                                  if (
                                    (r.seekWrite(s),
                                    e.length >= 0 && s >= e.length)
                                  )
                                    return void t(null);
                                  var u =
                                    e._clampToLength(
                                      r.writeOffset + r.bytesWritable(o)
                                    ) - r.writeOffset;
                                  if (0 === u) t(null);
                                  else {
                        ...
                        (this.drawFrame = function (a) {
                          ...
                          (e.width === d.displayWidth &&
                            ...
                            (null !== i &&
                              ...
                              (function (e, r) {
                                for (
                                  var o = (i = t.createImageData(e, r)).data,
                                    n = e * r * 4,
                                    a = 0;
                                  a < n;
                                  a += 4
                    ...
                    function o(e) {
                      ...
                      function P(e, t) {
                        ...
                        if (
                          ...
                          throw (
                            (a.deleteProgram(o),
                            Error("GL program linking failed: " + n))
                          );
                        }
                        return o;
                      }
                      return (
                        (n.drawFrame = function (s) {
                          var g = s.format,
                            y =
                              !t ||
                              e.width !== g.displayWidth ||
                              e.height !== g.displayHeight;
                          if (
                            (y &&
                              ((e.width = g.displayWidth),
                              (e.height = g.displayHeight),
                            ...
                            b(_, 0, s.y.stride),
                              b(m, 0, (s.u.stride * g.width) / g.chromaWidth);
                          }
                        ...
                        if (1 == n && 1 == a)
                          for (y = 0, b = l, O = 0, R = 0; R < o; R += 2) {
                            for (
                              ...
                              (T = 0 | u[V++]),
                                (E =
                                  (((409 * (A = 0 | d[v++])) | 0) - 57088) | 0),
                                (P =
                                  (((100 * T) | 0) + ((208 * A) | 0) - 34816) |
                                  0),
                                (w = (((516 * T) | 0) - 70912) | 0),
                                (k = (298 * s[p++]) | 0),
                                (t[y] = (k + E) >> 8),
    ...
    190445: function (e, t, i) {
      e.exports = i("667589");
    },
  },
]);
//# sourceMappingURL=bbf088bed6a9c6a4d859.js.map
