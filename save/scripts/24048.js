  ...
  ["24048"],
  {
      ...
      var i = n("759843"),
        ...
        S = {
          createChannel(e) {
            ...
            if (
              (null != _ && _ !== c.BITRATE_DEFAULT && (I.bitrate = _),
              null != h && h > 0 && (I.user_limit = h),
    ...
    398654: function (e, t, n) {
      ...
      function g(e) {
        let { showAlertMode: t } = (0, f.useGuildAlertModeEnabled)(
            null != e ? e : h.ZERO_STRING_GUILD_ID
          ),
          n = (0, r.useStateFromStores)([s.default, u.default], () => {
            ...
            return (
              null != n && i.hasAny(n, _.IncidentAlertModeratorPermissions)
            );
          }),
      ...
      function p() {
        ...
        let t = o.default.getGuildId(),
          ...
          { showAlertMode: r } = (0, f.getGuildAlertModeEnabled)(
            null != n ? n : h.ZERO_STRING_GUILD_ID
          ),
          u =
        ...
        initialize(e) {
          this.waitFor(o.default),
            null != e &&
              ...
              (_ = e.mentionRaidDetectionByGuild));
        }
        getState() {
          return {
    ...
    739726: function (e, t, n) {
      ...
      function T(e) {
        let {
          ...
          R = (0, o.useListingThumbnailUrl)(t, 600),
          N =
            null !== t.price_tier
              ? (0, S.formatPrice)(t.price_tier, h.CurrencyCodes.USD)
              : void 0,
          v = (0, E.useProductType)(t);
              ...
              children: [
                (0, i.jsxs)("div", {
                  ...
                  children: [
                    ...
                    t.published
                      ? (0, i.jsx)(_.PublishedBadge, {})
                      : (0, i.jsx)(_.DraftBadge, {}),
                  ],
                }),
                !m &&
                  (0, i.jsx)(I, {
      ...
      function c(e) {
        let {
          ...
          g = r.useCallback(() => {
            ...
            (h.current || e === o.FetchState.NOT_FETCHED) &&
              ((h.current = !1),
          ...
          p = r.useMemo(
            () => _ === o.FetchState.FETCHED && !0 !== h.current,
            [_, h]
          );
      ...
      function I(e) {
        ...
        (h[e] = t),
          t.forEach(e => {
            let t = e.set(
              "flags",
              _.ChannelFlags.IS_ROLE_SUBSCRIPTION_TEMPLATE_PREVIEW_CHANNEL
            );
    ...
    974755: function (e, t, n) {
              ...
              (0, i.jsx)(u.Clickable, {
                ...
                children: (0, i.jsx)(d.default, {
                  ...
                  iconBackgroundClassName: n
                    ...
                    : null,
                  iconClassName:
                    n && o !== h.BoostedGuildTiers.TIER_3
      ...
      function T(e) {
        ...
        let s =
          t.hasFeature(h.GuildFeatures.VERIFIED) ||
          t.hasFeature(h.GuildFeatures.PARTNERED);
        return s
    ...
    593916: function (e, t, n) {
      ...
      function N(e) {
        let { guildId: t } = e,
          ...
          { impersonateType: N, viewingRoles: v } = (0,
          ...
          M = N === C.ImpersonateType.SERVER_SHOP,
          O = (0, d.useStateFromStores)([f.default], () =>
            null != n ? f.default.getTrueMember(t, n.id) : null
          ),
          [A, L] = (0, c.useMultiSelect)(null == v ? [] : h.default.keys(v)),
          b = r.useRef(l);
        r.useEffect(() => {
          let e = {},
            t = b.current;
          if (null != t && null != N) {
            ...
            (0, g.updateImpersonating)(t.id, { type: N, roles: e });
          }
        }, [A, N, u]);
        let x =
        ...
        let D = a.has(
          _.computePermissionsForRoles({ forceRoles: G, context: l }),
    ...
    977169: function (e, t, n) {
      ...
      function G() {
        let e = (0, s.useStateFromStores)([h.default], () =>
            h.default.getGuildId()
          ),
          t = (0, s.useStateFromStores)([_.default], () =>
            _.default.getChannelId(e)
          ),
          {
            viewingRoles: n,
        ...
        let G = (function (e) {
          ...
          D =
            r === v.GuildSettingsSections.ROLE_SUBSCRIPTIONS
          ...
          F = t => {
            ...
            null != e &&
              (R.default.isFullServerPreview(e) &&
                (0, E.transitionTo)(v.Routes.CHANNEL(e)),
        ...
        return (0, i.jsxs)(I.default, {
          ...
          children: [
            ...
            w && l
              ...
              : (0, i.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, i.jsx)(o.Popout, {
                      position: "bottom",
                      renderPopout: () => (0, i.jsx)(N.default, { guildId: e }),
                      children: e => {
                        let { onClick: t } = e;
                        return (0, i.jsxs)(x, {
                          onClick: t,
            ...
            l || r === v.GuildSettingsSections.ROLE_SUBSCRIPTIONS
              ? null
      ...
      function D(e) {
        let { guildId: t } = e,
          n = (0, s.useStateFromStores)([R.default], () =>
            R.default.isViewingRoles(t)
          );
        return n
          ? (0, i.jsx)("div", {
...
//# sourceMappingURL=e4d84b2fbe47b996bf96.js.map
