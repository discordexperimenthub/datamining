  ...
  ["27083"],
  {
    ...
    868869: function (e, t, s) {
      ...
      function p(e) {
        ...
        if (t === E.PurchaseTypes.ONE_TIME)
          return r
            ? _.default.Messages.PAYMENT_MODAL_BUTTON_PREMIUM_GIFT
            : _.default.Messages.GUILD_PRODUCT_PURCHASE_MODAL_CTA;
        if (
          (n(
            null != s,
          ...
          return _.default.Messages.PAYMENT_MODAL_BUTTON_PREMIUM_GIFT;
        if ((0, c.isPremiumSubscriptionPlan)(s.id)) {
          if (l) return _.default.Messages.BILLING_SELECT_PLAN;
          if (null != a)
            return a.status === d.SubscriptionStatusTypes.PAUSED
              ? _.default.Messages.RESUME
              : (0, o.subscriptionCanSwitchImmediately)(a, s.id, i)
                ? _.default.Messages.BILLING_SWITCH_PLAN_UPGRADE
                : _.default.Messages.BILLING_SWITCH_PLAN_CHANGE;
      ...
      function L(e) {
        ...
        if (M)
          return (0, a.jsxs)(u.default, {
            ...
            submitting: o,
            children: [
              (0, a.jsx)("img", { alt: "", className: I.nitroIcon, src: T }),
              C,
            ],
          });
        else if (!R)
...
//# sourceMappingURL=27083.02344fc57ba54708e74d.js.map
