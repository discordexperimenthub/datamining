        ...
        enhanceNewMember(e) {
          ...
          let r =
            ...
            I = {
              ...
              user: c,
              sort: (0, M.getSortValueForMember)(
                e,
                null !== (t = S.selectedSort) && void 0 !== t
                  ? t
                  : m.OrderBy.ORDER_BY_UNSPECIFIED
              ),
              joinedAtTimestamp: i,
              ...r,
            };
        ...
        isMemberIncludedInSearchResults(e) {
          ...
          if (
            ...
            !(function (e, t) {
              ...
              for (let t of r) if (_(e.nick, t)) return !0;
              if (null == e.user) return !1;
              let { globalName: n, username: s } = e.user;
              for (let e of r) if (_(s, e)) return !0;
              for (let e of r) if (_(n, e)) return !0;
              return !1;
            })(e, t)
          )
            return !1;
          ...
          if (r || i || n || s)
            return (
              !!(
                ...
                (i && (0, d.isMemberCommunicationDisabled)(e)) ||
      ...
      let p = new b(n.default, {
        ...
        MEMBER_SAFETY_GUILD_MEMBER_SEARCH_SUCCESS: function (e) {
          ...
          let { guildId: d, members: _, total_result_count: c } = e,
            S = M(d),
            { memberIds: I, memberSupplementals: f } = _.reduce(
              (e, t) => {
                let {
                    member: r,
