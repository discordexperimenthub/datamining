            ...
            description: (() => {
              switch (_) {
                ...
                case C.ChannelTypes.GUILD_FORUM:
                  return (null == S ? void 0 : S.createPostsDisabled) &&
                    !E.isMediaChannel()
                    ? n.default.getForumChannelPermissionText()
                    : l.default.Messages
                ...
                case C.ChannelTypes.GUILD_VOICE:
                  return M.default.getTextInVoiceSendMessageChannelPermissionText(
                    null == S ? void 0 : S.sendMessagesDisabled
                  );
                default:
                  return l.default.Messages
          ...
          [C.Permissions.READ_MESSAGE_HISTORY.toString()]: {
            ...
            description: (() => {
              switch (_) {
                ...
                case C.ChannelTypes.GUILD_VOICE:
                  return M.default.getTextInVoiceReadMessageHistoryChannelPermissionText(
                    null == S ? void 0 : S.readMessageHistoryDisabled
                  );
                case C.ChannelTypes.GUILD_FORUM:
                case C.ChannelTypes.GUILD_MEDIA:
                  return l.default.Messages
