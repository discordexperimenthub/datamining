      ...
      function i(e) {
        let t = (function (e) {
          let { PI: t, min: n, max: r, cos: i, round: a } = Math,
            ...
            P = a(N > 1 ? 32 : 32 * N),
            y = a(N > 1 ? 32 / N : 32),
            O = new Uint8Array(P * y * 4),
            U = [],
            M = [];
          for (let e = 0, u = 0; e < y; e++)
            for (let a = 0; a < P; a++, u += 4) {
              ...
              for (let e = 0, t = 0; e < 3; e++)
                for (let n = e ? 0 : 1, u = 2 * M[e]; n < 3 - e; n++, t++) {
                  let e = U[n] * u;
                  (s += C[t] * e), (E += R[t] * e);
                }
              if (f)
                for (let e = 0, t = 0; e < 5; e++)
                  for (let n = e ? 0 : 1, u = 2 * M[e]; n < 5 - e; n++, t++)
                    p += L[t] * U[n] * u;
              let T = o - (2 / 3) * s,
                h = (3 * o - T + E) / 2,
                m = h - E;
