    ...
    469938: function (e, a, i) {
      ...
      var o = {
        ...
        "creditCard.holderName.invalid":
          "Immetti il nome riportato sulla carta",
        ...
        "creditCard.cvcField.title.optional":
          "Codice di sicurezza (facoltativo)",
        ...
        "creditCard.taxNumber":
          "Data di nascita del titolare della carta o numero di registrazione aziendale",
        ...
        "error.va.sf-ach-num.01":
          "Il campo Numero di conto corrente bancario \xe8 vuoto",
        "error.va.sf-ach-num.02":
          "La lunghezza del numero di conto corrente bancario non \xe8 corretta",
        "error.va.sf-ach-loc.01":
          "Il campo Numero di routing bancario \xe8 vuoto",
        "error.va.sf-ach-loc.02":
          "La lunghezza del numero di routing bancario non \xe8 corretta",
        "error.va.sf-kcp-pwd.01": "Il campo Password \xe8 vuoto",
        "error.va.sf-kcp-pwd.02":
          "La lunghezza della password non \xe8 corretta",
        ...
        "onlineBanking.termsAndConditions":
          "Facendo clic, accetti i %#termini e le condizioni%#",
        ...
        "ctp.loading.intro":
          "Stiamo verificando se hai delle carte salvate con Click to Pay...",
        "ctp.login.title": "Continua su Click to Pay",
        "ctp.login.subtitle":
          "Per continuare, inserisci l'indirizzo e-mail collegato a Click to Pay.",
        ...
        "ctp.otp.subtitle":
          "Inserisci il codice che %@ ha inviato a %@ per verificare la tua identit\xe0.",
        "ctp.emptyProfile.message":
          "Non esistono carte registrate in questo profilo Click to Pay",
        ...
        "ctp.infoPopup.title":
          "Click to Pay offre la facilit\xe0 del contactless online",
        ...
        "ctp.infoPopup.benefit2":
          "Usa questo strumento con i commercianti di tutto il mondo",
        ...
        "ctp.errors.FRAUD":
          "L'account utente \xe8 stato bloccato o disattivato",
        "ctp.errors.CONSUMER_ID_MISSING":
          "L'identit\xe0 del consumatore non \xe8 presente nella richiesta",
        ...
        "ctp.errors.RETRIES_EXCEEDED":
          "\xc8 stato superato il limite di tentativi per la generazione del codice OTP",
        "ctp.errors.OTP_SEND_FAILED":
          "Impossibile inviare il codice OTP al destinatario",
        "ctp.errors.REQUEST_TIMEOUT":
          "Si \xe8 verificato un errore. Riprova o inserisci manualmente la carta",
        ...
        "consent.checkbox.invalid":
          "\xc8 necessario accettare i termini e le condizioni",
        "form.instruction":
          "Se non diversamente indicato, tutti i campi sono obbligatori.",
        ...
        "trustly.description2":
          "Nessuna carta, nessun download di app, nessuna registrazione",
      };
    },
  },
]);
//# sourceMappingURL=9eb129973f24e18e128a.js.map
