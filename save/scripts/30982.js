    ...
    125835: function (t, e, l) {
      ...
      function o(t) {
        ...
        return (0, n.jsxs)("span", {
          className: s(r.container, e, { [r.containerColored]: a }),
          children: [
            l,
            o
              ? null
              : (0, n.jsxs)(n.Fragment, {
                  children: [
                    ...
                    (0, n.jsx)(i.default, { foreground: r.sparkleStarRight }),
                    (0, n.jsx)(i.default, {
      ...
      var n = l("37983"),
        ...
        M = t => {
          let {
            ...
            { analyticsLocations: y } = (0, u.default)(),
            x = (0, o.useAppContext)(),
            T = x === C.AppContext.POPOUT,
            [v, N] = a.useState(!1),
            P =
              null != L
                ? Math.max(
                    (0, d.getNumberOfAppliedBoostsNeededForTier)(s, L),
                    1
                  )
                : 1,
            R = (0, d.generateBlockGuildSubscriptionPurchasesNode)(),
            I = async () => {
              N(!0),
          ...
          return null != R
            ...
            : (0, n.jsx)(c.default, {
                size: r.Button.Sizes.SMALL,
                ...w,
                className: i(w.className, { [p.buttonHighlighted]: E }),
                submitting: v,
                onClick: I,
                pauseAnimation: S,
                children:
    ...
    954296: function (t, e, l) {
      ...
      async function p(t) {
        let {
          ...
          x = w ? a.POPOUT_MODAL_CONTEXT : a.DEFAULT_MODAL_CONTEXT,
        ...
        let v = [];
        !c.default.isLoadedForPremiumSKUs() &&
          v.push((0, r.fetchPremiumSubscriptionPlans)()),
          !u.default.hasFetched &&
            (v.push(s.fetchSubscriptions()),
            v.push((0, i.fetchGuildBoostSlots)())),
          v.length > 0 && (await Promise.allSettled(v));
    ...
    163732: function (t, e, l) {
      ...
      async function C(t) {
        let {
          ...
          E = _ ? a.POPOUT_MODAL_CONTEXT : a.DEFAULT_MODAL_CONTEXT,
          w = o.default.getPremiumTypeSubscription();
            ...
            s.default.show({
              title:
                f.default.Messages.BILLING_MANAGED_BY_PAYMENT_GATEWAY.format({
                  paymentGatewayName:
                    d.PaymentGatewayToFriendlyName[w.paymentGateway],
                }),
        ...
        Promise.all([
          (0, i.fetchPaymentSources)(),
          (0, r.fetchPremiumSubscriptionPlans)(),
        ]);
        let y = await (0, a.openModalLazy)(
          async () => {
            let { default: t } = await l.el("860634").then(l.bind(l, "860634"));
            return l => {
              let { transitionState: a, onClose: s } = l;
              return (0, n.jsx)(t, {
                transitionState: a,
                onClose: t => {
                  s(), null == L || L(t);
