    ...
    916565: function (e, t, n) {
      ...
      async function F(e) {
        ...
        if (null != O.options)
          for (let e of O.options) {
            if (
              ...
              continue;
            let t =
                (null === (l = U.autocomplete) || void 0 === l
                  ? void 0
            ...
            if (e.type === s.ApplicationCommandOptionType.STRING) {
              let l =
                null !==
                  (u =
                    null === (a = N.getOptionalString(S, e.name)) ||
                    void 0 === a
                      ? void 0
                      : a.trim()) && void 0 !== u
                  ? u
            ...
            if (
              (i(
                null != U.autocomplete || 1 === o.length,
            ...
            switch (e.type) {
                ...
                if ("channelMention" === r.type) n = r.channelId;
                  ...
                  if ((0, L.isSnowflake)(r.text)) n = r.text.trim();
                    ...
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (m = U.guild) || void 0 === m ? void 0 : m.id,
                      U.channel.id
                    );
                    i(
              ...
              case s.ApplicationCommandOptionType.ROLE:
                if ("roleMention" === r.type) n = r.roleId;
                  ...
                  if ((0, L.isSnowflake)(r.text)) n = r.text.trim();
                    ...
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (f = U.guild) || void 0 === f ? void 0 : f.id,
                      U.channel.id,
                      { allowUsers: !1 }
                    );
                    i(
                  ...
                  "textMention" === r.type &&
                    "@everyone" === r.text &&
                    (n =
                      null === (h = U.guild) || void 0 === h ? void 0 : h.id);
                break;
              case s.ApplicationCommandOptionType.USER:
                if ("userMention" === r.type) n = r.userId;
                  ...
                  if ((0, L.isSnowflake)(r.text)) n = r.text.trim();
                    ...
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (g = U.guild) || void 0 === g ? void 0 : g.id,
                      U.channel.id,
                      { allowRoles: !1 }
                    );
                    i(
              ...
              case s.ApplicationCommandOptionType.MENTIONABLE:
                if ("userMention" === r.type) n = r.userId;
                  ...
                  n = null === (v = U.guild) || void 0 === v ? void 0 : v.id;
                else if ("text" === r.type) {
                  if ((0, L.isSnowflake)(r.text)) n = r.text.trim();
                  else {
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (E = U.guild) || void 0 === E ? void 0 : E.id,
                      U.channel.id
                    );
                    (null == e ? void 0 : e.type) === "userMention"
                      ? (n = e.userId)
        ...
        if (null != O.execute)
          return (
            d.default.trackWithMetadata(
              b.AnalyticEvents.APPLICATION_COMMAND_USED,
              {
                command_id: O.id,
                application_id: O.applicationId,
                command_type: O.type,
                location:
                  F === x.CommandOrigin.APPLICATION_LAUNCHER
                    ? x.ApplicationCommandTriggerLocations.APP_LAUNCHER
                    : x.ApplicationCommandTriggerLocations.SLASH_UI,
              }
            ),
            O.execute(z, U)
          );
        if (
          O.inputType === x.ApplicationCommandInputType.BUILT_IN ||
          O.inputType === x.ApplicationCommandInputType.BUILT_IN_TEXT ||
          O.inputType === x.ApplicationCommandInputType.BUILT_IN_INTEGRATION
        )
          return;
        let V = {
          version: O.version,
        ...
        null != P && (V.target_id = P),
          null != U.autocomplete
            ? (0, M.performAutocomplete)(O, U, V)
            : (r.default.clearAll(U.channel.id, G),
              B({
      ...
      let j = e => {
        ...
        B = e => {
          let {
            ...
            A =
              n.type === s.ApplicationCommandType.CHAT
                ? b.MessageTypes.CHAT_INPUT_COMMAND
                : b.MessageTypes.CONTEXT_MENU_COMMAND,
            I = (0, g.default)({
              channelId: h,
              content: "",
              tts: !1,
          ...
          a.default.receiveMessage(h, I, !0, { applicationId: t }),
            f.addQueued(T.nonce, {
              messageId: I.id,
              onCreate: e => {
      ...
      async function V(e, t, n, l) {
        ...
        ({ totalSize: a, largestUploadedFileSize: r } = await G(e, !0));
