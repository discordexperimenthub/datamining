  ...
  ["31337"],
  {
      ...
      function ee(e, t, n) {
        ...
        return 0 !==
          ...
          ? ((r === O.ScoreMethod.NONE ||
              ...
              i.sort((e, t) => eo(e.displayName, t.displayName)),
            { section: e, data: i })
          : null;
      }
      function et(e) {
      ...
      async function B(e) {
        ...
        if (null != M.options)
          for (let e of M.options) {
            if (
              ...
              continue;
            let t =
                (null === (i = L.autocomplete) || void 0 === i
                  ? void 0
              ...
              (n =
                null != e.choices
                  ...
                  : e.autocomplete
                    ...
                    : i),
                l(
                  null != L.autocomplete || null != n,
                  'Option "'.concat(e.name, '" expects a value')
                ),
                null != n &&
                  G.push({ type: e.type, name: e.name, value: n, focused: t });
              continue;
            }
            ...
            if (
              (l(
                null != L.autocomplete || 1 === a.length,
            ...
            switch (e.type) {
                ...
                if ("channelMention" === r.type) n = r.channelId;
                  ...
                  if ((0, R.isSnowflake)(r.text)) n = r.text.trim();
                    ...
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (f = L.guild) || void 0 === f ? void 0 : f.id,
                      L.channel.id
                    );
                    l(
              ...
              case s.ApplicationCommandOptionType.ROLE:
                if ("roleMention" === r.type) n = r.roleId;
                  ...
                  if ((0, R.isSnowflake)(r.text)) n = r.text.trim();
                    ...
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (m = L.guild) || void 0 === m ? void 0 : m.id,
                      L.channel.id,
                      { allowUsers: !1 }
                    );
                    l(
                  ...
                  "textMention" === r.type &&
                    "@everyone" === r.text &&
                    (n =
                      null === (_ = L.guild) || void 0 === _ ? void 0 : _.id);
                break;
              case s.ApplicationCommandOptionType.USER:
                if ("userMention" === r.type) n = r.userId;
                  ...
                  if ((0, R.isSnowflake)(r.text)) n = r.text.trim();
                    ...
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (I = L.guild) || void 0 === I ? void 0 : I.id,
                      L.channel.id,
                      { allowRoles: !1 }
                    );
                    l(
              ...
              case s.ApplicationCommandOptionType.MENTIONABLE:
                if ("userMention" === r.type) n = r.userId;
                  ...
                  n = null === (A = L.guild) || void 0 === A ? void 0 : A.id;
                else if ("text" === r.type) {
                  if ((0, R.isSnowflake)(r.text)) n = r.text.trim();
                  else {
                    let e = (0, p.resolveApplicationCommandOption)(
                      r.text,
                      null === (N = L.guild) || void 0 === N ? void 0 : N.id,
                      L.channel.id
                    );
                    (null == e ? void 0 : e.type) === "userMention"
                      ? (n = e.userId)
                ...
                if ("text" === r.type) {
                  ...
                  n =
                    null != e.choices
                      ...
                      : e.autocomplete
                        ? H(e, t, L, Number)
                        : Number(v.normalizeNumericString(T.default.locale, t));
                }
                break;
        ...
        if (null != M.subCommandPath)
          for (let e = M.subCommandPath.length - 1; e >= 0; e -= 1) {
            let { name: t, type: n } = M.subCommandPath[e];
            G = [{ type: n, name: t, options: G }];
          }
        if (null != M.execute)
          return (
            c.default.trackWithMetadata(
              P.AnalyticEvents.APPLICATION_COMMAND_USED,
              {
                command_id: M.id,
                application_id: M.applicationId,
                command_type: M.type,
                location:
                  B === D.CommandOrigin.APPLICATION_LAUNCHER
                    ? D.ApplicationCommandTriggerLocations.APP_LAUNCHER
                    : D.ApplicationCommandTriggerLocations.SLASH_UI,
              }
            ),
            M.execute(G, L)
          );
        if (
          M.inputType === D.ApplicationCommandInputType.BUILT_IN ||
          M.inputType === D.ApplicationCommandInputType.BUILT_IN_TEXT ||
          M.inputType === D.ApplicationCommandInputType.BUILT_IN_INTEGRATION
        )
          return;
        let V = {
          version: M.version,
          id:
            null !==
              (h =
                null === (t = M.rootCommand) || void 0 === t ? void 0 : t.id) &&
            void 0 !== h
              ? h
              : M.id,
          guild_id: M.guildId,
        ...
        null != U && (V.target_id = U),
          null != L.autocomplete
            ? (0, O.performAutocomplete)(M, L, V)
            : (r.default.clearAll(L.channel.id, W),
              k({
      ...
      let w = e => {
            ...
            e
              .map(e =>
                "emoji" === e.type
                  ...
                  : "customEmoji" === e.type
                    ? f.default.getCustomEmojiById(e.emojiId)
                    : null
              )
        ...
        k = e => {
          let {
            ...
            E =
              n.type === s.ApplicationCommandType.CHAT
                ? P.MessageTypes.CHAT_INPUT_COMMAND
                : P.MessageTypes.CONTEXT_MENU_COMMAND,
            g = (0, I.default)({
              channelId: _,
              content: "",
              tts: !1,
          ...
          let h = {
            ...
            S = (e, t) => {
              null == t && null != e && o.default.sendClydeError(_, e),
                a.default.dispatch({
          ...
          o.default.receiveMessage(_, g, !0, { applicationId: t }),
            m.addQueued(h.nonce, {
              messageId: g.id,
              onCreate: e => {
      ...
      async function V(e, t, n, i) {
        let l = (0, g.maxFileSize)(n),
          a = e => {
            null == i || i(l, e),
              m.setFailed(
                t,
                P.AbortCodes.ENTITY_TOO_LARGE,
                F.default.Messages.UPLOAD_AREA_TOO_LARGE_HELP.format({
                  maxSize: (0, g.sizeString)(l),
                })
              );
          },
          { totalSize: o, largestUploadedFileSize: r } = await W(e, !1);
        if (
          r >
            Math.max(l, U.DEFAULT_MOBILE_PRE_COMPRESSION_MAX_ATTACHMENT_SIZE) ||
        ...
        try {
          ...
          m.setFailed(
            t,
            void 0,
            F.default.Messages.UPLOADING_FILES_FAILED.format({
              count: e.length,
            })
          );
        }
        ({ totalSize: o, largestUploadedFileSize: r } = await W(e, !0));
    ...
    118851: function (e, t, n) {
      ...
      var i = n("679653"),
        ...
        _ = n("680894");
      function I(e, t, n, p) {
        let { allowUsers: m = !0, allowRoles: I = !0 } = null != p ? p : {};
        switch (e[0]) {
          case "@":
      ...
      function T(e, t, n) {
        ...
        return (
          null != i &&
          ((n === _.CLYDE_AI_USER_ID && "clyde" === e.toLowerCase()) ||
