  ...
  ["31835"],
  {
        ...
        return (
          ...
          (0, s.jsxs)(s.Fragment, {
            children: [
              ...
              !ey && (0, s.jsx)(A.default, { isEligibleForTrial: ev }),
    ...
    628135: function (e, t, n) {
      ...
      var s = n("37983"),
        ...
        T = n("285311"),
        N = n("93902");
      let A = I.default.getEnableHardwareAcceleration()
        ? u.AnimatedAvatar
        : u.Avatar;
      function C(e) {
      ...
      function h(e) {
        let { id: t } = e,
          n = (0, l.useStateFromStores)([p.default], () => {
            var e;
            return null === (e = p.default.getProfileEffectById(t)) ||
              void 0 === e
              ? void 0
              : e.config;
          }),
        ...
        return (
          ...
          (0, s.jsxs)("div", {
            ...
            children: [
              ...
              (0, s.jsx)(S.default, { profileEffectId: t }),
            ],
          })
        );
      }
      function v(e) {
        let { sku: t } = e,
          { selectedGiftStyle: n } = (0, E.useGiftContext)(),
          { product: r } = (0, d.useFetchCollectiblesProduct)(
            null == t ? void 0 : t.id
          ),
          l = null == r ? void 0 : r.items[0],
          u = (0, a.match)(l)
            .with({ type: i.CollectiblesItemType.AVATAR_DECORATION }, e =>
              (0, s.jsx)(C, { avatarDecoration: e })
            )
            .with({ type: i.CollectiblesItemType.PROFILE_EFFECT }, e =>
              (0, s.jsx)(h, { id: e.id })
            )
            .otherwise(() => null);
    ...
    921149: function (e, t, n) {
      ...
      function m() {
        ...
        return (
          ...
          s &&
          m >= 0 &&
          m <= (0, o.getBillingGracePeriodDaysAndExpiresDate)(e).days &&
    ...
    705820: function (e, t, n) {
      ...
      function E(e) {
        let {
          ...
          [v, g] = r.useState((0, o.toRichValue)(C)),
          x = r.useRef(!1);
        return (
          r.useEffect(() => {
            x.current = !0;
    ...
    527866: function (e, t, n) {
      ...
      function Y(e) {
        ...
        let eh = [{ planId: eC.id, quantity: 1 }],
          ...
          D.useSubscriptionEntitlements)(eC.id, eI),
