    ...
    145079: function (e, t, n) {
      ...
      var p = e => {
        ...
        return (0, r.jsx)(c.default, {
          ...
          botType: h(n),
          botVerified: n.isVerifiedBot(),
          discriminator: C || v !== S ? null : null != u ? u : n.discriminator,
          ...E,
        });
      };
    },
      ...
      class N extends i.PureComponent {
            ...
            ? (0, r.jsxs)(A, {
                ...
                children: [
                  (0, r.jsxs)(l.Text, {
                    ...
                    children: [
                      (0, r.jsx)("strong", {
                        ...
                        children:
                          m.default.Messages.MFA_SMS_AUTH_CURRENT_PHONE.format({
                            phoneNumber: e.phone,
                          }),
                      }),
                      (0, r.jsx)(l.Button, {
                  ...
                  (0, r.jsx)(l.Button, {
                    ...
                    children: i
                      ? m.default.Messages.MFA_SMS_DISABLED_PARTNER
                      : n
                        ? m.default.Messages.MFA_SMS_ALREADY_ENABLED
                        : m.default.Messages.MFA_SMS_ENABLE,
                  }),
                ],
              })
            : (0, r.jsx)(A, {
                ...
                children: (0, r.jsx)(l.Button, {
                  ...
                  children: i
                    ? m.default.Messages.MFA_SMS_DISABLED_PARTNER
                    : m.default.Messages.MFA_SMS_ADD_PHONE,
                }),
              });
        }
                ...
                children: [
                  (0, r.jsx)(l.Heading, {
                    ...
                    children: f.default.parse(
                      m.default.Messages.TWO_FA_SUCCESS_HEADER
                    ),
                  }),
                  (0, r.jsx)(l.Text, {
        ...
        renderTotp() {
          ...
          return (0, r.jsxs)(l.ModalRoot, {
            ...
            children: [
              this.renderHeader(
                m.default.Messages.MFA_SMS_ENABLE_SHOULD_DO.format()
              ),
              ...
              t &&
                this.renderConfirmModal(m.default.Messages.TWO_FA_CONFIRM_BODY),
            ],
          });
        }
        renderWebAuthn() {
          ...
          return (0, r.jsxs)(l.ModalRoot, {
            ...
            children: [
              this.renderHeader(
                m.default.Messages.TWO_FA_WEBAUTHN_SHOULD_DO.format()
              ),
              ...
              t &&
                this.renderConfirmModal(
                  m.default.Messages.TWO_FA_CONFIRM_WEBAUTHN_BODY
                ),
            ],
          });
        }
          ...
          super(...e),
            ...
            (this.getDownloadFileContents = () => {
              let e = this.props.backupCodes
                  .map(e => {
                    ...
                    return "* "
                      ...
                      .concat(
                        t
                          ? "(".concat(
                              m.default.Messages.TWO_FA_BACKUP_CODE_USED,
                              ")"
                            )
                          : ""
                      );
                  ...
                  .join("\r\n"),
                t = m.default.Messages.TWO_FA_DISCORD_BACKUP_CODES.format({
    ...
    649844: function (e, t, n) {
      ...
      function _(e) {
        let {
          ...
          V = (0, f.isPremiumExactly)(w, h.PremiumTypes.TIER_2);
        (0, s.openModalLazy)(
          async () => {
      ...
      let E = {
        ...
        h = e => {
          let {
            ...
            { enabled: v } = (0, c.useRedesignIconContext)(),
            m = t;
          if ((!0 === S ? (m = E.DOWN) : !1 === S && (m = E.RIGHT), v)) {
            let e = {
...
//# sourceMappingURL=19cfebe3a7078b4e135e.js.map
