    ...
    145079: function (e, t, n) {
      ...
      var E = e => {
        ...
        return (0, i.jsx)(c.default, {
          ...
          botType: v(n),
          botVerified: n.isVerifiedBot(),
          discriminator: m || S !== C ? null : null != u ? u : n.discriminator,
          ...h,
        });
      };
    },
        ...
        v = e => {
          let [t, n] =
              e instanceof l.default
                ...
                : h(e),
            [r, u, v, p] = (0, s.useStateFromStoresArray)([a.default], () => [
            ...
            m = i.useCallback(e => f(e, E, u, r), [r, u, E]),
            C = i.useCallback(e => f(e, E, p, v), [p, v, E]);
          return null == e
            ? d
            : {
        ...
        p = function (e) {
          ...
          return null == e
            ...
            : {
                ...
                canManageAllExpressions: u,
                canManageAllEvents: p,
                canManageGuildExpression: e => f(e, E, u, s),
                canManageGuildEvent: e => f(e, E, p, v),
              };
        };
    },
    ...
    300322: function (e, t, n) {
      ...
      function S(e) {
        let t = (0, l.useStateFromStores)(
          ...
          () =>
            h.default.can(
              s.default.combine(E.Permissions.CREATE_PRIVATE_THREADS),
              e
            ),
          [e]
        );
      ...
      function I(e, t, n) {
        return (
          !(
            ...
            (null != n &&
              (n.hasFlag(E.MessageFlags.HAS_THREAD) || (0, u.default)(n)))
          ) && !0
        );
      }
      function A(e) {
      ...
      function T(e) {
        return (0, l.useStateFromStoresObject)([p.default, h.default], () => {
          let t = p.default.getActiveJoinedThreadsForParent(e.guild_id, e.id),
            ...
            a = r(i).some(e => h.default.can(E.Permissions.VIEW_CHANNEL, e));
          return {
      ...
      function y(e) {
        return (0, l.useStateFromStores)([h.default], () => V(e, h.default));
      }
      function O(e) {
        let t = (0, o.default)(),
    ...
    671484: function (e, t, n) {
      ...
      i = class e extends l.default {
        ...
        get isSelfRedeemable() {
          return !(0, a.hasFlag)(this.flags, c.NOT_SELF_REDEEMABLE);
        }
      ...
      let h = {
        ...
        v = e => {
          let {
            ...
            g = t;
          if ((!0 === C ? (g = h.DOWN) : !1 === C && (g = h.RIGHT), S)) {
            let e = {
...
//# sourceMappingURL=5a444592878f3e19cd9e.js.map
