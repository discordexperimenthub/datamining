    ...
    788506: function (e, t, i) {
      ...
      let A = function (e, t) {
          ...
          let a = (0, y.isExternalEmojiAllowedForIntention)(e),
            ...
            _ = (0, r.useStateFromStoresArray)(
              [E.default],
              () => E.default.getSortedPackIds(),
              []
            ),
            { topEmojis: g, newlyAddedEmojis: O } = (0, p.default)(i, e),
            { allEmojis: T } = (0, I.default)({
              topEmojis: g,
              newlyAddedEmojis: O,
            }),
            { viewAndUseEnabled: j } = (0,
            l.useInventoryGuildPacksUserExperiment)({ autoTrackExposure: !1 }),
            A = (0, r.useStateFromStores)(
              [o.default],
              () => o.default.getDisambiguatedEmojiContext(i),
              [i]
            ),
            h = (0, r.useStateFromStores)([c.default], () => {
              var e;
              return null === (e = c.default.getGuild(i)) || void 0 === e
                ? void 0
                : e.name;
            }),
            M = n.useMemo(() => {
              let n = A.getGroupedCustomEmoji(),
                ...
                l = (r, a) => {
                  for (let o of r) {
                    let r;
                    if (
                      (a === C.EmojiCategoryTypes.PACK
                        ? (r = E.default.getPackByPackId({ packId: o }))
                        : a === C.EmojiCategoryTypes.GUILD &&
                          (r = c.default.getGuild(o)),
                      null == r)
                    )
                      continue;
                    ...
                    if (a === C.EmojiCategoryTypes.PACK) {
                      ...
                      a === C.EmojiCategoryTypes.GUILD &&
                        (l = { type: C.EmojiCategoryTypes.GUILD, guild: r });
                    null != l && (r.id === i ? u.unshift(l) : u.push(l));
                  }
                };
              return (
                l(_, C.EmojiCategoryTypes.PACK),
                l(r, C.EmojiCategoryTypes.GUILD),
                o.default.categories.reduce((t, n) => {
        ...
        R = (e, t, i, n, r) => {
          a.default.trackWithMetadata(O.AnalyticEvents.SEARCH_RESULT_VIEWED, {
            search_type:
              null != r && r === y.EmojiIntention.REACTION
                ? O.SearchTypes.EMOJI_REACTION
                : O.SearchTypes.EMOJI,
            total_results: e,
        ...
        N = (e, t, i, n) => {
          ...
          a.default.trackWithMetadata(O.AnalyticEvents.SEARCH_RESULT_SELECTED, {
            search_type:
              null != n && n === y.EmojiIntention.REACTION
                ? O.SearchTypes.EMOJI_REACTION
                : O.SearchTypes.EMOJI,
            location: t,
            expression_guild_id: U(e),
            expression_pack_id:
              e.type === s.EmojiTypes.PACK ? e.packId : void 0,
            emoji_id: e.id,
            emoji_name: o,
            is_custom: null != e.id,
        ...
        F = e => {
          ...
          switch (o) {
            case y.EmojiIntention.REACTION:
              i = c
                ? j.PremiumUpsellTypes.EMOJI_PICKER_SUPER_REACTION_EMOJI_CLICKED
                : j.PremiumUpsellTypes.EMOJI_PICKER_REACTION_EMOJI_CLICKED;
              break;
          ...
          a.default.trackWithMetadata(
            O.AnalyticEvents.EXPRESSION_PICKER_EXPRESSION_SELECTED,
            {
              ...
              expression_pack_id:
                n.type === s.EmojiTypes.PACK ? n.packId : void 0,
              is_custom: null != n.id,
        ...
        D = e => {
          ...
          a.default.trackWithMetadata(O.AnalyticEvents.EXPRESSION_FAVORITED, {
            ...
            expression_pack_id:
              i.type === s.EmojiTypes.PACK ? i.packId : void 0,
            is_custom: null != i.id,
      ...
      let L = (e, t, i) => {
        ...
        k = (e, t, i) => {
          switch (e) {
            ...
            default:
              return null != i
                ? S.default.Messages.EMOJI_CATEGORY_PACK.format({ packName: i })
                : null != t
                  ? t
                  : e;
          }
      ...
      function x(e) {
        return (
          ...
          (0, r.useStateFromStoresArray)([o.default], () =>
            o.default
        ...
        n.default.trackWithMetadata(
            ...
            : d.AnalyticEvents.EXPRESSION_PICKER_OPENED,
          {
            ...
            num_animated_expressions_newly_added: P.filter(e => e.animated)
              .length,
            ...(i === c.EmojiIntention.REACTION && { is_burst: g }),
