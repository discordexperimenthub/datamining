  ...
  ["41875"],
  {
    ...
    699668: function (e, t, n) {
      ...
      function G(e, t) {
        ...
        let u = (0, o.useStateFromStoresArray)([T.default], () =>
            Object.values(T.default.getGuilds())
          ),
          d = i.useCallback(() => {
            let i = {};
            for (let a of u)
              i[a.id] = (function (e, t, n, i, a) {
                var s;
                let [l, r, o] = _.default.hasConsented(
                    R.Consents.PERSONALIZATION
                  )
                    ? (0, M.guessGuildModeWithRemoteData)(e, t, n, i, !0)
                  ...
                  u =
                    ...
                    void 0 !== s
                      ? s
                      : {},
                  d = (0, A.default)(e, null != a ? a : l, u, i, t);
                return {
                  guildId: e.id,
                  mode: l,
                  debugReason: o,
                  ...
                  visitsALot: r,
                  muted:
                    v.default.isMuted(e.id) &&
                    !v.default.isTemporarilyMuted(e.id),
                };
              })(a, n, e, t, s[a.id]);
            return i;
          }, [u, n, e, t, s]),
      ...
      function U() {
        ...
        for (let a of e) {
          ...
          let e =
              null !==
                (n = v.default.getAllSettings().userGuildSettings[a.id]) &&
              void 0 !== n
                ? n
                : {},
        ...
        F(t),
          I.default.track(R.AnalyticEvents.NOTIFICATION_MIGRATION_COMPLETED, {
            auto_migrated: !0,
            num_unread_guids_after: e.filter(e => p.default.hasUnread(e.id))
              .length,
          });
      }
      function j(e) {
          ...
          let t = Object.values(e)
              ...
              .map(e => {
                ...
                return {
                  plan: e,
                  memberCount:
                    null !== (t = S.default.getMemberCount(e.guildId)) &&
                    void 0 !== t
                      ? t
                      : 0,
                };
            ...
            n = {
              num_unread_guilds_before: Object.keys(e).filter(e =>
                p.default.hasUnread(e)
              ).length,
              unmuted_server_ids: t
                .filter(e => v.default.isMuted(e.plan.guildId))
        ...
        try {
          ...
          for (let n of Object.values(e)) {
            ...
            let e =
                null !==
                  (i =
                    v.default.getAllSettings().userGuildSettings[n.guildId]) &&
                void 0 !== i
                  ? i
                  : {},
              s = {};
      ...
      async function W() {
        u.default.set("turnedOffNewNotifications", !0),
          I.default.track(R.AnalyticEvents.NOTIFICATION_MIGRATION_OPTOUT, {
            num_guilds_with_new_setting: Object.values(
              T.default.getGuilds()
            ).filter(
              e =>
                v.default.resolveGuildUnreadSetting(e) ===
