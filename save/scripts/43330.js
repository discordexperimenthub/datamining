(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["43330"],
  {
      ...
      function A(e, t) {
        switch (e.type) {
          ...
          case R.ChannelTypes.GUILD_TEXT:
            ...
            else if ((0, _.default)(e)) return i.default;
          ...
          case R.ChannelTypes.GUILD_VOICE:
            if ((0, _.default)(e)) return E.default;
            return T.default;
    ...
    689226: function (e, t, a) {
      ...
      let i = ""
        ...
        C = (e, t) => {
          ...
          null != window.GLOBAL_ENV.CDN_HOST)
            ? ""
                ...
                .concat(c)
                .concat(f)
            : "".concat(o).concat(u.Endpoints.ROLE_ICON(a, l), "?").concat(c);
        },
        h = e =>
          e.startsWith(i) ||
        ...
        m = (e, t) => {
          ...
          return l || e.features.has(u.GuildFeatures.ROLE_ICONS);
        };
    },
          ...
          children: (0, l.jsxs)("div", {
            ...
            children: [
              ...
              (0, l.jsx)(u.default, {
                ...
                goToThread: (e, t) => {
                  a(),
                    (0, i.openThreadSidebarForViewing)(
                      e,
                      !t,
    ...
    913979: function (e, t, a) {
      ...
      var l = a("37983"),
        ...
        v = n.memo(function (e) {
          let { threadId: t, goToThread: n, showChannelName: o } = e,
            ...
            c = (0, r.useStateFromStores)([i.default], () =>
              i.default.getChannel(d.parent_id)
            );
      ...
      function g(e) {
        let { channel: t } = e,
          ...
          u = (0, r.useStateFromStoresArray)([d.default], () =>
    ...
    442184: function (e, t, a) {
      ...
      function j(e) {
        let { channel: t } = e,
          a = (0, S.useLastMessageTimestamp)(t);
        return (0, l.jsxs)(s.Text, {
          ...
          children: [
            ...
            "\xa0 • \xa0",
            (0, S.getTimestampString)(a),
          ],
        });
      }
      function _(e) {
        let { channel: t, message: a } = e;
        (0, i.useSubscribeGuildMembers)({ [t.guild_id]: [a.author.id] });
          ...
          x = n.useMemo(() => {
            let e =
                  ...
                  : null,
              {
                ...
                renderedContent: n,
                icon: r,
              } = (0, g.renderSingleLineMessage)(a, e, v, T.messageContent, {
        ...
        return (0, l.jsxs)(s.Text, {
          ...
          children: [
            ...
            x,
            "\xa0 • \xa0",
            (0, S.getTimestampString)(p.default.extractTimestamp(a.id)),
          ],
        });
      }
      function R(e) {
        ...
        (0, i.useSubscribeGuildMembers)({ [d.guild_id]: [d.ownerId] });
        let g = (0, r.useStateFromStores)([m.default], () =>
          ...
          L = null !== (n = (0, o.default)(d)) && void 0 !== n ? n : v.default;
            ...
            null == g
              ? (0, l.jsxs)(l.Fragment, {
                  children: [
                    (0, l.jsx)("div", {
                      ...
                      children: (0, l.jsx)(L, { width: 10, height: 10 }),
                    }),
              ...
              : (0, l.jsxs)(l.Fragment, {
                  children: [
                    ...
                    (0, l.jsx)("span", { className: T.bullet, children: "•" }),
                    M.default.Messages.THREAD_BROWSER_LAST_ACTIVE_TIME.format({
                      time: (0, S.getTimestampString)(h),
                    }),
                  ],
...
//# sourceMappingURL=ca798aef24c6ed74d611.js.map
