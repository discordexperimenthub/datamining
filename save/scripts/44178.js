  ...
  ["44178"],
  {
    ...
    145079: function (e, t, n) {
      ...
      var m = e => {
        ...
        return (0, i.jsx)(c.default, {
          ...
          botType: v(n),
          botVerified: n.isVerifiedBot(),
          discriminator: E || g !== C ? null : null != u ? u : n.discriminator,
          ...h,
        });
      };
    },
        ...
        h = (e, t) => {
          ...
          null != window.GLOBAL_ENV.CDN_HOST)
            ? ""
                ...
                .concat(d)
                .concat(f)
            : "".concat(u).concat(o.Endpoints.ROLE_ICON(n, i), "?").concat(d);
        },
        v = e =>
          e.startsWith(a) ||
    ...
    270161: function (e, t, n) {
      ...
      let l = s.Permissions.VIEW_CHANNEL,
        o = i.combine(l, s.Permissions.CONNECT),
        a = i.combine(l, r.MODERATE_STAGE_CHANNEL_PERMISSIONS);
    },
        ...
        v = e => {
          let [t, n] =
              e instanceof l.default
                ...
                : h(e),
            [r, u, v, p] = (0, s.useStateFromStoresArray)([o.default], () => [
              o.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e),
              o.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e),
              o.default.can(t, e),
              o.default.can(n, e),
            ]),
            m = (0, s.useStateFromStores)([a.default], () =>
              a.default.getCurrentUser()
            ),
            E = i.useCallback(e => f(e, m, u, r), [r, u, m]),
            C = i.useCallback(e => f(e, m, p, v), [p, v, m]);
          return null == e
            ? d
            : {
        ...
        p = function (e) {
          ...
          return null == e
            ...
            : {
                ...
                canManageGuildEvent: e => f(e, m, p, v),
              };
        };
    },
    ...
    300322: function (e, t, n) {
      ...
      function x(e) {
        return (0, l.useStateFromStoresObject)([p.default, h.default], () => {
          let t = p.default.getActiveJoinedThreadsForParent(e.guild_id, e.id),
            n = p.default.getActiveJoinedRelevantThreadsForParent(
              e.guild_id,
              e.id
            ),
            ...
            o = r(i).some(e => h.default.can(m.Permissions.VIEW_CHANNEL, e));
          return {
            hasActiveThreads: s || l || o,
            hasMoreActiveThreads: o || l,
          };
        });
      }
      function T(e) {
      ...
      function R(e) {
        let t = (0, l.useStateFromStores)([h.default], () => A(e, h.default)),
          n = V(e);
        return b(e, t, n);
      }
      function M(e) {
      ...
      function V(e) {
        return (0, l.useStateFromStores)([h.default], () => P(e, h.default));
      }
      function j(e) {
        let t = (0, a.default)(),
      ...
      i = class e extends l.default {
        static createFromServer(t) {
          return new e({
            ...
            subscriptionPlan:
              null != t.subscription_plan
                ? a.default.createFromServer(t.subscription_plan)
                : null,
            revoked: !1,
            entitlementBranches:
      ...
      let h = {
        ...
        v = e => {
          let {
            ...
            _ = t;
          if ((!0 === C ? (_ = h.DOWN) : !1 === C && (_ = h.RIGHT), g)) {
            let e = {
...
//# sourceMappingURL=c2ae87dd694b4e215ff9.js.map
