(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["47387"],
  {
    ...
    400307: function (e, t, n) {
      ...
      function er(e) {
        let t,
          { text: n, className: i, colorOptions: r = 2 } = e;
        switch (r) {
          case 1:
            t =
      ...
      function eo(e) {
        ...
        if (
          ...
          let e =
            ...
            n = y.default.formatPriceString(
              y.default.getDefaultPrice(t.id),
              t.interval
            );
          return (0, u.jsx)(u.Fragment, {
        ...
        if (!t && i) {
          var T, P, p, S;
          let e = y.default.formatPriceString(
            y.default.getDefaultPrice(
              n === W.PremiumTypes.TIER_0
            ...
            children:
              0 === r
                ? X.default.Messages.PREMIUM_TIER_CARD_TRIAL_HEADER_BEFORE_REDEMPTION_NEW.format(
                    {
                      planName: (0, y.getTierDisplayName)(
                        null !==
                          (P =
          ...
          children: [
            (0, u.jsx)(es, {
              ...
              text: X.default.Messages.PREMIUM_TIER_UPLOAD_ITEM.format({
                maxUploadPremium: (0, y.getMaxFileSizeForPremiumType)(
                ...
                text: X.default.Messages.PREMIUM_TIER_SERVER_BOOST_WITH_PERCENTAGE_ITEM.format(
                  {
                    ...
                    percentageOff: (0, j.formatPercent)(
                      r,
      ...
      function em(e) {
        ...
        let {
          ...
          f = (0, _.useStateFromStores)([M.default], () =>
            M.default.getPremiumTypeSubscription()
          ),
          E = (0, _.useStateFromStores)([O.default], () =>
            O.default.getCurrentUser()
          ),
          T = (0, k.usePremiumTrialOffer)(),
          P =
            null == T
              ? void 0
          ...
          p =
            (null == f ? void 0 : f.trialId) != null
              ? null == E
                ...
                : E.premiumType
              : null,
          S = (0, G.useIsInPremiumOfferExperience)(),
          R = (0, H.usePremiumDiscountOffer)(),
          C = (0, G.useHasDiscountApplied)(),
          L = null != P || null != p ? 0 : null != R || C ? 1 : null,
          v = (0, V.useIsEligibleForBogoPromotion)(),
          U = (0, V.getBOGOPillCopy)();
        return (0, u.jsxs)("div", {
          ...
          children: [
            !d &&
            null != R &&
            (0, H.discountOfferHasTier)(R, W.PremiumSubscriptionSKUs.TIER_2) &&
            (null === (n = R.discount) || void 0 === n ? void 0 : n.amount) !==
              void 0
              ? (0, u.jsxs)(u.Fragment, {
                  children: [
                    (0, u.jsx)(er, {
              ...
              : null,
            d || P !== W.PremiumSubscriptionSKUs.TIER_2
              ? null
              : (0, u.jsxs)(u.Fragment, {
                  children: [
                    (0, u.jsx)(er, {
            ...
            (0, u.jsxs)("div", {
              children: [
                ...
                !d &&
                  P !== W.PremiumSubscriptionSKUs.TIER_2 &&
                  v &&
                  (0, u.jsx)(I.Text, {
                    variant: "text-xs/bold",
                ...
                (0, u.jsx)(ec, { featureSet: a, isModal: m, isGift: d }),
              ],
            }),
            l,
            d || (P !== W.PremiumSubscriptionSKUs.TIER_2 && null == R)
              ? null
