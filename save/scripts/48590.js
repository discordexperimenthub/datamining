      ...
      var eo = {
          ...
          t =
            null != l
              ? u(N.default.getChannels(l)[c])
                  ...
                  .value()
              : u(I.default.loadAllGuildAndPrivateChannelsFromDisk())
                  .values()
                ...
                for (let n of [
                  ...
                  (function (e, t) {
                    ...
                    if (null == n) {
                      var l;
                      n = t[e.parent_id] =
                        null === (l = I.default.getChannel(e.parent_id)) ||
                        void 0 === l
                          ? void 0
        ...
        queryGroupDMs(e) {
          let {
            ...
            d = u(I.default.getMutablePrivateChannels()).values().value(),
            f = [];
          for (let e of d) {
