    ...
    633701: function (e, a, r) {
      ...
      var o = {
        ...
        "creditCard.holderName.invalid":
          "Introduzca el nombre como se muestra en la tarjeta",
        ...
        "address.errors.incomplete":
          "Introduzca una direcci\xf3n para continuar",
        ...
        "creditCard.cvcField.title.optional":
          "C\xf3digo de seguridad (opcional)",
        ...
        "creditCard.taxNumber":
          "Fecha de nacimiento del titular o n\xfamero de registro comercial",
        ...
        "error.va.sf-cc-dat.03":
          "La tarjeta de cr\xe9dito est\xe1 a punto de caducar",
        ...
        "error.va.sf-cc-cvc.02":
          "Introduzca el c\xf3digo de seguridad completo",
        "error.va.sf-ach-num.01":
          "El campo del n\xfamero de cuenta bancaria est\xe1 vac\xedo",
        "error.va.sf-ach-num.02":
          "El n\xfamero de cuenta bancaria no tiene la longitud correcta",
        "error.va.sf-ach-loc.01":
          "El campo del n\xfamero de ruta bancaria est\xe1 vac\xedo",
        "error.va.sf-ach-loc.02":
          "El n\xfamero de ruta bancaria no tiene la longitud correcta",
        "error.va.sf-kcp-pwd.01":
          "El campo de la contrase\xf1a est\xe1 vac\xedo",
        "error.va.sf-kcp-pwd.02":
          "La contrase\xf1a no tiene la longitud correcta",
        ...
        invalidFormatExpects:
          "Formato no v\xe1lido. Formato correcto: %{format}",
        "upi.qrCodeWaitingMessage":
          "Escanee el c\xf3digo QR con la aplicaci\xf3n UPI que prefiera para completar el pago",
        "upi.vpaWaitingMessage":
          "Abra la aplicaci\xf3n UPI para confirmar el pago",
        "upi.modeSelection": "Seleccione c\xf3mo le gustar\xeda usar UPI.",
        "onlineBanking.termsAndConditions":
          "Al continuar, usted acepta los %#T\xe9rminos y condiciones%#",
        ...
        "ctp.loading.intro":
          "Estamos comprobando si tiene alguna tarjeta guardada con Click to Pay...",
        ...
        "ctp.otp.subtitle":
          "Introduzca el c\xf3digo %@ que le hemos enviado a %@ para verificar que es usted.",
        "ctp.emptyProfile.message":
          "No hay tarjetas registradas en este perfil de Click to Pay",
        ...
        "ctp.infoPopup.title":
          "Click to Pay ofrece la comodidad de la funci\xf3n sin contacto en internet",
        ...
        "ctp.infoPopup.benefit1":
          "Click to Pay utiliza cifrado para mantener su informaci\xf3n segura y protegida",
        "ctp.infoPopup.benefit2":
          "Util\xedcelo con vendedores de todo el mundo",
        "ctp.infoPopup.benefit3":
          "Config\xfarela una vez para realizar pagos sin complicaciones en el futuro",
        ...
        "ctp.errors.FRAUD":
          "Se ha bloqueado o desactivado la cuenta de usuario",
        "ctp.errors.CONSUMER_ID_MISSING":
          "Falta la identidad del consumidor en la solicitud",
        "ctp.errors.ACCT_INACCESSIBLE":
          "Esta cuenta no est\xe1 disponible en este momento, por ejemplo, est\xe1 bloqueada",
        ...
        "ctp.errors.OTP_SEND_FAILED":
          "No se ha podido enviar la contrase\xf1a de un solo uso al destinatario",
        ...
        "companyDetails.registrationNumber.invalid":
          "Introduzca el n\xfamero de registro",
        "consent.checkbox.invalid":
          "Debe aceptar los t\xe9rminos y condiciones",
        "form.instruction":
        ...
        "trustly.description2":
          "Sin tarjetas, sin descarga de aplicaciones, sin registro",
      };
    },
  },
]);
//# sourceMappingURL=2a124e6e2dc0fbbb57eb.js.map
