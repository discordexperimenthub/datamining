  ...
  ["51955"],
  {
    ...
    18054: function (e, t, n) {
      ...
      function p(e) {
        ...
        a.HTTP.del({ url: u.Endpoints.CHANNEL(e), oldFormErrors: !0 }).then(
          () => {
      ...
      class eO extends s.PureComponent {
        ...
        componentDidUpdate(e, t) {
          ...
          if (e.hasModalOpen && !this.props.hasModalOpen) {
            ...
            e !== a && this.setState((0, R.createState)(e));
          }
                ...
                if (null != n && n.length > 0) {
                  ...
                  null != a && a.length > 0
                    ? "" !== t
                      ...
                      : f.default.sendStickers(o.id, a, t, E, m.tts)
                    : f.default.sendMessage(o.id, m, void 0, E);
                return (
            ...
            (this.renderMessageBanner = e => {
              ...
              return t.type === eN.ChannelTypes.DM && n
                ...
                : null != l &&
                  ...
                  : i
                    ? (0, a.jsx)(
                        H.AutomodUserProfileQuarantineChatInputNotice,
                        { guild: s }
                      )
                    : null;
            });
    ...
    361528: function (e, t, n) {
      ...
      var a = n("37983"),
        ...
        f = s.memo(function (e) {
          ...
          if (null == t)
            return (0, a.jsx)(a.Fragment, { children: s.Children.only(A) });
          let I = null;
          return (
            null != E
    ...
    306588: function (e, t, n) {
      ...
      class U extends s.PureComponent {
        ...
        render() {
          ...
          if (e && !p)
            (N.message = H.default.Messages.FOLLOW_NEWS_CHAT_INPUT_MESSAGE),
              null != m &&
                m >= 1e3 &&
                (N.subtitle =
                  H.default.Messages.FOLLOW_NEWS_CHAT_INPUT_SUBTITLE.format({
                    count: (1e3 * Math.floor(m / 1e3)).toLocaleString(),
                  })),
              (N.buttonText = H.default.Messages.FOLLOW),
              (N.onButtonClick = this.handleFollowAnnouncement),
              (N.imageSrc = n("757000")),
              t &&
                ((N.onSecondaryButtonClick = this.handleJoinServer),
                (N.secondaryButtonText =
                  H.default.Messages.LURKER_MODE_CHAT_INPUT_BUTTON));
          else if (l)
            (N.message =
              H.default.Messages.GUILD_VERIFICATION_TEXT_NOT_CLAIMED),
              (N.buttonText = H.default.Messages.CLAIM_ACCOUNT),
              (N.onButtonClick = S
            ...
            switch (null == _ ? void 0 : _.applicationStatus) {
              case E.GuildJoinRequestApplicationStatuses.SUBMITTED:
                (N.message =
                  H.default.Messages.MEMBER_VERIFICATION_APPLICATION_CONFIRMATION_TITLE),
                  (N.subtitle =
                    H.default.Messages.MEMBER_VERIFICATION_APPLICATION_CONFIRMATION_SUBTITLE),
                  (N.buttonText =
                    H.default.Messages.MEMBER_VERIFICATION_CANCEL_APPLICATION),
                  (N.onButtonClick = this.handleCancelApplication),
                  (N.imageSrc = n("897176"));
                break;
              case E.GuildJoinRequestApplicationStatuses.REJECTED:
                (N.message =
                  H.default.Messages.MEMBER_VERIFICATION_REJECTED_TITLE),
                  (N.buttonText =
                    H.default.Messages.MEMBER_VERIFICATION_LEARN_MORE),
                  (N.onButtonClick = this.handleViewApplicationRejection),
                  (N.imageSrc = n("376180"));
                break;
              default:
                (N.message =
                  H.default.Messages.MEMBER_VERIFICATION_CHAT_BLOCKER_TEXT),
                  (N.buttonText =
                    H.default.Messages.MEMBER_VERIFICATION_NOTICE_CTA),
            ...
            i && !A
              ? ((N.message =
                  H.default.Messages.GUILD_VERIFICATION_TEXT_NOT_PHONE_VERIFIED),
                (N.buttonText = H.default.Messages.VERIFY_PHONE),
                (N.onButtonClick = this.handleVerifyPhone),
                (N.imageSrc = n("958347")))
              : r
                ? ((N.message =
                    H.default.Messages.GUILD_VERIFICATION_TEXT_NOT_VERIFIED),
                  (N.buttonText = H.default.Messages.RESEND_VERIFICATION_EMAIL),
                  (N.onButtonClick = this.handleResendVerification),
                  (N.imageSrc = n("524939")))
                : u
                  ? ((N.message =
                      H.default.Messages.GUILD_VERIFICATION_TEXT_MEMBER_AGE.format(
                        { min: b.VerificationCriteria.MEMBER_AGE }
                      )),
                    (N.countdown = d))
                  : c &&
                    ((N.message =
                      H.default.Messages.GUILD_VERIFICATION_TEXT_ACCOUNT_AGE.format(
                ...
                (0, o.openModal)(e =>
                  (0, a.jsx)(o.ConfirmModal, {
                    ...
                    children: (0, a.jsx)(o.Text, {
                      variant: "text-md/normal",
                      children:
                        H.default.Messages.VERIFICATION_EMAIL_BODY.format({
                          email: t,
                        }),
                    }),
                  })
      ...
      function G(e) {
        ...
        return (0, a.jsx)(U, { ...j, channel: s, children: l });
      }
    },
          ...
          children: e => {
            ...
            switch (t) {
              case i.DismissibleContent.ACTIVITIES_CHAT_BUTTON_NUX:
                return (0, a.jsx)(c.OmniButtonNuxAnimation, { children: h });
    ...
    79254: function (e, t, n) {
      ...
      function H(e) {
        ...
        let { analyticsLocations: F } = (0, f.default)();
        s.useEffect(() => {
        ...
        return (0, a.jsx)(o.Menu, {
          ...
          children: i.map(function (e) {
            ...
            let s = (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsx)(e.icon, { className: P.optionIcon }),
                (0, a.jsx)("div", {
            ...
            switch (e.type) {
              case L.AttachmentTypes.UPLOAD_A_FILE:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "upload-file", label: s, action: u },
                  "upload-file"
                );
              case L.AttachmentTypes.UPLOAD_TEXT_AS_FILE:
                ...
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "upload-text-as-file", label: s, action: W },
                  "upload-text-as-file"
                );
              case L.AttachmentTypes.CLIPS:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "clips", label: s, action: B },
                  "clips"
                );
              case L.AttachmentTypes.POLL:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "poll", label: s, action: V },
                  "poll"
                );
                  ...
                  o.MenuItem,
                  {
                    ...
                    action: () => {
                      ...
                      return (
                        ...
                        j(n, t, R.ActivityActionTypes.JOIN, F))
                      );
                    },
                  },
                  "play"
                  ...
                  o.MenuItem,
                  {
                    ...
                    action: () => {
                      ...
                      return (
                        ...
                        j(n, t, R.ActivityActionTypes.LISTEN, F))
                      );
                    },
                  },
                  "listen"
                  ...
                  o.MenuItem,
                  {
                    ...
                    action: () => {
                      ...
                      return (
                        ...
                        j(n, t, R.ActivityActionTypes.WATCH, F))
                      );
                    },
                  },
                  "watch"
              ...
              case L.AttachmentTypes.CREATE_THREAD:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "THREAD", label: s, action: U },
                  "THREAD"
                );
              case L.AttachmentTypes.SLASH_COMMAND:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "SLASH_COMMAND", label: s, action: G },
                  "SLASH_COMMAND"
                );
            ...
            ? (0, a.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, a.jsxs)("div", {
                    ...
                    children: [
                      (0, a.jsx)(R, { channelId: n.id, otherUserId: t }),
            ...
            : !0 === l.isMobile || h
              ...
              : (0, a.jsxs)("div", {
                  ...
                  children: [
                    ...
                    !s && (0, a.jsx)(A.default, { otherUserId: t, channel: n }),
                  ],
                });
      };
    },
    ...
    34695: function (e, t, n) {
      ...
      function O(e) {
        let { canManageRoles: t, channel: n } = e,
          ...
          r = (0, d.default)(n.id);
        if (r) return null;
        if (n.isForumPost()) return (0, a.jsx)(A.default, { channel: n });
      ...
      function D(e) {
        ...
        if (n.isMultiUserDM())
          return n.isManaged()
            ? (0, a.jsxs)(T.default, {
                channelId: n.id,
                children: [
                  (0, a.jsx)(T.EmptyMessageHeader, {
                    children:
                      R.default.Messages.BEGINNING_CHANNEL_WELCOME.format({
                        channelName: d,
                      }),
                  }),
                  (0, a.jsx)(T.EmptyMessageBody, {
        ...
        return N
          ...
          : (0, a.jsx)(T.default, {
              channelId: n.id,
              children: (0, a.jsx)(T.EmptyMessageBody, {
                children:
        ...
        return (0, a.jsxs)(c.default, {
          ...
          children: [
            (0, a.jsx)("div", {
              ...
              children: (0, a.jsx)(E, { className: h.icon, strokeWidth: 1.75 }),
            }),
    ...
    931922: function (e, t, n) {
      ...
      function b(e) {
        let { channel: t } = e,
          ...
          H = (0, c.useStateFromStores)([_.default, T.default], () => {
            var e;
    ...
    554393: function (e, t, n) {
      ...
      function b(e) {
        ...
        if (
          (s.useEffect(() => {
            if (null != H) U(Math.floor((H - 280) / 58)), es(!1);
          }, [H]),
          null == W || null == Z)
        )
          return null;
    ...
    557809: function (e, t, n) {
          ...
          case I.ChannelTypes.GROUP_DM:
            ...
            return (0, a.jsxs)(s.Fragment, {
              children: [
                ...
                (0, a.jsx)(T.default, { channel: t }, "channel-".concat(t.id)),
              ],
            });
          case I.ChannelTypes.GUILD_ANNOUNCEMENT:
          case I.ChannelTypes.GUILD_TEXT:
      ...
      function R(e, t) {
        switch (e.type) {
          ...
          case I.ChannelTypes.GROUP_DM:
            return null != t
              ? (0, a.jsx)(A.default, { channel: e, guild: t }, e.id)
              : null;
          default:
            return null;
        }
    ...
    16108: function (e, t, n) {
      ...
      function c(e) {
        return a.HTTP.del({ url: r.Endpoints.CHANNEL_RECIPIENT_CONSENT(e) });
      }
      function f(e) {
        return a.HTTP.put({
          ...
          O = a.useCallback(
            async e => {
              if (!R) {
                _(!0);
                try {
                  await (0, f.rejectMessageRequest)(e), L(!0), null == s || s();
                } catch (t) {
                  let e = new i.APIError(t);
                  null == E || E(e);
                } finally {
      ...
      function d(e) {
        ...
        return (
          f.forEach(e => {
            ...
            n === e.id && (d = j);
            let { jumpSequenceId: b, jumpFlash: k, jumpTargetId: H } = f;
            k && e.id === H && null != b && (j.flashKey = b),
    ...
    556118: function (e, t, n) {
      ...
      function Y(e) {
        ...
        let { ...f } = (0, u.useListItem)(
          ...
          m = (0, x.default)(s),
          g = (0, R.getMessageAriaLabelledBy)(s),
          S = (0, R.getMessageAriaDescribedBy)(s);
        return s.type === W.MessageTypes.THREAD_STARTER_MESSAGE &&
          null != h &&
          h.state === E.ReferencedMessageState.LOADED
          ? (0, a.jsx)(X, { ...e, message: h.message, groupId: h.message.id })
          : (0, a.jsx)(_.default, {
              ...f,
              id: n,
              compact: r,
            ...
            children: (0, a.jsx)("li", {
              ...
              children: (0, a.jsx)(_.default, {
                ...
                className: i(q, {
                  ...
                  [z.groupStart]: !$ && (eF || g.type === W.MessageTypes.REPLY),
                  [z.selected]: eA,
      ...
      function M(e) {
        ...
        return I
          ? (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsxs)(o.Clickable, {
                  ...
                  onClick: L,
                  children: [
                    (0, a.jsx)(f.default, { sticker: x, size: 24 }),
                    (0, a.jsx)(o.Text, {
                      className: A.text,
          ...
          : (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsx)(f.default, { sticker: x, size: 160 }),
                (0, a.jsx)(o.Button, {
                  className: A.button,
                  onClick: L,
                  disabled: !!l,
    ...
    823674: function (e, t, n) {
      ...
      function er(e) {
        let {
            ...
            n.type === et.MessageTypes.AUTO_MODERATION_ACTION && (H = H && R);
            let F = (0, K.canReportMessage)(n),
              U = (0, X.default)(n, t, R),
        ...
        function (e) {
          ...
          let {
            ...
            G = (0, D.default)({
              ...
              canLoadMore: null == L,
              handleScrollToBottom: s.useCallback(() => F(!0), [F]),
              handleScrollFromBottom: s.useCallback(() => F(!1), [F]),
            }),
            B = (0, O.default)({
              scrollerRef: G.ref,
              isEditing: null != I,
          ...
          a.useCallback(
            n => {
              ...
              switch (n.key.toLowerCase()) {
                case "backspace":
                  D &&
                    (v(F) || H.canDeleteOwnMessage(U)) &&
                    (n.preventDefault(), (0, I.deleteMessage)(F, H, n));
                  break;
                case "c":
                  ((0, S.isMac)() ? b : j) &&
                    E.SUPPORTS_COPY &&
                    (n.preventDefault(), (0, E.copy)(H.content));
                  break;
                case "e":
                  if (D) {
                    if (
                      ...
                      (L = F),
                      (R = H),
                      !L.isSystemDM() && (0, A.default)(R, a))
                    )
                      n.preventDefault(), (0, I.editMessage)(F, H);
                  }
                  break;
                case "p":
                  if (D || k) {
                    if (
                      ...
                      n.preventDefault(), (0, I.pinMessage)(F, H, n);
                  }
                  break;
                case "+":
                  (D || k) &&
                ...
                case "r":
                  (D || k) &&
                    (0, i.canReplyToMessage)(F, H) &&
                    (n.preventDefault(), (0, I.replyToMessage)(F, H, n));
                  break;
                case "t":
                  if (D && (0, r.computeCanStartPublicThread)(F, H))
                    n.preventDefault(),
                    ...
                    let e = c.default.getChannel(
                      T.default.castMessageIdAsChannelId(H.id)
                    );
                    null != e &&
                      (D || k) &&
                      (n.preventDefault(),
                  ...
                  break;
                case "enter":
                  P && (n.preventDefault(), (0, I.markMessageUnread)(F, H));
                  break;
                case "escape":
                  f.default.isEditing(F.id, H.id)
                    ? s.default.endEditMessage(F.id)
    ...
    221068: function (e, t, n) {
      ...
      function $(e) {
        ...
        let n,
          ...
          eu = () => es.isInitialized() || F.ready,
          ed = (0, H.useShowConvoStarterInDM)(R),
          ec =
            F.length > 0 &&
            (null === (t = F.first()) || void 0 === t
              ? void 0
        ...
        R.isDM() &&
          ...
          (n =
            eE.type === m.SafetyWarningTypes.STRANGER_DANGER
              ? (0, a.jsx)(T.StrangerDangerWarningBanner, {
                  channelId: R.id,
                  warningId: eE.id,
        ...
        if (
          ...
          ((e && eu()) || !e) &&
            eA.unshift(
              (0, a.jsx)(w.default, { compact: et, ...el }, "has-more")
            );
        }
        if (
          ((!F.hasMoreBefore || null != ei) &&
          ...
          F.hasMoreAfter &&
            eA.push(
              (0, a.jsx)(w.default, { compact: et, ...el }, "has-more-after")
            ),
          !er && ed && eu() && eA.push((0, a.jsx)(W.default, { channel: R })),
          $ > 0 && ee && eu())
        ) {
          let e, t;
        ...
        if (
          (null == s &&
            ...
            eh &&
            em.includes(z.ChatOverlays.SUMMARIES) &&
            (s = (0, a.jsx)(V.TopicsPill, { channel: R, scrollManager: es })),
          F.error)
        )
          r = (0, a.jsx)(V.ErrorLoadingBar, {
    ...
    144553: function (e, t, n) {
      ...
      let A = s.memo(function (e) {
        ...
        let {
          ...
          H = (0, m.useNullableMessageAuthor)(n);
      ...
      let i = () => {
        let e = (0, a.useStateFromStores)([s.default], () => {
            ...
            return (
              null ===
                (n =
                  null === (t = s.default.settings.privacy) || void 0 === t
                    ? void 0
        ...
        return (
          ...
          (0, a.jsxs)("div", {
            ...
            children: [
              ...
              (0, a.jsx)("div", { className: C.guildAvatar, children: T }),
              (0, a.jsx)("svg", {
            ...
            children: (e, t) => {
              ...
              return (0, a.jsx)(f.Clickable, {
                ...
                children: (0, a.jsxs)("div", {
                  ...
                  children: [
                    A(n),
                    (0, a.jsx)("div", { className: i(T.innerCircle, _(n)) }),
                    (0, a.jsx)("div", { className: i(T.outerCircle, _(n)) }),
                  ],
                }),
              });
            },
            ...
            (this.renderPopoutContent = e => {
              ...
              return (0, u.jsx)(A, {
                ...
                className: f(
                  {
                    [T.bottom]: "bottom" === n,
                    [T.contentNarrowNoMedia]: !s && !r,
                    [T.contentNarrowWithMedia]: !s && r,
                    [T.contentWideNoMedia]: s && !r,
                    [T.contentWideWithMedia]: s && r,
                    [T.right]: "right" === n,
                    [T.top]: "top" === n,
                    [T.left]: "left" === n,
...
//# sourceMappingURL=7eb7859d492c8c942286.js.map
