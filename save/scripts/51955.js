  ...
  ["51955"],
  {
    ...
    335350: function (e, t, n) {
      ...
      var a = n("37983"),
        ...
        c = n("891302");
      function f(e) {
        let { channel: t, openOmniMenu: n, children: f } = e,
          h = (0, l.useStateFromStores)([d.default], () =>
            d.default.hasCurrentUserSentMessageSinceAppStart()
          ),
          C = (0, c.useActivitiesInTextOnboardingVisibility)(
            t,
            "ChannelOmniButtonNux"
          ),
          p = (0, o.useCanPostPollsInChannel)(t),
          m = s.useMemo(() => {
            let e = [];
            return (
              h &&
                (null == C ? void 0 : C.desktopThrobberEnabled) &&
                e.push(i.DismissibleContent.ACTIVITIES_CHAT_BUTTON_NUX),
              p && e.push(i.DismissibleContent.POLLS_CHAT_INPUT_COACHMARK),
              e
            );
          }, [h, C, p]);
          ...
          children: e => {
            ...
            switch (t) {
              case i.DismissibleContent.ACTIVITIES_CHAT_BUTTON_NUX:
                return (0, a.jsx)(c.OmniButtonNuxAnimation, { children: f });
    ...
    79254: function (e, t, n) {
      ...
      function F(e) {
        ...
        let { analyticsLocations: x } = (0, f.default)();
        s.useEffect(() => {
          ...
          children: i.map(function (e) {
            ...
            switch (e.type) {
              case L.AttachmentTypes.UPLOAD_A_FILE:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "upload-file", label: s, action: r },
                  "upload-file"
                );
              case L.AttachmentTypes.UPLOAD_TEXT_AS_FILE:
                ...
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "upload-text-as-file", label: s, action: B },
                  "upload-text-as-file"
                );
              case L.AttachmentTypes.CLIPS:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "clips", label: s, action: H },
                  "clips"
                );
                  ...
                  o.MenuItem,
                  {
                    ...
                    action: () => {
                      ...
                      return (
                        ...
                        j(n, t, R.ActivityActionTypes.JOIN, x))
                      );
                    },
                  },
                  "play"
                  ...
                  o.MenuItem,
                  {
                    ...
                    action: () => {
                      ...
                      return (
                        ...
                        j(n, t, R.ActivityActionTypes.LISTEN, x))
                      );
                    },
                  },
                  "listen"
                  ...
                  o.MenuItem,
                  {
                    ...
                    action: () => {
                      ...
                      return (
                        ...
                        j(n, t, R.ActivityActionTypes.WATCH, x))
                      );
                    },
                  },
                  "watch"
              ...
              case L.AttachmentTypes.CREATE_THREAD:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "THREAD", label: s, action: y },
                  "THREAD"
                );
              case L.AttachmentTypes.SLASH_COMMAND:
                return (0, a.jsx)(
                  o.MenuItem,
                  { id: "SLASH_COMMAND", label: s, action: F },
                  "SLASH_COMMAND"
                );
    ...
    525503: function (e, t, n) {
      ...
      var s = n("77078"),
        ...
        r = n("977772");
      function o(e) {
        let { markAsDismissed: t, onClickCta: n, children: o } = e;
        return (0, a.jsx)(s.Popout, {
          renderPopout: () =>
            (0, a.jsx)(l.default, {
              className: r.tooltip,
              header: i.default.Messages.POLL_COACHMARK_TITLE,
              content: i.default.Messages.POLL_COACHMARK_SUBTITLE,
              buttonCTA: i.default.Messages.POLL_COACHMARK_CTA,
              secondaryButtonCTA: i.default.Messages.POLL_COACHMARK_DISMISS,
              buttonProps: {
                color: s.Button.Colors.CUSTOM,
                className: r.pollsCtaButton,
              },
              ...
              onClick: n,
              markAsDismissed: t,
              caretPosition: l.CaretPosition.BOTTOM_LEFT,
...
//# sourceMappingURL=03fcd04cfbb40cbda387.js.map
