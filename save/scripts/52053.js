(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["52053"],
  {
    ...
    36170: function (e, t, s) {
        ...
        let { quest: s, rewardCode: l } = e,
          ...
          i = {
            ...
            background:
              "\n    linear-gradient(\n      150deg,\n      transparent 68%,\n      "
                .concat(
                  (0, p.hexOpacityToRgba)(s.config.colors.primary, 0.2),
                  " 85%,\n      transparent 100%\n    ),\n    linear-gradient(\n      150deg,\n      transparent 13%,\n      "
                )
                .concat(
                  (0, p.hexOpacityToRgba)(s.config.colors.primary, 0.6),
                  " 44%,\n      transparent 76%\n    ),\n    "
                )
      ...
      function T(e) {
        let t = (0, n.useStateFromStores)([E.default], () => {
          var e;
        ...
        return t
          ? (0, a.jsx)(w, { ...e })
          : (0, a.jsx)(_.QuestsRewardCodeModalUnverified, { ...e });
      }
      function w(e) {
        var t;
        let { transitionState: s, onClose: r, quest: o, location: h } = e,
          ...
          E = o.config.rewardCodePlatforms.length > 1,
          [p, _] = l.useState(E ? null : o.config.rewardCodePlatforms[0]),
          {
            rewardCode: T,
          ...
          b = l.useCallback((e, t, s) => {
            D(!1), (0, g.claimQuestRewardCode)(e, t, s).catch(() => D(!0));
          }, []),
          B = l.useCallback(e => {
            D(!1), (0, g.fetchQuestRewardCode)(e).catch(() => D(!0));
          }, []);
        l.useEffect(() => {
          var e, t;
          null == T &&
        ...
        let L = null;
        R && null != T
          ? (L = N.default.Messages.QUESTS_REWARD_CODE_HEADER)
          : null != T
            ? (L = N.default.Messages.QUESTS_REWARD_CODE_CONGRATS)
            : O &&
              (L =
                N.default.Messages
        ...
        O &&
          (U =
            N.default.Messages.QUESTS_REWARD_CODE_SELECT_PLATFORM_INSTRUCTIONS.format(
              { rewardName: o.config.messages.rewardName }
            ));
        let k =
          null != p
            ? o.config.messages.rewardRedemptionInstructionsByPlatform[p]
            : void 0;
        null != T && null != k && (U = k);
        let F =
            null != U
        ...
        let W = null == T && (w || I),
          H = W && !O ? (0, a.jsx)(m.Spinner, { className: M.spinner }) : null,
          Z = null;
        null != T
          ? (Z = (0, a.jsx)(m.FormItem, {
        ...
        let V = () => {
          ...
          z = O && I,
          G = !z && ((O && null == p) || W),
          Y = N.default.Messages.QUESTS_REWARD_CODE_DONE;
        O
          ? (Y = N.default.Messages.QUESTS_REWARD_CODE_GET_CODE)
          : !O && j && (Y = N.default.Messages.QUESTS_REWARD_CODE_TRY_AGAIN);
          ...
          children: [
            (0, a.jsxs)("div", {
              ...
              children: [
                ...
                (0, a.jsx)(A, { quest: o, rewardCode: T }),
                (0, a.jsxs)("div", {
            ...
            (0, a.jsx)(m.ModalFooter, { children: X }),
          ],
        });
      }
    },
...
//# sourceMappingURL=e3f3a8e1fce43ada378d.js.map
