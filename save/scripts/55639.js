(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["55639"],
  {
      ...
      class m {
        ...
        isMemberIncludedInSearchResults(e) {
          ...
          if (
            ...
            (null != _.afterDate &&
              a.default.extractTimestamp(e.userId) < _.afterDate) ||
            (null != _.beforeDate &&
              a.default.extractTimestamp(e.userId) > _.beforeDate) ||
          ...
          if (r || i || n || d)
            return (
              !!(
                ...
                (i && (0, u.isMemberCommunicationDisabled)(e)) ||
                (n && e.hasUnusualAccountActivity) ||
                (d && (0, s.hasAutomodQuarantinedProfile)(e))
              ) || !1
            );
          return !0;
        }
    ...
    178406: function (e, t, r) {
      ...
      function I(e) {
        return (
          null == S[e] && (S[e] = new h.GuildMemberSafetyPageStore(e)), S[e]
        );
      }
      function E(e) {
      ...
      let R = new T(n.default, {
        ...
        FETCH_GUILD_MEMBER_SUPPLEMENTAL_SUCCESS: function (e) {
          let { guildId: t, memberSupplementals: r } = e,
            i = (0, m.syncMemberSupplemental)(t, r);
          if (i) {
            let e = I(t);
        ...
        MEMBER_SAFETY_GUILD_MEMBER_SEARCH_SUCCESS: function (e) {
          var t, r, i, n, s, u;
          let a, l;
          let { guildId: d, members: h, total_result_count: M } = e,
            S = I(d),
            { memberIds: E, memberSupplementals: f } = h.reduce(
              (e, t) => {
                let {
                    member: r,
