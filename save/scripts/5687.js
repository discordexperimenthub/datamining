  ...
  ["5687"],
  {
    ...
    721698: function (i, t, x) {
      ...
      async function l(i) {
        ...
        if (
          d.default.getApplicationFetchState(i) === d.FetchState.FETCHING ||
          d.default.isInvalidApplication(i) ||
          x < y + 6e5
        )
          return;
        c.set(i, x),
      ...
      async function I(i) {
        var t;
        let { applicationId: x, guildId: s, options: d } = i,
          { page: k } = null != d ? d : {},
          p = Date.now(),
          e = r.default.getFetchState({ applicationId: x, guildId: s }),
          { lastFetchTimeMs: n } =
            null !==
              (t = r.default.getSimilarApplications({
                applicationId: x,
                guildId: s,
              })) && void 0 !== t
              ? t
          ...
          if (null == n || !(n + 6e5 > p)) {
            ...
            try {
              let i = await a.default.get({
                ...
                query: { guild_id: s, page: k, locale: y.default.locale },
              });
              o.default.dispatch({
      ...
      async function u(i) {
        var t;
        let { query: x, guildId: s, options: d, onSuccessCallback: k } = i,
          { page: p, categoryId: r } = null != d ? d : {},
          n = Date.now(),
          c = e.default.getFetchState({
            query: x,
            guildId: s,
            page: p,
            categoryId: r,
      ...
      async function h() {
        let { includesInactive: i = !1 } =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          t = Date.now(),
          x = p.default.getFetchState({ includesInactive: i }),
          s = p.default.getLastFetchTimeMs({ includesInactive: i });
          ...
          if (null == s || !(s + 6e5 > t)) {
            ...
            try {
              let t = await a.default.get({
                ...
                query: { includes_inactive: i, locale: y.default.locale },
              });
              o.default.dispatch({
    ...
    810047: function (i, t, x) {
      ...
      let p = {},
        ...
        r = {};
      function n(i) {
        let { includesInactive: t } = i;
        return "includes_inactive:".concat(t);
      }
      class m extends d.default.Store {
        getLastFetchTimeMs(i) {
          let { includesInactive: t } = i;
          return r[n({ includesInactive: t })];
        }
        getFetchState(i) {
          let { includesInactive: t } = i;
          return e[n({ includesInactive: t })];
        }
        getCollections(i) {
          let { includesInactive: t } = i;
          return p[n({ includesInactive: t })];
        }
      }
      var c = new m(k.default, {
        APPLICATION_DIRECTORY_FETCH_COLLECTIONS: function (i) {
          let { includesInactive: t } = i;
          e = { ...e, [n({ includesInactive: t })]: 0 };
        },
        APPLICATION_DIRECTORY_FETCH_COLLECTIONS_SUCCESS: function (i) {
          var t;
          let { collections: x, includesInactive: s } = i,
            a = n({ includesInactive: s });
          let o =
            ((t = x.map(i => {
              var t;
              return (
                (i.application_directory_collection_items =
                  ((t = i.application_directory_collection_items),
    ...
    856894: function (i, t, x) {
      ...
      var s,
        ...
        k = x("913144");
      function p(i) {
        let { query: t, guildId: x, page: s, categoryId: a } = i;
        return "query:'"
          .concat(t, "' guildId:")
          .concat(x, " page:")
          .concat(s, " categoryId:")
      ...
      class n extends d.default.Store {
        getSearchResults(i) {
          let { query: t, guildId: x, page: s, categoryId: a } = i,
            o = p({ query: t, guildId: x, page: s, categoryId: a });
          return e.get(o);
        }
        getFetchState(i) {
          let { query: t, guildId: x, page: s, categoryId: a } = i,
      ...
      var m = new n(k.default, {
        ...
        APPLICATION_DIRECTORY_FETCH_SEARCH_SUCCESS: function (i) {
          let { query: t, guildId: x, page: s, categoryId: a, result: o } = i,
            y = p({ query: t, guildId: x, page: s, categoryId: a });
          e.set(y, { lastFetchTimeMs: Date.now(), ...o }),
            (r = { ...r, [y]: 1 });
        },
    ...
    388647: function (i, t, x) {
      ...
      var s,
        ...
        k = x("913144");
      function p(i) {
        let { applicationId: t, guildId: x, page: s } = i;
      ...
      class n extends d.default.Store {
        getSimilarApplications(i) {
          let { applicationId: t, guildId: x, page: s } = i;
          if (null == t) return;
          let a = p({ applicationId: t, guildId: x, page: s });
          return e.get(a);
        }
        getFetchState(i) {
          let { applicationId: t, guildId: x, page: s } = i;
      ...
      var m = new n(k.default, {
        APPLICATION_DIRECTORY_FETCH_SIMILAR_APPLICATIONS: function (i) {
          let { applicationId: t, guildId: x, page: s } = i,
            a = p({ applicationId: t, guildId: x, page: s });
          r = { ...r, [a]: 1 };
        },
        APPLICATION_DIRECTORY_FETCH_SIMILAR_APPLICATIONS_SUCCESS: function (i) {
          let {
            ...
            d = p({ applicationId: t, guildId: x, page: o });
          e.set(d, {
    ...
    506061: function (i, t, x) {
      ...
      var s,
        ...
        y = x("913144"),
        d = x("718517");
      ((a = s || (s = {}))[(a.NOT_FETCHED = 0)] = "NOT_FETCHED"),
      ...
      function p(i) {
        let { applicationId: t, guildId: x } = i;
        null == k.applicationIdToGuildIds[t] &&
          (k.applicationIdToGuildIds[t] = new Set()),
          k.applicationIdToGuildIds[t].add(x),
          (k.applicationIdToGuildIds[t] = new Set(
            k.applicationIdToGuildIds[t]
          ));
      }
      class e extends o.default.PersistedStore {
        initialize(i) {
          if (null != i)
            for (let t in ((k.lastFetchTimeMs = i.lastFetchTimeMs),
            (k.nextFetchRetryTimeMs = i.nextFetchRetryTimeMs),
            (k.fetchState = i.fetchState),
            i.applicationIdToGuildIds))
              k.applicationIdToGuildIds[t] = new Set(
                i.applicationIdToGuildIds[t]
              );
        }
        getState() {
          return k;
      ...
      (e.displayName = "MyGuildApplicationsStore"),
        (e.persistKey = "MyGuildApplicationsStore");
      var r = new e(y.default, {
        LOGOUT: function () {
          (k.applicationIdToGuildIds = {}),
            (k.lastFetchTimeMs = null),
            (k.nextFetchRetryTimeMs = null),
            (k.fetchState = 0);
        },
        ...
        FETCH_INTEGRATION_APPLICATION_IDS_FOR_MY_GUILDS_SUCCESS: function (i) {
          let { guildIdToApplicationIds: t } = i;
          for (let i in ((k.fetchState = 2),
          (k.lastFetchTimeMs = Date.now()),
          (k.applicationIdToGuildIds = {}),
          (k.nextFetchRetryTimeMs = null),
          t))
            for (let x of t[i]) p({ applicationId: x, guildId: i });
        },
        FETCH_INTEGRATION_APPLICATION_IDS_FOR_MY_GUILDS_FAILURE: function (i) {
          let { retryAfterSeconds: t } = i;
        ...
        INTEGRATION_CREATE: function (i) {
          let { application: t, guildId: x } = i;
          null != t && p({ applicationId: t.id, guildId: x });
        },
        INTEGRATION_DELETE: function (i) {
          ...
          null != t &&
            !(function (i) {
              let { applicationId: t, guildId: x } = i;
              null != k.applicationIdToGuildIds[t] &&
                (k.applicationIdToGuildIds[t].delete(x),
                (k.applicationIdToGuildIds[t] = new Set(
                  k.applicationIdToGuildIds[t]
                )));
            })({ applicationId: t, guildId: x });
        },
      });
    },
    529805: function (i, t, x) {
      ...
      function y(i) {
        s.default.dispatch({ type: "DELETE_PENDING_REPLY", channelId: i });
      }
    },
    ...
    397485: function (i, t, x) {
      ...
      function Y(i) {
        ...
        let d = G(i, "userId"),
          ...
          p =
            k.length < 2
              ? null !== (t = null == k ? void 0 : k[0]) && void 0 !== t
                ? t
                : ""
              : k.join(", ");
        if (d.length < 1) return "";
        if (1 === d.length)
          return N.default.Messages.A11Y_ANNOUNCEMENT_VOICE_CHANNEL_EFFECTS_SINGLE.format(
            {
              firstUsername:
                null === (x = F.default.getUser(d[0])) || void 0 === x
                  ? void 0
                  : x.username,
              emojiNames: p,
            }
        ...
        if (2 === d.length)
          return N.default.Messages.A11Y_ANNOUNCEMENT_VOICE_CHANNEL_EFFECTS_DOUBLE.format(
            {
              firstUsername:
                null === (s = F.default.getUser(d[0])) || void 0 === s
                  ? void 0
                  : s.username,
              secondUsername:
                null === (a = F.default.getUser(d[1])) || void 0 === a
                  ? void 0
                  : a.username,
              emojiNames: p,
            }
          ...
          return N.default.Messages.A11Y_ANNOUNCEMENT_VOICE_CHANNEL_EFFECTS_MULTIPLE.format(
            {
              firstUsername:
                null === (o = F.default.getUser(d[0])) || void 0 === o
                  ? void 0
                  : o.username,
              secondUsername:
                null === (y = F.default.getUser(d[1])) || void 0 === y
                  ? void 0
                  : y.username,
              count: d.length - 2,
              emojiNames: p,
    ...
    427302: function (i, t, x) {
      ...
      class l extends a.Component {
        render() {
          let { popoutOpen: i } = this.state,
            ...
            y = {
              location: { ...x.location, object: m.AnalyticsObjects.LIST_ITEM },
            };
          return (0, s.jsx)(d.Popout, {
            preload: () =>
              (0, e.default)(t.id, t.getAvatarURL(o, 80), { guildId: o }),
            renderPopout: i =>
              (0, s.jsx)(r.default, {
                ...i,
                guildId: o,
        ...
        constructor(...i) {
          super(...i),
            ...
            (this.handleClickUser = () => {
              let { onPopoutOpen: i } = this.props;
              this.setState({ popoutOpen: !this.state.popoutOpen }),
                null == i || i();
            }),
            (this.handleUserPopoutClose = () => {
              let { onPopoutClose: i } = this.props;
              this.setState({ popoutOpen: !1 }), null == i || i();
            }),
            (this.renderUserPopout = i => {
              ...
              return (0, s.jsxs)(n.default, {
                ...
                className: y(c.memberListItem, t, { [c.popoutDisabled]: x }),
                onContextMenu: a,
      ...
      l.defaultProps = { disablePopout: !1 };
      var _ = (0, p.default)(l);
    },
