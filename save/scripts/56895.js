      ...
      class f extends i.default.Store {
        initialize() {
          this.waitFor(u.default, s.default, l.default, a.default),
            this.syncWith([u.default, s.default, l.default, a.default], I);
        }
        getGuildIncident(e) {
          return c[e];
        }
      ...
      var T = new f(r.default, {
        CONNECTION_OPEN: function (e) {
          for (let t of ((c = {}), e.guilds)) {
            ...
            null != e &&
              ((0, E.hasDetectedActivity)(e) || (0, E.isUnderLockdown)(e)) &&
              (c[t.id] = e);
          }
        },
        GUILD_CREATE: function (e) {
          let { guild: t } = e,
            n = S(t.properties.incidents_data);
          null != n &&
            ((0, E.hasDetectedActivity)(n) || (0, E.isUnderLockdown)(n)) &&
            (c[t.id] = n);
        },
        GUILD_UPDATE: function (e) {
          let { guild: t } = e,
            n = S(t.incidents_data);
          null != n &&
          ((0, E.hasDetectedActivity)(n) || (0, E.isUnderLockdown)(n))
            ? (c[t.id] = n)
            : delete c[t.id];
