(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["59733"],
  {
    ...
    689096: function (e, t, n) {
      "use strict";
      e.exports = n.p + "f8fb88f65f33f224c7b3.mp3";
    },
    90152: function (e, t, n) {
      "use strict";
    ...
    696730: function (e, t, n) {
      "use strict";
      e.exports = n.p + "6cc13ddadaadc1e9acfb.mp3";
    },
    656602: function (e, t, n) {
      "use strict";
    ...
    221083: function (e, t, n) {
      ...
      var A = {
        ...
        toggleSelfMute() {
          ...
          return g()
            ? Promise.resolve()
            : (S({ usedKeybind: n }), o.default.isEnabled())
              ? s.default.dispatch({
        ...
        setMode(e) {
          ...
          !g() &&
            s.default.dispatch({
              ...
              context: n,
              mode: e,
              options: { ...o.default.getModeOptions(n), ...t },
            });
        },
        setInputVolume(e) {
          !g() &&
            s.default.dispatch({ type: "AUDIO_SET_INPUT_VOLUME", volume: e });
        },
        setOutputVolume(e) {
          !g() &&
            s.default.dispatch({ type: "AUDIO_SET_OUTPUT_VOLUME", volume: e });
        },
        setInputDevice(e, t) {
          if (!g()) {
            if (null != t) {
              let n = o.default.getInputDevices();
              _(n, o.default.getInputDeviceId(), e, "Audio Input", t);
            }
            s.default.dispatch({ type: "AUDIO_SET_INPUT_DEVICE", id: e }), f();
          }
        },
        setOutputDevice(e, t) {
          if (!g()) {
            if (null != t) {
              ...
              _(n, o.default.getOutputDeviceId(), e, "Audio Output", t);
            }
            s.default.dispatch({ type: "AUDIO_SET_OUTPUT_DEVICE", id: e }), f();
          }
        },
        setVideoDevice(e, t) {
          if (!g()) {
            if (null != t) {
              ...
              _(n, o.default.getVideoDeviceId(), e, "Video", t);
            }
            s.default.dispatch({
        ...
        setLoopback(e) {
          !g() &&
            s.default.dispatch({ type: "AUDIO_SET_LOOPBACK", enabled: e });
        },
        ...
        setQoS(e) {
          !g() && s.default.dispatch({ type: "AUDIO_SET_QOS", enabled: e });
        },
        reset() {
          !g() && s.default.dispatch({ type: "AUDIO_RESET" });
        },
        setSilenceWarning(e) {
          !g() &&
            s.default.dispatch({
        ...
        setDebugLogging(e) {
          !g() &&
            s.default.dispatch({ type: "AUDIO_SET_DEBUG_LOGGING", enabled: e });
        },
        setVideoHook(e) {
          !g() &&
            s.default.dispatch({
        ...
        setAV1Enabled(e) {
          !g() &&
            s.default.dispatch({ type: "MEDIA_ENGINE_SET_AV1", enabled: e });
        },
        setH265Enabled(e) {
          !g() &&
            s.default.dispatch({ type: "MEDIA_ENGINE_SET_H265", enabled: e });
        },
        setAecDump(e) {
          !g() &&
            s.default.dispatch({
                ...
                e => {
                  switch (e) {
                    ...
                    case l.UserMediaErrors.PERMISSION_DISMISSED:
                      ...
                      break;
                    default:
                      S(f.NativePermissionStates.ERROR),
                        m.warn(`unknown getUserMedia error: ${e}`);
                  }
                }
              )
              .then(() => !0));
    ...
    149566: function (e, t, n) {
      ...
      var s = (0, n("516086").createExperiment)({
        ...
        defaultConfig: { allowAprilFoolsSoundpack: !1 },
        treatments: [
          {
            id: 1,
            label: "April Fools 2023",
            config: { allowAprilFoolsSoundpack: !0 },
          },
        ],
      });
    },
    867511: function (e, t, n) {
      "use strict";
      n.r(t),
        n.d(t, {
          Soundpacks: function () {
    ...
    370916: function (e, t, n) {
      ...
      class d extends s.default.PersistedStore {
        static #e = (this.displayName = "SoundpackStore");
        static #t = (this.persistKey = "SoundpackStore");
        initialize(e) {
    ...
    552091: function (e, t, n) {
      ...
      function o(e, t) {
        ...
        return d((0, u.default)(t)[e] ?? e, e, n);
      }
      function d(e, t) {
        let n =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1;
      ...
      function c(e) {
        ...
        let s = d((0, u.default)(i.default.getSoundpack())[e] ?? e, e, t);
        return (
          null != n
            ? s.playWithListener().then(e => {
                e && n();
              })
            : s.play(),
          s
      ...
      s = n("358838").WebAudioSound;
    },
    358838: function (e, t, n) {
      "use strict";
      n.r(t),
        n.d(t, {
        ...
        playWithListener() {
          return new Promise((e, t) => {
            this._ensureAudio().then(n => {
              (null == n.duration || 0 === n.duration) &&
                t("sound has no duration"),
                n.play(),
                setTimeout(() => {
                  e(!0);
                }, n.duration);
          ...
          return (
            (this._audio =
              ...
              new Promise((e, t) => {
                let s = new Audio();
                (s.src = n("159141")(
                  `../../sounds/${this.name}.mp3`.replace("../../sounds/", "./")
                )),
                  (s.onloadeddata = () => {
...
//# sourceMappingURL=59733.9e98cad92d7b47d59e70.js.map
