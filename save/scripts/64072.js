(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["64072"],
  {
      ...
      var i = n("77078"),
        ...
        s = () =>
          (0, a.jsx)("div", {
            ...
            children: (0, a.jsx)(i.Dots, { dotRadius: 4, themed: !0 }),
          });
    },
    ...
    39393: function (e, t, n) {
      ...
      let s = (e, t, n) => {
          var s, u;
          let r = (0, a.useStateFromStores)([i.default], () =>
    ...
    151622: function (e, t, n) {
      ...
      function f(e) {
        let {
          ...
          p = (0, d.useExplicitMediaAttachmentsForMessage)(t, n, f),
          S = (0, d.useExplicitMediaEmbedsForMessage)(t, n, E),
          { reportFalsePositive: I, isReportFalsePositiveLoading: v } = (0,
        ...
        return (
          ...
          (0, a.jsx)(o.ExplicitMediaFalsePositiveModal, {
            ...
            onConfirmPress: I,
            attachmentPreview: 1 === p.length && 0 === S.length ? p[0] : void 0,
            embedPreview: 1 === S.length && 0 === p.length ? S[0] : void 0,
            transitionState: m,
            onClose: M,
          })
        );
    ...
    823026: function (e, t, n) {
      ...
      var a = n("37983"),
        ...
        m = n("782340");
      function M(e) {
        let { user: t, guildId: n, channel: M, context: g } = e,
          p = c.default.getGuild(n),
          S = (0, l.useStateFromStores)([f.default], () =>
            null != p ? f.default.can(E.Permissions.MANAGE_GUILD, p) : null
          ),
          I = (0, d.useContextIndexState)(M, !0, !0),
          v = (0, d.useUserIndexState)(!0, !0),
          { isUserApp: h, isGuildApp: A } = i.useMemo(() => {
            var e, n, a, i;
          ...
          }, [I, v, null == t ? void 0 : t.id]),
          _ = i.useCallback(() => {
            (null == p ? void 0 : p.id) != null &&
              (o.default.open(p.id, E.GuildSettingsSections.INTEGRATIONS),
    ...
    363396: function (e, t, n) {
      ...
      function C(e, t, n) {
        t.state === h.MessageStates.SEND_FAILED || n.shiftKey
          ? i.default.deleteMessage(
              e.id,
              t.id,
              t.state === h.MessageStates.SEND_FAILED
            )
    ...
    261649: function (e, t, n) {
      ...
      function w(e) {
        let {
          ...
          en = (0, A.default)(t, n),
          ea = (0, C.default)(t, n),
          ei = (0, _.default)({ type: U, id: w, name: k }),
          el = (0, G.default)(t, n),
          es = (0, T.default)(t, n),
          eu = (0, O.default)(t),
          er = (0, S.default)(t, n),
          ...
          eI = (0, b.default)(t, n),
          ev = (0, P.default)(t, n),
          eh = (0, g.default)(t, n, { hoist: !0 }),
          eA = (0, M.default)(s, n.getGuildId()),
          e_ = (0, x.default)(t),
          eT = (0, v.default)(t),
          eC = (0, m.default)({
        ...
        return (0, a.jsxs)(l.Menu, {
          ...
          children: [
            ...
            (0, a.jsxs)(l.MenuGroup, { children: [eg, ep] }),
            (0, a.jsx)(l.MenuGroup, { children: eM }),
            (0, a.jsx)(l.MenuGroup, { children: eS }),
          ],
        });
      }
    },
    761136: function (e, t, n) {
      ...
      function I(e, t) {
        let { perGuildMaxCount: n } = r.triggerConfigs[S],
          { isLoading: M, saveRule: I } = (0, o.useAutomodEditingRuleActions)(),
          { createNewEditingRule: v } = (0, o.useAutomodEditingRuleState)(),
          [h, A] = i.useState(!1),
          [_, T] = (0, u.useSyncAutomodRules)(t),
    ...
    175537: function (e, t, n) {
      ...
      function v(e, t) {
        let { reducedMotion: n } = i.useContext(
          ...
          v = (0, o.useIsActiveChannelOrUnarchivableThread)(t),
          h = (0, l.useStateFromStores)(
            [f.default],
            () =>
              (t.isPrivate() ||
                f.default.can(p.Permissions.ADD_REACTIONS, t)) &&
              v,
            [t, v]
          ),
          A = (0, u.useEmojiInPriorityOrder)(t.getGuildId());
        if (
          !c.RenderReactions.getSetting() ||
          !h ||
          e.type === p.MessageTypes.GUILD_INVITE_REMINDER
        )
          return null;
        let _ = A.filter(
          e =>
        ...
        return (0, a.jsx)(s.MenuItem, {
          ...
          action: () => {
            M.ComponentDispatch.dispatchKeyed(
              p.ComponentActionsKeyed.TOGGLE_REACTION_POPOUT,
              e.id,
              { emojiPicker: !0 }
            );
          },
    ...
    702495: function (e, t, n) {
      ...
      function h(e) {
        let { type: t, id: n, name: h, isInExpressionPicker: A = !1 } = e,
          { location: _ } = (0, r.useAnalyticsContext)(),
          T = i.useMemo(
            () => ({
              ..._,
              section: A
                ? S.AnalyticsSections.EXPRESSION_PICKER
                : S.AnalyticsSections.CONTEXT_MENU,
            }),
            [_, A]
          ),
          ...
          O = null != R && C.includes(R.id),
          x = (0, l.useStateFromStores)([o.default], () => {
            if (t === f.PickerContextMenuDataTypes.EMOJI) {
              if (null != n)
                return o.default.getDisambiguatedEmojiContext().getById(n);
              if (null != h) {
                var e;
                return null !== (e = v(h)) && void 0 !== e
                  ? e
                  : v(c.default.convertSurrogateToName(h));
              }
            }
          }),
          y = (0, d.useIsFavoriteEmoji)(null, x);
        if (null != R && t === f.PickerContextMenuDataTypes.STICKER)
          return (0, p.isGuildSticker)(R) && !(0, p.isAvailableGuildSticker)(R)
            ? null
            : O
              ? (0, a.jsx)(s.MenuItem, {
                  id: "unfavorite",
              ...
              : (0, a.jsx)(s.MenuItem, {
                  ...
                  action: () => {
                    (0, m.trackStickerFavorited)({
                      sticker: R,
                      location: { ...T, object: S.AnalyticsObjects.STICKER },
                    }),
                      (0, E.favoriteSticker)(null == R ? void 0 : R.id);
                  },
                  label: I.default.Messages.FAVORITE_ITEM,
                });
        if (null != x && t === f.PickerContextMenuDataTypes.EMOJI)
          return y
            ? (0, a.jsx)(s.MenuItem, {
                id: "unfavorite",
            ...
            : (0, a.jsx)(s.MenuItem, {
                ...
                action: () => {
                  (0, d.trackEmojiFavorited)({
                    emoji: x,
                    location: { ...T, object: S.AnalyticsObjects.EMOJI },
                  }),
                    (0, u.favoriteEmoji)(x);
                },
                label: I.default.Messages.FAVORITE_ITEM,
            ...
            u.Tooltip,
            {
              ...
              children: e =>
                (0, a.jsx)("div", {
                  ...
                  className: l(I.button, { [I.focused]: i }),
                  ...e,
                  children:
                    null == r || "" === r.trim()
                      ? (0, a.jsx)("span", {
              ...
              children: i.map((e, t) => {
                ...
                return (0, a.jsx)(
                  u.MenuItem,
                  {
                    ...
                    render: t => {
                      let { isFocused: n } = t;
                      return (0, a.jsx)(h, { emoji: e, isFocused: n });
                    },
                    action: () => A(e),
                    dontCloseOnActionIfHoldingShiftKey: !0,
                  },
        ...
        let o = (function (e) {
          ...
          C = async () => {
            try {
              ...
              _(M.default.Messages.ERROR_COPYING_IMAGE, e),
                r.default.track(
        ...
        I = e => {
          let t,
            ...
            _ = (0, u.useStateFromStores)([m.default], () =>
              m.default.getGuild(null != v ? v : I.guild_id)
            ),
...
//# sourceMappingURL=11a210f54635a9335e8b.js.map
