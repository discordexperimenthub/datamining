    ...
    269596: function (e, t, i) {
      ...
      class a extends r.default.PersistedStore {
        ...
        hasHotspot(e) {
          ...
          return (
            !(
              o.CONFERENCE_MODE_ENABLED || u.ProcessArgs.isDisallowPopupsSet()
            ) &&
            (i || !s.has(e))
          );
        }
    ...
    716849: function (e, t, i) {
      ...
      function L(e) {
        let { enabled: t, useExpectedValue: i } = e.useExperiment(
          ...
          u = (0, n.default)([d.default], () =>
            d.default.shouldFetchPremiumLikelihood()
          ),
          o = (0, n.default)([l.default], () => l.default.getCurrentUser());
        r.useEffect(() => {
          I(o, u, t, i);
        }, [o, u, t, i]);
      }
    ...
    58608: function (e, t, i) {
      ...
      let a = e => {
        ...
        function p() {
          var e;
          a &&
            (null == E || null === (e = E.current) || void 0 === e || e.play());
        }
        function m() {
          var e;
          a &&
      ...
      var c = n.forwardRef((e, t) => (0, r.jsx)(a, { ...e, externalRef: t }));
    },
