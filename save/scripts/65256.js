  ...
  ["65256"],
  {
    ...
    648456: function (e, t, i) {
      ...
      async function G(e) {
        ...
        let { channelId: n, applicationId: l } = e,
          ...
          r = y.default.getEmbeddedActivityDurationMs(n, l),
      ...
      function H(e) {
        ...
        let {
          ...
          s = I.default.getId(),
          o = y.default.getEmbeddedActivitiesForChannel(n),
        ...
        constructor(...e) {
          super(...e),
            (this.handleSelectedChannelUpdate = () => {
              ...
              for (let { channelId: t, applicationId: i } of y.default
              ...
              if (null != e) {
                ...
                t.forEach(e => {
                  if (e.userIds.has(i)) {
                    let t = y.default.getSelfEmbeddedActivityForChannel(
                      e.channelId
                    );
                    null == t &&
            ...
            (this.superHandleRPCDisconnect = e => {
              let { reason: t, application: i } = e,
                n = i.id;
              if (null != n && null != t) {
                for (let { applicationId: e, channelId: t } of y.default
                  .getSelfEmbeddedActivities()
                  .values())
                  e === n &&
    ...
    706508: function (e, t, i) {
      ...
      async function A(e) {
        ...
        if (null == S || (p && !S.isPrivate()) || null == A || null == h)
    ...
    986214: function (e, t, i) {
      ...
      async function h(e) {
        ...
        if (
          (null == g && !(0, v.isPrivateChannelWithEnabledActivities)(y)) ||
          null == m ||
          null == t ||
          null == t.application
        )
        ...
        if (U) {
          ...
          return !1;
        return (
          f.startEmbeddedActivity(y, t.application.id, L),
          (0, C.default)(D, y),
          (0, T.default)({
