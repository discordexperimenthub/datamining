    ...
    889793: function (e, t, n) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsx)(N, {
              user: t,
              onApply: () => {
                (0, C.setNewPendingProfileEffectId)(_, c, n), o();
              },
              onClose: o,
              product: P,
              purchase: M,
      ...
      function R(e) {
        let {
          ...
          { AnalyticsLocationProvider: T, analyticsLocations: N } = (0,
          u.default)(n, o.default.EDIT_PROFILE_EFFECT_MODAL),
          R = (0, C.useGlobalOrGuildIdentityProfileEffect)(I, f);
        return (
          s.useEffect(() => {
    ...
    717262: function (e, t, n) {
      ...
      var N = e => {
        ...
        let {
          ...
          O = S.default.isPremium(n),
          b = (0, E.default)(n.id),
          y = !!(null == b ? void 0 : b.getPreviewBio(x).value),
          j = v.UseLegacyChatInput.useSetting(),
          V = j && null != x ? d.default.parse(void 0, x).content : x,
          F = S.default.canUsePremiumProfileCustomization(n),
          H = (null == b ? void 0 : b.canUsePremiumProfileCustomization) || F,
          D = {
            user: n,
            guild: g,
            pendingGlobalName: _,
      ...
      let R = () => 80,
        P = e => {
          ...
          return (0, r.jsx)(c.Clickable, {
            className: l(N.effectGridItem, n, { [N.selected]: s }),
            ...i,
            onClick: i.onSelect,
            children: t,
          });
        ...
        M = e => {
          ...
          let {
            ...
            C = (0, u.default)([_.default], () =>
              _.default.getProfileEffectById(i.id)
            ),
            m = (0, u.default)([f.default], () => {
              let e = f.default.getProduct(i.skuId);
              return (0, E.isPremiumCollectiblesProduct)(e);
            }),
            T = (0, u.default)([h.default], () => h.default.isItemViewed(i)),
            R = s.useRef(null),
            {
              ...
              ? t
              : {},
            O = S.default.canUseCollectibles(n),
          ...
          return (
            ...
            (0, r.jsxs)(P, {
              className: b && !c ? N.decorationGridItemChurned : void 0,
              innerRef: null != l ? l : R,
              isSelected: c,
              ...d,
              children: [
                ...
                .with(I.NONE_ITEM, () =>
                  (0, r.jsxs)(
                    P,
                    {
                      ...
                      onSelect: () => l(null),
                      children: [
                        (0, r.jsx)(m.default, { className: N.notAllowedIcon }),
                        (0, r.jsx)(c.Text, {
                ...
                .with(I.SHOP_ITEM, () =>
                  (0, r.jsxs)(
                    P,
                    {
                      ...
                      onSelect: u,
                      children: [
                        (0, r.jsx)(C.default, { className: N.shopIcon }),
                        (0, r.jsx)(c.Text, {
                          variant: "text-xs/normal",
                          color: "header-primary",
...
//# sourceMappingURL=a82b463c5dd1d3fb6679.js.map
