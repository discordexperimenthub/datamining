  ...
  ["67407"],
  {
    ...
    359499: function (e, t, r) {
      ...
      function g() {
              ...
              return null !==
                (e =
                  t.userTenureRewardStatusByRewardId[
                    R.TenureRewardSKUs.FREE_GUILD_BOOST_1_MONTH
                  ]) && void 0 !== e
                ? e
                : t.userTenureRewardStatusByRewardId[
                    R.TenureRewardSKUs.FREE_GUILD_BOOST_3_MONTHS
                  ];
          })(),
          t = A(),
        ...
        if (a && !1 === i)
          return {
            nitroTenureStatus: R.NitroRewardStatus.REDEEMED,
            tenureRewardSkuId: t.skuId,
            showNotification: !0,
          };
        if (a)
          return {
            nitroTenureStatus: R.NitroRewardStatus.REDEEMABLE,
            tenureRewardSkuId: t.skuId,
            showNotification: !0,
          };
        if (!(null != e && (0, v.isUserTenureRewardStatusActive)(e)))
          ...
          let r =
              e.next_tenure_reward_id ===
                R.TenureRewardSKUs.FREE_GUILD_BOOST_1_MONTH &&
              t <= R.MAX_DAYS_LEFT_TO_SHOW_CARD_1_MONTH_VARIANT,
            n =
              e.next_tenure_reward_id ===
                R.TenureRewardSKUs.FREE_GUILD_BOOST_3_MONTHS &&
              t <= R.MAX_DAYS_LEFT_TO_SHOW_CARD_3_MONTH_VARIANT;
          return {
            nitroTenureStatus: R.NitroRewardStatus.PENDING,
      ...
      let I = e => {
          switch (e) {
            case R.NitroRewardStatus.PENDING:
              return [a.DismissibleContent.TENURE_REWARD_PENDING];
            case R.NitroRewardStatus.REDEEMABLE:
        ...
        b = () => {
          ...
          return (
            !!r &&
            null != t &&
            t === R.NitroRewardStatus.REDEEMABLE &&
      ...
      function P() {
        let {
          ...
          r = (0, l.useStateFromStores)([f.default], () => {
            ...
            return (
              null != e && (0, m.isPremiumExactly)(e, S.PremiumTypes.TIER_2)
            );
          }),
          i = n.useRef(!1);
        n.useEffect(() => {
    ...
    354588: function (e, t, r) {
      ...
      var i = r("414456"),
        ...
        E = e => {
          ...
          let { redeemableInDays: v = 0, tenureRewardSkuId: S } = m,
            R =
              c.TenureRewardSKUs.FREE_GUILD_BOOST_1_MONTH === S
                ? c.NUM_DAYS_REQUIRED_1_MONTH_VARIANT
                : c.NUM_DAYS_3_REQUIRED_MONTH_VARIANT,
            g = Math.min(R, Math.max(R - v, 0)),
            N = (100 * g) / R,
            A = T ? (100 * Math.max(g - 0.25 * R, 0)) / R : N;
          return (0, n.jsx)("div", {
    ...
    287850: function (e, t, r) {
      ...
      function C(e) {
          ...
          arguments.length > 1 && void 0 !== arguments[1]
            ...
            : (function (e) {
                ...
                let n =
                    null !==
                      (r =
                        null !== (t = S.default.lastMessageId(e.id)) &&
                        void 0 !== t
                          ? t
        ...
        return {
          ...
          lastMessageId: t,
          isFavorite:
            R.default.isMessagesFavorite(e.id) &&
      ...
      function b() {
        I.clear(),
          ...
          (0, E.isInMainTabsExperiment)() &&
            ...
            R.default.getAddedToMessages().forEach(e => {
      ...
      class w extends d.default.Store {
        initialize() {
          this.waitFor(T.default, v.default, g.default, p.default, R.default),
            this.syncWith([R.default, p.default], b);
        }
...
//# sourceMappingURL=4cb91149a88fa0ada264.js.map
