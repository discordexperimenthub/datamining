  ...
  ["71033"],
  {
    ...
    918771: function (e, t, n) {
      ...
      var i = n("37983"),
        ...
        b = n("856614"),
        M = function (e) {
          let { guildId: t, transitionState: s, onClose: M } = e,
            x = (0, a.useStateFromStores)(
              [_.default],
              () => _.default.getGuild(t),
              [t]
            ),
            y = (0, a.useStateFromStores)([m.default], () => m.default.getId()),
            O = (0, a.useStateFromStores)([C.default], () =>
              C.default.getMember(t, y)
            ),
            [D, w] = r.useState([]),
            V = (0, f.default)(),
            U = (0, S.useUID)();
          if (
            (r.useEffect(() => {
              0 !== D.length &&
                A.default.track(R.AnalyticEvents.PASSPORT_ENTRY_VIEWED, {
                  role_ids: D.map(e => {
                    let { role_id: t } = e;
                    return t;
                  }),
            ...
            return null;
          let j = Object.values(x.roles).filter(e => {
            var t;
            return (
          ...
          return (0, i.jsxs)(u.ModalRoot, {
            ...
            children: [
              (0, i.jsxs)(u.ModalHeader, {
                separator: !1,
                children: [
                  (0, i.jsx)(T.default, { className: P.headerIcon, size: 24 }),
                  (0, i.jsx)(u.Heading, {
                  ...
                  (0, i.jsx)(u.Heading, {
                    ...
                    children:
                      L.default.Messages.CONNECTIONS_ROLES_CHANNEL_CALL_TO_ACTION_LEARN_MORE.format(
                        {
                          helpdeskArticleUrl: I.default.getArticleURL(
                              ...
                              a =
                                (null == r ? void 0 : r.bot) != null
                                  ? (0, i.jsx)("img", {
                                      ...
                                      alt: "",
                                      className: l(P.botAvatar, b.avatar),
                                    })
                                  : null;
                            } else {
                              let t = h.default.get(e.connection_type);
                              a = (0, i.jsx)("img", {
                                src: (0, o.isThemeLight)(V)
                                  ? t.icon.lightSVG
                                  : t.icon.darkSVG,
                                alt: "",
                                className: b.avatar,
    ...
    649844: function (e, t, n) {
      ...
      function v(e) {
        let {
          ...
          U = (0, f.isPremiumExactly)(V, E.PremiumTypes.TIER_2);
        (0, s.openModalLazy)(
          async () => {
      ...
      let d = {
        ...
        E = e => {
          let [t, n] =
            ...
            C = i.useCallback(e => f(e, m, u, r), [r, u, m]),
            _ = i.useCallback(e => f(e, m, v, E), [v, E, m]);
          return null == e
            ? d
            : {
    ...
    300322: function (e, t, n) {
      ...
      function p(e) {
        ...
        return e.type === m.ChannelTypes.GUILD_TEXT && A(t, e);
      }
      function N(e) {
        let t = _(e),
          n = p(e);
      ...
      let h = {
        ...
        E = e => {
          let {
            ...
            N = t;
          if ((!0 === _ ? (N = h.DOWN) : !1 === _ && (N = h.RIGHT), p)) {
            let e = {
...
//# sourceMappingURL=148a6719cd2dc9639b3d.js.map
