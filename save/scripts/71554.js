  ...
  ["71554"],
  {
    ...
    312016: function (e, t, n) {
      ...
      let T = /^\/([a-zA-Z0-9-]+)$/,
        ...
        M = w("discord.com"),
        G = [
          _.default.escape(null !== (i = g.host) && void 0 !== i ? i : ""),
          _.default.escape(null !== (l = m.host) && void 0 !== l ? l : ""),
          _.default.escape(null !== (u = y.host) && void 0 !== u ? u : ""),
          _.default.escape(null !== (a = U.host) && void 0 !== a ? a : ""),
          _.default.escape(null !== (o = M.host) && void 0 !== o ? o : ""),
        ].filter(Boolean),
        B = RegExp(
          "((https?://[^ ]*)|^|[^/][^/.])(".concat(G.join("|"), ")"),
          "g"
    ...
    223913: function (e, t, n) {
      ...
      function N(e) {
        return (0, l.useStateFromStoresArray)(
          [E.default, s.default, d.default, u.default],
          () => p(e, E.default, s.default, d.default, u.default)
        );
      }
      function A(e, t, n) {
        let r = [];
    ...
    373469: function (e, t, n) {
      ...
      function v(e) {
        ...
        r.set(t, {
          ...
          state: u
            ? L.ApplicationStreamStates.PAUSED
            : L.ApplicationStreamStates.ACTIVE,
        }),
      ...
      function U(e, t) {
        ...
        return (
          e === O.StreamTypes.CALL ||
          (null != n &&
            N.default.canBasicChannel(L.BasicPermissions.VIEW_CHANNEL, n))
        );
      }
      function M(e) {
      ...
      class G extends a.default.Store {
        initialize() {
          this.syncWith([N.default], () => !0),
            this.waitFor(d.default, N.default);
        }
        ...
        getCurrentUserActiveStream() {
          ...
          return null == t
            ? null
            : this.getActiveStreamForUser(S.default.getId(), t.getGuildId());
        }
        ...
        getStreamerActiveStreamMetadata() {
          ...
          return null == r
            ? null
            : null !== (e = u[(0, E.encodeStreamKey)(r)]) && void 0 !== e
              ? e
              : null;
        }
        ...
        getAnyStreamForUser(e) {
          ...
          return null == n
            ? null
            : null !== (t = Object.values(n).find(e => M(e))) && void 0 !== t
              ? t
              : null;
        }
        getStreamForUser(e, t) {
          ...
          let r =
            null === (n = i[e]) || void 0 === n
              ? void 0
              : n[null != t ? t : L.NULL_STRING_GUILD_ID];
        ...
        getAllApplicationStreams() {
          return (0, c.default)(p.default)
            ? D().filter(e => null != e && U(e.streamType, e.channelId))
            : [];
        }
        getAllApplicationStreamsForChannel(e) {
          return (0, c.default)(p.default)
            ? D().filter(
                t =>
                  null != t && t.channelId === e && U(t.streamType, t.channelId)
              )
            : [];
        }
        getViewerIds(e) {
      ...
      var B = new G(o.default, {
        ...
        VOICE_STATE_UPDATES: function (e) {
          ...
          return t.reduce((e, t) => {
              ...
              return (
                null ==
                  i[
                    (o = {
                      streamType:
                        null != r ? O.StreamTypes.GUILD : O.StreamTypes.CALL,
                      ownerId: n,
                      guildId: r,
                      channelId: l,
                    }).ownerId
            ...
            }
            {
              ...
              return n === S.default.getId() &&
                u !== t &&
                null != A.default.getChannelId()
                ? e
                : (function (e, t) {
                    var n;
        ...
        STREAM_WATCH: function (e) {
          ...
          r.delete(t),
            r.set(t, { ...n, state: L.ApplicationStreamStates.CONNECTING }),
          ...
          let {
            ...
            c =
              null !==
                (t =
                  null != a
                    ? d.default.getGameForPID(a)
                    : null != s
                      ? d.default
                          .getRunningGames()
                          .find(e => (0, I.default)(s, e.windowHandle))
                      : null) && void 0 !== t
                ? t
                : null;
          (u[_] = { id: null == c ? void 0 : c.id, pid: a, sourceName: o }),
            r.delete(_),
            r.set(_, {
              streamType: n,
              guildId: i,
        ...
        STREAM_TIMED_OUT: function (e) {
          let { streamKey: t } = e,
            n = r.get(t);
          if (null == n) return !1;
          r.set(t, { ...n, state: L.ApplicationStreamStates.FAILED });
        },
        STREAM_DELETE: function (e) {
          ...
          else if (u === L.ApplicationStreamDeleteReasons.UNAUTHORIZED)
            o = L.ApplicationStreamStates.FAILED;
          else if (
            u === L.ApplicationStreamDeleteReasons.SAFETY_GUILD_RATE_LIMITED
          ) {
            let { guildId: e } = (0, E.decodeStreamKey)(t);
            n
              .el("772545")
        ...
        STREAM_UPDATE_SELF_HIDDEN: function (e) {
          let { channelId: t, selfStreamHidden: n } = e,
            r = (0, E.isStreamKey)(h);
          r &&
            (null == h ? void 0 : h.includes(S.default.getId())) &&
            !1 === P[t] &&
            !0 === n &&
            (h = null),
            (P[t] = n);
        ...
        RTC_CONNECTION_STATE: function (e) {
          ...
          if (null == t) return !1;
          let i = r.get(t);
          if (null == i || i.state === L.ApplicationStreamStates.ENDED)
            return !1;
          let l = i.state;
          switch (n) {
        ...
        CHANNEL_RTC_SELECT_PARTICIPANT: function (e) {
          ...
          if (
            ...
            Array.from(r.values()).forEach(e => {
              (0, E.encodeStreamKey)(e) !== h &&
                e.state === L.ApplicationStreamStates.ENDED &&
                y((0, E.encodeStreamKey)(e));
            }),
            null == t)
          )
            return;
    ...
    404008: function (e, t, n) {
      ...
      function y(e, t, n) {
        ...
        let l = e.getGuildId(),
          ...
          c =
            _.default.can(f.Permissions.MOVE_MEMBERS, e) &&
            _.default.can(f.Permissions.CONNECT, e),
          S = !1;
        S =
          e.type === C
            ? null != l &&
      ...
      function M(e) {
        ...
        if (e.type === f.ChannelTypes.GUILD_VOICE)
          return _.default.can(f.Permissions.CONNECT, e)
            ? "voice"
            : "voice-locked";
            ...
            (i =
              null == o || null == s || null == d
                ...
                : ""
                    .concat(location.protocol, "//")
                    .concat(location.host)
                    .concat(f.Routes.CHANNEL_THREAD_VIEW(o, s, d, E)));
...
//# sourceMappingURL=71554.b98f9ed5339d3b6997ae.js.map
