(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["71554"],
  {
    850068: function (e, t, n) {
      ...
      function m(e) {
        var t;
        return N.VAULTABLE_PAYMENT_SOURCES.has(e.type)
          ? null
          : JSON.stringify({
              type:
      ...
      function D(e) {
        ...
        if (((t = e), p.StripeErrorTypes.includes(t.type))) {
          ...
          if (((i = a), "card_error" === e.type))
            c.default.track(N.AnalyticEvents.PAYMENT_SOURCE_CREATION_FAILED, {
              ...a,
      ...
      async function w(e, t, n, r) {
        ...
        return (
          ...
          y(N.PaymentGateways.STRIPE, S.payment_method, n, {
      ...
      function F(e, t, n) {
        return y(N.PaymentGateways.BRAINTREE, e, t, { analyticsLocation: n });
      }
      ...
      async function H(e, t, n, r) {
        ...
        let l = await g(e),
          ...
          E =
            ...
            N.Endpoints.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(
              t,
              null != _ ? _ : "",
              "success"
            );
      ...
      async function W(e) {
        let t = await u.default.get({ url: N.Endpoints.BILLING_PAYMENT(e) });
        return (
          a.default.dispatch({
      ...
      async function ee(e, t) {
        ...
        return N.REDIRECTED_PAYMENT_SOURCES.has(t.type)
      ...
      async function en(e) {
        ...
        if (!N.REDIRECTED_PAYMENT_SOURCES.has(r.type))
      ...
      function e_(e, t, n, r) {
        ...
        return es(
          e,
          { status: N.SubscriptionStatusTypes.ACTIVE, items: i },
          n,
          r
        );
      }
      ...
      async function eR() {
        ...
        try {
          let e = u.default.get({ url: N.Endpoints.BILLING_COUNTRY_CODE });
          a.default.wait(() =>
            a.default.dispatch({
    ...
    312016: function (e, t, n) {
      ...
      let f = /^\/([a-zA-Z0-9-]+)$/,
        ...
        M = w("discord.com"),
        G = [
          c.default.escape(null !== (i = g.host) && void 0 !== i ? i : ""),
          c.default.escape(null !== (l = m.host) && void 0 !== l ? l : ""),
          c.default.escape(null !== (u = y.host) && void 0 !== u ? u : ""),
          c.default.escape(null !== (a = U.host) && void 0 !== a ? a : ""),
          c.default.escape(null !== (o = M.host) && void 0 !== o ? o : ""),
        ].filter(Boolean),
        B = RegExp(
          "((https?://[^ ]*)|^|[^/][^/.])(".concat(G.join("|"), ")"),
          "g"
        ...
        return null !==
          (i =
            null !==
              (r =
                null !==
                  (n = null !== (t = b(y, e)) && void 0 !== t ? t : b(D, e)) &&
                void 0 !== n
                  ? n
                  : b(v, e)) && void 0 !== r
              ? r
      ...
      function V(e) {
        ...
        for (let e of r) {
          ...
          if ((null == i ? void 0 : i.match(f)) != null) {
            let e = (0, _.generateInviteKeyFromUrlParams)(
              i.substring(1),
              r.search
            );
            E.default.getInvite(e), I(S.CodedLinkType.INVITE, e);
          }
          (null == s ? void 0 : s.match(f)) != null &&
            I(S.CodedLinkType.TEMPLATE, s.substring(1));
          ...
          (null == c ? void 0 : c.match(N)) != null &&
            I(S.CodedLinkType.CHANNEL_LINK, c.replace("/channels/", ""));
          let P = (function (e) {
          ...
          null != V &&
            I(S.CodedLinkType.GUILD_PRODUCT, "".concat(V[1], "-").concat(V[2]));
    ...
    223913: function (e, t, n) {
      ...
      function p(e) {
        return (0, u.useStateFromStoresArray)(
          [_.default, s.default, d.default, a.default],
          () => N(e, _.default, s.default, d.default, a.default)
        );
      }
      function A(e, t, n) {
        let r = [];
    ...
    398604: function (e, t, n) {
      ...
      function L(e) {
        ...
        let l =
          ...
          a =
            (null === (n = f[e.guild_scheduled_event_id]) || void 0 === n
              ? void 0
              : null === (t = n[u]) || void 0 === t
                ? void 0
                : t[e.user_id]) != null,
        ...
        (a || !s) &&
          (null === (i = f[e.guild_scheduled_event_id]) ||
            void 0 === i ||
            null === (r = i[u]) ||
            void 0 === r ||
            delete r[e.user_id],
              ...
              l =
                (null != e.guild_scheduled_event_exception_id &&
                  e.response ===
                    d.GuildScheduledEventUserResponses.UNINTERESTED) ||
                (null == e.guild_scheduled_event_exception_id &&
                  e.response === d.GuildScheduledEventUserResponses.INTERESTED)
                  ? -1
                  : 1;
            O(
              e.guild_scheduled_event_id,
      ...
      function g(e) {
        ...
        return (
          r < 0 ? i.push(t) : (i[r] = t),
          p({ ...n, guild_scheduled_event_exceptions: i }),
          !0
        );
      }
      function m(e) {
        ...
        return (
          ...
          ((t =
            ...
            d.GuildScheduledEventStatus.ACTIVE),
          t)
        );
      }
      function y(e) {
      ...
      class v extends l.default.Store {
        ...
        getUserCount(e, t) {
          ...
          let u =
            null !==
              (i = null === (n = N[e]) || void 0 === n ? void 0 : n[T]) &&
            void 0 !== i
              ? i
              : 0;
          if (null == t) return u;
        ...
        getUsersForGuildEvent(e, t) {
          ...
          let i = R(t);
          return null !==
            (r = null === (n = f[e]) || void 0 === n ? void 0 : n[i]) &&
            void 0 !== r
            ? r
            : {};
        }
      ...
      var U = new v(a.default, {
        CONNECTION_OPEN: function (e) {
          ...
          return (
            ...
            (N = {}),
            S.forEach(p),
            t.forEach(e => e.guild_scheduled_events.forEach(e => p(e))),
            !0
          );
        },
        ...
        FETCH_GUILD_EVENTS_FOR_GUILD: function (e) {
          let { guildId: t, guildScheduledEvents: n } = e,
            r = c.values(_.GUILD_EVENT(t), !0).map(e => e.id),
            l = n.map(e => e.id);
        ...
        GUILD_SCHEDULED_EVENT_USER_COUNTS_FETCH_SUCCESS: function (e) {
          ...
          for (let e in (O(t, null, n.eventCount), n.recurrenceCounts))
        ...
        GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE: function (e) {
          ...
          return p({ ...n, guild_scheduled_event_exceptions: r }), !0;
        },
        GUILD_SCHEDULED_EVENT_EXCEPTIONS_DELETE: function (e) {
          let { eventId: t } = e,
            n = c.get(t);
          return (
            null != n && (p({ ...n, guild_scheduled_event_exceptions: [] }), !0)
          );
        },
        LOGOUT: function () {
          return c.clear(), !0;
    ...
    325861: function (e, t, n) {
      ...
      function R(e, t) {
        ...
        return (
          ...
          (null === (n = N[t]) || void 0 === n || delete n[e], !0)
        );
      }
      function C(e) {
        let t = d.default
        ...
        for (let { channel: e } of t) delete N[e.id];
        return t.length > 0;
      }
      function L(e) {
      ...
      class M extends a.default.Store {
        initialize() {
          this.syncWith([f.default], () => !0),
            this.waitFor(p.default, f.default);
        }
    ...
    404008: function (e, t, n) {
      ...
      function m(e, t, n) {
        ...
        let l = e.getGuildId(),
          ...
          c =
            E.default.can(T.Permissions.MOVE_MEMBERS, e) &&
            E.default.can(T.Permissions.CONNECT, e),
          S = !1;
        S =
          e.type === R
            ? null != l &&
      ...
      function U(e) {
        ...
        if (e.type === T.ChannelTypes.GUILD_VOICE)
          return E.default.can(T.Permissions.CONNECT, e)
            ? "voice"
            : "voice-locked";
            ...
            (i =
              null == o || null == s || null == d
                ...
                : ""
                    .concat(location.protocol, "//")
                    .concat(location.host)
                    .concat(T.Routes.CHANNEL_THREAD_VIEW(o, s, d, _)));
