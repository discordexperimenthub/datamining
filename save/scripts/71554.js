(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["71554"],
  {
    ...
    398604: function (e, t, n) {
            ...
            (function (e) {
              ...
              let r = R(e.guild_scheduled_event_exception_id),
                i =
                  null !==
                    (n =
                      null === (t = p[e.guild_scheduled_event_id]) ||
                      void 0 === t
                        ? void 0
                        : t[r]) && void 0 !== n
                    ? n
          ...
          (function (e) {
            ...
            let r = R(e.guild_scheduled_event_exception_id),
              i =
                null !==
                  (n =
                    null === (t = p[e.guild_scheduled_event_id]) || void 0 === t
                      ? void 0
                      : t[r]) && void 0 !== n
                  ? n
                  : 0,
      ...
      function h(e, t) {
        c.values(E.GUILD_EVENT(e)).forEach(e => A(e.id, t));
      }
      function P(e) {
      ...
      function g(e) {
        ...
        return (
          r < 0 ? i.push(t) : (i[r] = t),
          N({ ...n, guild_scheduled_event_exceptions: i }),
          !0
        );
      }
      function m(e) {
      ...
      class v extends l.default.Store {
        ...
        getUserCount(e, t) {
          ...
          let u =
            null !==
              (i = null === (n = p[e]) || void 0 === n ? void 0 : n[T]) &&
            void 0 !== i
              ? i
              : 0;
          if (null == t) return u;
          let a =
            null !==
              (l = null === (r = p[e]) || void 0 === r ? void 0 : r[t]) &&
            void 0 !== l
              ? l
              : 0;
          return u - a;
      ...
      var U = new v(a.default, {
        ...
        FETCH_GUILD_EVENTS_FOR_GUILD: function (e) {
          let { guildId: t, guildScheduledEvents: n } = e,
            r = c.values(E.GUILD_EVENT(t), !0).map(e => e.id),
            l = n.map(e => e.id);
        ...
        GUILD_SCHEDULED_EVENT_USER_COUNTS_FETCH_SUCCESS: function (e) {
          ...
          for (let e in (L(t, null, n.eventCount), n.recurrenceCounts))
        ...
        GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE: function (e) {
          ...
          return N({ ...n, guild_scheduled_event_exceptions: r }), !0;
        },
        GUILD_SCHEDULED_EVENT_EXCEPTIONS_DELETE: function (e) {
          let { eventId: t } = e,
            n = c.get(t);
          return (
            null != n && (N({ ...n, guild_scheduled_event_exceptions: [] }), !0)
          );
        },
        LOGOUT: function () {
          return c.clear(), !0;
      ...
      ((u = r || (r = {})).SPEAKER = "SPEAKER"),
        ...
        (l = class {
          ...
          constructor(e) {
            var t;
            (this.participants = {}),
              (this._participantsIndex = new o.default(g, L)),
      ...
      var G = new M(o.default, {
          ...
          return t.reduce((e, t) => {
              ...
              return (
                null ==
                  i[
                    (n = {
                      streamType:
                        null != s ? O.StreamTypes.GUILD : O.StreamTypes.CALL,
                      ownerId: o,
                      guildId: s,
                      channelId: d,
                    }).ownerId
                ...
                (i[n.ownerId][
                  null !== (r = n.guildId) && void 0 !== r ? r : "null"
                ] = n),
                !0
              );
            }
            {
              ...
              return (
                (l = o),
                (u = null != (u = s) ? u : "null"),
                ((null === (a = i[l]) || void 0 === a ? void 0 : a[u]) !=
                  null &&
                  (delete i[l][u], !0)) ||
                  e
              );
        ...
        STREAM_UPDATE_SELF_HIDDEN: function (e) {
          let { channelId: t, selfStreamHidden: n } = e,
            r = (0, d.isStreamKey)(L);
          r &&
            (null == L ? void 0 : L.includes(c.default.getId())) &&
            !1 === h[t] &&
            !0 === n &&
            (L = null),
            (h[t] = n);
...
//# sourceMappingURL=71554.4bf9ab49e3f274b4d05f.js.map
