      ...
      function y(e) {
        let {
          ...
          z = (0, s.useStateFromStores)([v.default], () =>
            v.default.can(L.Permissions.SEND_MESSAGES, F)
          ),
        ...
        let q = [];
        return (!W &&
          q.push((0, n.jsx)(C.default, { channel: F }, "notifications")),
        q.push(
          (0, n.jsx)(
            R.default.Icon,
            {
                  ...
                  children: (0, N.renderTitle)({
                    ...
                    handleContextMenu: e => {
                      (0, i.openContextMenuLazy)(e, async () => {
                        ...
                        return t =>
                          (0, n.jsx)(e, { ...t, channel: F, guild: H });
                      });
                    },
                    handleClick: () => {
                      let e = T.default.getMessages(F.id);
                      if (w) {
                        (0, g.transitionTo)(L.Routes.CHANNEL(F.guild_id, F.id)),
    ...
    961727: function (e, t, l) {
      ...
      function et(e) {
        ...
        let { guild: l, user: s } = e,
          ...
          x = r(N)
            .filter(e => l.roles.hasOwnProperty(e))
            .map(e => l.roles[e])
            .orderBy("position", "desc")
            .value(),
          S = (0, v.default)(s.id, l.id);
        a.useEffect(() => {
        ...
        let E = (0, I.parseBioReact)(null == S ? void 0 : S.bio),
          _ = y.default.getEnableHardwareAcceleration()
            ? m.AnimatedAvatar
            : m.Avatar;
        return (0, n.jsxs)("div", {
          className: K.profile,
        ...
        a.useEffect(() => {
          if ((null == d ? void 0 : d.id) != null)
            !E.default.isFullServerPreview(d.id) &&
              (F.default.shouldFetchPrompts(d.id) || h) &&
...
//# sourceMappingURL=8624211533f402b331c4.js.map
