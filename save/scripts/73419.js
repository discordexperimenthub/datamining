  ...
  ["73419"],
  {
    ...
    442939: function (e, t, n) {
      ...
      function u(e) {
        ...
        return (
          l.useEffect(() => {
            !(0, s.areArraysShallowEqual)(e, t.current) &&
              (i.default.fetchApplications(e, !1), (t.current = e));
          }, [e]),
          (0, a.useStateFromStoresArray)([r.default], () =>
    ...
    310688: function (e, t, n) {
      ...
      class eI extends a.PureComponent {
        ...
        getInviteKey() {
          ...
          return null == s
            ? s
            : (0, q.generateInviteKeyFromExtraData)({
                baseCode: s,
      ...
      var eg = a.forwardRef(function (e, t) {
        ...
        let {
          ...
          { analyticsLocations: B } = (0, p.default)(
            m.default.INSTANT_INVITE_MODAL
          ),
          ...
          J = null;
        null != I
          ? (J = el.InviteTargetTypes.STREAM)
          : null != g && (J = el.InviteTargetTypes.EMBEDDED_APPLICATION);
        let $ = null != u ? u.getGuildId() : null != o ? o.id : null,
          ee = (0, f.useStateFromStores)(
            [D.default],
            () => {
          ...
          [et, en, ei, er, eu] = (0, f.useStateFromStoresArray)(
            ...
            () => {
              ...
              return [
                ...
                null != u && null != Q
                  ? H.default.getVoiceStatesForChannel(Q)
                  : null,
                null != $ ? j.default.getProps($, e) : null,
              ];
            },
            [Q, u, $]
          ),
          eo = (0, f.useStateFromStores)(
            [U.default],
            () =>
              null != Q &&
              U.default.can(ea.Permissions.CREATE_INSTANT_INVITE, Q),
            [Q]
          ),
          ed = null === ee || !eo,
          [eg] = a.useState(() => {
            ...
            return (
              null != I && null != er
                ...
                : null != $ &&
                  null != eu &&
                  J !== el.InviteTargetTypes.EMBEDDED_APPLICATION &&
                  eu.rows.forEach(t => {
          ...
          ev = (0, f.useStateFromStores)(
            [R.default],
            () => R.default.getStageInstanceByChannel(eE),
            [eE]
          );
        a.useEffect(() => {
        ...
        let [eT] = (0, _.default)(null != g ? [g] : []),
          em = (0, S.default)({ guildId: $ }),
          ep = null != ee ? ee.code : void 0,
          e_ = null == ee ? void 0 : ee.maxAge,
          eN = null == ee ? void 0 : ee.maxUses,
          eC = null == ee ? void 0 : ee.temporary,
          eS = o.vanityURLCode,
          ex = null != eS && eS.length > 0,
          { enabled: eM } = X.default.useExperiment(
            {
              guildId:
                null !==
                  (i =
          ...
          eA = eM && !(null == Q ? void 0 : Q.isGuildVocal()) && ex,
          ey = (null == Q ? void 0 : Q.type) === ea.ChannelTypes.GUILD_VOICE,
          eR = (0, N.default)(Q);
        !eo &&
          (null == ev ? void 0 : ev.invite_code) != null &&
          (ep = ev.invite_code);
        let [eL, ej] = a.useState({
            query: "",
            maxAge:
              null !== (r = null != e_ ? e_ : em) && void 0 !== r
                ? r
                : eh.value,
            savedMaxAge:
              e_ === ec.value ? (null != em ? em : eh.value) : ec.value,
          ...
          eO = a.useCallback(
            e => {
              eV({ currentPage: e, lastPage: eL.currentPage });
            },
            [eL.currentPage, eV]
          ),
          eD =
            ...
            !ed &&
            !eR,
          { enabled: ew } = A.GuestVoiceInvitesExperiment.useExperiment(
            { guildId: null == o ? void 0 : o.id, location: "acc417_3" },
            { autoTrackExposure: eD }
          ),
          { maxAge: eU, maxUses: eG, temporary: eP, savedMaxAge: eF } = eL,
          eH = a.useCallback(() => {
            let { currentPage: e, lastPage: t } = eL;
          ...
          eb = a.useCallback(() => {
            ...
            0 === eG && 0 === eU && !eP && eA
              ? eV({ networkError: void 0, showVanityURL: !0 })
              : null != e &&
                (eV({ networkError: void 0, showVanityURL: !1 }),
                E.default
                  .createInvite(
                    e,
                    {
                  ...
                  .catch(e => eV({ networkError: e, showVanityURL: eA }))),
              eU !== ec.value &&
                eF !== ec.value &&
                eV({ savedMaxAge: ec.value });
          }, [
            eA,
            Q,
            d,
        ...
        return (
          ...
          (0, l.jsx)(p.AnalyticsLocationProvider, {
            value: B,
            children: (0, l.jsx)(eI, {
              ref: t,
              canCreateInvites: eo,
              ...
              shouldHideTemporaryInviteToggle:
                (ew && eD) || L === el.InstantInviteModalPages.GUEST,
              modalState: eL,
              setModalState: eV,
              changePage: eO,
