  ...
  ["74143"],
  {
    ...
    467094: function (e, t, r) {
      ...
      let m = async (e, t) => {
        ...
        g = async e => {
          let { body: t } = await s.HTTP.get({ url: p.Endpoints.STICKER(e) });
    ...
    41170: function (e, t, r) {
      ...
      let x = e => {
          let {
            ...
            u = l >= 33;
          return (0, i.jsxs)("div", {
            className: a(T.assetWrapper, { [T.assetWrapperMasked]: r || s }),
            ...
            children: [
              r
                ? (0, i.jsxs)("div", {
                    className: T.error,
                    children: [
                      (0, i.jsx)(E.default, { className: T.errorIcon }),
                      u &&
                        (0, i.jsx)(f.Text, {
                ...
                : t,
              c && n && (0, i.jsx)("div", { className: T.loadingIndicator }),
            ],
          });
        },
        L = e => {
          ...
          null == N)
            ...
            : (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)(x, {
                  ...
                  withLoadingIndicator: E,
                  children: _(
                    (0, i.jsx)("canvas", { className: T.lottieCanvas, ref: I }),
                    a.id
                  ),
                }),
              });
        ...
        N = e => {
          ...
          n.useLayoutEffect(() => {
            var e;
            (null === (e = v.current) || void 0 === e ? void 0 : e.complete) ===
              !0 && I(!1);
          }, []),
          null == R)
            ? null
      ...
      let C = (0, c.cssValueToNumber)(T.stickerPickerPreviewDimensions),
        ...
        R = n.memo(function (e) {
          let {
            ...
            W = n.useMemo(() => ({ width: j, height: j, padding: b }), [b, j]);
          return (0, i.jsx)("div", {
            className: T.row,
            style: z,
            ...(null == R ? void 0 : R(P)),
            children: w.map(e => {
              ...
              let C =
                ...
                }, 250),
                {
                  ...
                  onFocus: b,
                  ...H
                } = null !== (o = null == c ? void 0 : c(e.columnIndex, P)) &&
                void 0 !== o
                  ? o
                  : {};
              switch (e.type) {
                ...
                case p.StickerGridItemTypes.STICKER: {
                  ...
                  return (0, n.createElement)(
                    ...
                    (0, i.jsxs)(u.Clickable, {
                      className: a(T.sticker, F, { [T.stickerInspected]: C }),
                      innerRef: _,
                      tabIndex: w,
                      onFocus: null != b ? b : R,
                      onMouseMove: R,
...
//# sourceMappingURL=74143.6aad341005d9d73a2d7e.js.map
