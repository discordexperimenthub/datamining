  ...
  ["82899"],
  {
    ...
    861370: function (e, t, n) {
      ...
      var i = n("627445"),
        ...
        s = n("306160");
      function d(e) {
        let { id: t, label: n, onSuccess: i, shiftId: d, showIconFirst: c } = e,
    ...
    244480: function (e, t, n) {
      ...
      function p(e, t) {
        ...
        let u = c.default.getVoiceStateForChannel(e.id),
          a = (0, E.getAudienceRequestToSpeakState)(u);
        return (
          a ===
      ...
      function I(e, t, n) {
        ...
        n
          ? ((s.allow = u.add(s.allow, t)), (s.deny = u.remove(s.deny, t)))
          : ((s.allow = u.remove(s.allow, t)), (s.deny = u.add(s.deny, t))),
    ...
    230324: function (e, t, n) {
      ...
      function c(e, t, n, l) {
        ...
        return 1 === a && null != u
          ? r
          : null == u
            ? d.default.Messages.SPEAKING_COUNT.format({ count: a })
      ...
      function g(e) {
        ...
        return {
          ...
          request_to_speak_state: u.canEveryoneRole(
      ...
      function h(e) {
        ...
        let n = (0, g.default)(),
          ...
          m = (0, i.useStateFromStores)(
            [o.default],
            () =>
              null != h ? o.default.getVoiceStateForChannel(h, e.id) : null,
            [h, e.id]
          ),
          v =
          ...
          T = (0, i.useStateFromStores)(
            [c.default],
            () => c.default.getPermissionsForUser(e.id, h),
            [h, e.id]
          ),
    ...
    692986: function (e, t, n) {
      ...
      function v(e) {
        let t =
          ...
          I =
            s.default.supports(E.Features.DISABLE_VIDEO) && !n
              ? (0, l.jsx)(
                  u.MenuCheckboxItem,
                  {
                    id: "disable-video",
                        ...
                        r.default.show({
                          ...
                          onConfirm: () =>
                            a.default.setDisableLocalVideo(
                              e,
                              h.VideoToggleState.MANUAL_ENABLED
                            ),
                        });
                        return;
                      }
            ...
            : (0, l.jsx)(
                u.MenuCheckboxItem,
                {
                  ...
                  action: () => {
                    ...
                    _.default.track(
                      h.AnalyticEvents.AUDIO_LOCAL_SOUNDBOARD_MUTE_TOGGLED,
                      {
