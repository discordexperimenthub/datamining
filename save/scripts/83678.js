                ...
                return (0, a.jsx)(
                  o.MenuItem,
                  {
                    ...
                    action: () => {
                      ...
                      return (
                        (n = e.activity),
                        void (T.default.track(x.AnalyticEvents.OPEN_MODAL, {
      ...
      function P(e) {
        let { channel: t } = e,
          ...
          k = (0, c.useStateFromStores)([T.default], () =>
            null != P ? T.default.getRoles(P) : void 0
          ),
          F = (0, c.useStateFromStores)([_.default, T.default], () => {
            var e;
            return _.default.getUser(
              null === (e = T.default.getGuild(P)) || void 0 === e
                ? void 0
                : e.ownerId
            );
          }),
    ...
    952999: function (e, t, n) {
      ...
      function j(e) {
        let { channel: t } = e,
          ...
          P = (0, u.useStateFromStores)([T.default], () => {
            var e, t;
            return (
      ...
      function d(e) {
        ...
        return (
          f.forEach(e => {
            ...
            n === e.id && (d = b);
            let { jumpSequenceId: P, jumpFlash: k, jumpTargetId: F } = f;
...
//# sourceMappingURL=fc991ed6d04104a2a28a.js.map
