      ...
      function P(e) {
        let { channel: t } = e,
          ...
          P = (0, c.useStateFromStores)([T.default], () =>
            T.default.getGuild(t.guild_id)
          ),
          k = (0, c.useStateFromStores)([_.default], () =>
            _.default.getUser(null == P ? void 0 : P.ownerId)
          ),
          F = s.useMemo(
            () =>
              null != P
                ? o(P.roles)
                    .sortBy(e => -e.position)
                    .filter(e => !(0, m.isEveryoneRoleId)(P.id, e.id))
                    .value()
                : [],
            [P]
          ),
          ...
          U = (0, c.useStateFromStoresArray)(
            [_.default],
            () => {
              let e = {};
              for (let n of (null != k && (e[k.id] = k),
...
//# sourceMappingURL=ef9b4745ebf653f84567.js.map
