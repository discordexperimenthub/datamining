(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["83987"],
  {
      ...
      var i = n("872717"),
        ...
        C = {
          ...
          updateGuildNotificationSettings(e, t, n, i) {
            ...
            l.default.saveUserGuildSettings(e, t),
              r.default.dispatch({
          ...
          updateGuildAndChannelNotificationSettings(e, t, n, i) {
            ...
            l.default.saveUserGuildSettings(e, t),
              ...
              (0, o.trackGuildNotificationSettingsUpdate)(e, t, s, n, i),
          ...
          updateGuildNotificationSettingsBulk(e, t, n) {
            ...
            l.default.saveUserGuildSettingsBulk(e),
          ...
          updateChannelOverrideSettings(e, t, n, i, s) {
            ...
            l.default.saveUserGuildSettings(e, {
              ...
              (0, o.trackChannelNotificationSettingsUpdate)(e, t, n, u, i, s);
          },
          updateChannelOverrideSettingsBulk(e, t, n, i) {
            let a = d.default.keys(t),
              s = (0, o.getManyCurrentChannelSettings)(e, a);
            l.default.saveUserGuildSettings(e, { channel_overrides: t }),
              r.default.dispatch({
    ...
    531674: function (e, t, n) {
      ...
      function g(e, t) {
        let [n, a] = (0, l.useStateFromStoresArray)([c.default], () => [
    ...
    200008: function (e, t, n) {
      ...
      function c(e) {
        for (let t in e) {
          ...
          if (
            null == a ||
            (!a.isPrivate() && !l.default.can(o.Permissions.VIEW_CHANNEL, a))
          ) {
            delete e[t];
            continue;
          }
    ...
    986373: function (e, t, n) {
      ...
      function E(e) {
        let { favoritesEnabled: t, hasStaffPrivileges: n } = (0,
          ...
          l = e.isDM() || e.isThread(),
          s = !l || (n && (null == a ? void 0 : a.isStaff()) === !0);
    ...
    390008: function (e, t, n) {
      ...
      function d(e) {
        let t = (0, a.useStateFromStores)([l.default], () =>
          ...
          { isFavoritesPerk: c } = (0, s.useFavoritesServerExperiment)(
    ...
    936947: function (e, t, n) {
      ...
      function o(e) {
        let t = (0, l.useFavoritesGuildSelected)(),
          ...
          { isFavoritesPerk: d } = (0, s.useFavoritesServerExperiment)(
          ...
          children: [
            !n &&
              (0, i.jsx)(a.MenuItem, {
                ...
                action: () =>
                  (0, l.markAsInappropriateConversation)(
                    e.id,
      ...
      function c(e) {
        let t = (0, a.useStateFromStores)([o.default], () =>
          ...
          n = (0, a.useStateFromStores)([s.default], () =>
            s.default.getChannelSafetyWarnings(e.id)
          );
        return (null == t ? void 0 : t.isStaff()) !== !0 ||
          null == n ||
          0 === n.length
        ...
        E = (e, t) => {
          ...
          null != window.GLOBAL_ENV.CDN_HOST)
            ? ""
                ...
                .concat(c)
                .concat(f)
            : "".concat(o).concat(s.Endpoints.ROLE_ICON(n, i), "?").concat(c);
        },
        C = e =>
          e.startsWith(u) ||
    ...
    270161: function (e, t, n) {
      ...
      let l = r.Permissions.VIEW_CHANNEL,
        s = i.default.combine(l, r.Permissions.CONNECT),
        u = i.default.combine(l, a.MODERATE_STAGE_CHANNEL_PERMISSIONS);
    },
    ...
    649844: function (e, t, n) {
      ...
      function p(e) {
        let {
          ...
          w = (0, f.isPremiumExactly)(F, C.PremiumTypes.TIER_2);
        (0, r.openModalLazy)(
          async () => {
        ...
        C = e => {
          let [t, n] =
              e instanceof l.default
                ...
                : E(e),
            [a, o, C, p] = (0, r.useStateFromStoresArray)([s.default], () => [
            ...
            v = i.useCallback(e => f(e, _, p, C), [p, C, _]);
          return null == e
            ? c
            : {
    ...
    38766: function (e, t, n) {
      ...
      function o(e) {
        let {
          ...
          E = (0, i.useCallback)(() => {
            null != t && (0, l.initGuildIdentitySettings)(t, null != d ? d : f),
              a.default.open(
    ...
    764828: function (e, t, n) {
      ...
      ((r = i || (i = {}))[(r.STRANGER_DANGER = 1)] = "STRANGER_DANGER"),
        ...
        ((l = a || (a = {}))[(l.UPVOTE = 0)] = "UPVOTE"),
        (l[(l.DOWNVOTE = 1)] = "DOWNVOTE");
      let f = [],
        E = {},
        C = new Set();
      function p(e) {
    ...
    476294: function (e, t, n) {
      ...
      let u = e => {
        let t = (0, l.useIsEligibleForInappropriateConversationWarning)({
          ...
          u = (0, s.useInappropriateConversationBannerForChannel)(
            e.id,
            "context-menu-item"
          );
          ...
          (0, l.default)(
            function (e) {
              let {
                ...
                B = (0, P.default)(t.id, null),
                Z = (0, O.default)(t, k),
                z = (0, R.default)({ user: t, context: k }),
                K = (0, m.default)(t),
                X = (0, w.default)(t.id),
                Q = (0, L.default)(n.id, l),
                q = (0, G.default)(t),
                ...
                eg = (0, S.useInappropriateConversationItem)(n),
                ...
                children: [
                  ...
                  (0, i.jsxs)(a.MenuGroup, {
                    children: [
                      !eA &&
                        (0, i.jsxs)(i.Fragment, {
                          children: [j && B, Z, !eN && ee, j && z, j && K, X],
                        }),
                      Q,
                    ],
                  }),
                  !eA &&
                    (0, i.jsxs)(i.Fragment, {
                      children: [
                        ...
                        (0, i.jsx)(a.MenuGroup, { children: s && er }),
                        D && (0, i.jsxs)(a.MenuGroup, { children: [ed, eo] }),
                      ],
                    }),
                  (0, i.jsx)(a.MenuGroup, { children: ep }),
                  (0, i.jsxs)(a.MenuGroup, { children: [el, !H && es] }),
                ],
              });
            },
      ...
      function c(e, t) {
        let n = (0, a.useStateFromStores)(
          ...
          [c, f] = (0, a.useStateFromStoresArray)(
            [s.default],
            () => [
              s.default.getParticipants(t),
              s.default.getParticipant(t, e),
            ],
            [t, e]
          );
        return n || 0 === c.length
    ...
    870691: function (e, t, n) {
      ...
      class C extends i.default.PersistedStore {
        initialize(e) {
          this.waitFor(l.default, s.default),
    ...
    931138: function (e, t, n) {
      ...
      function d(e) {
        ...
        return (0, i.jsxs)("div", {
          className: l(o.flowerStarContainer, r),
          style: { width: n, height: n },
          children: [
            (0, i.jsx)(u.default, { ...c, className: l(d, o.flowerStar) }),
            (0, i.jsx)("div", {
      ...
      let E = {
        ...
        C = e => {
          let {
            ...
            N = t;
          if ((!0 === v ? (N = E.DOWN) : !1 === v && (N = E.RIGHT), S)) {
            let e = {
...
//# sourceMappingURL=2f21eef85edabbe80437.js.map
