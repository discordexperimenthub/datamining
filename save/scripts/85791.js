  ...
  ["85791"],
  {
          ...
          if (
            ...
            var t = e.document,
              ...
              _ = function (t, u, _) {
                ...
                if (((S.readyState = S.INIT), !u && (u = "download"), i)) {
      ...
      class N extends i.PureComponent {
        renderSMSSection() {
          let { currentUser: e } = this.props,
            ...
            n = e.hasFlag(R.UserFlags.MFA_SMS),
            i = e.hasFlag(R.UserFlags.PARTNER) || e.hasFlag(R.UserFlags.STAFF);
          return t
            ? (0, r.jsxs)(m, {
                label: v.default.Messages.MFA_SMS_ENABLE,
                text: v.default.Messages.MFA_SMS_AUTH_SALES_PITCH,
                children: [
                  (0, r.jsxs)(l.Text, {
                    variant: "text-md/normal",
                    className: A.sectionBody,
                    children: [
                      (0, r.jsx)("strong", {
                        ...
                        children:
                          v.default.Messages.MFA_SMS_AUTH_CURRENT_PHONE.format({
                            phoneNumber: e.phone,
                          }),
                      }),
                      (0, r.jsx)(l.Button, {
                  ...
                  (0, r.jsx)(l.Button, {
                    ...
                    children: i
                      ? v.default.Messages.MFA_SMS_DISABLED_PARTNER
                      : n
                        ? v.default.Messages.MFA_SMS_ALREADY_ENABLED
                        : v.default.Messages.MFA_SMS_ENABLE,
                  }),
                ],
              })
            : (0, r.jsx)(m, {
                ...
                children: (0, r.jsx)(l.Button, {
                  ...
                  children: i
                    ? v.default.Messages.MFA_SMS_DISABLED_PARTNER
                    : v.default.Messages.MFA_SMS_ADD_PHONE,
                }),
              });
        }
        renderBackupCodesSection() {
          return (0, r.jsx)(m, {
            label: v.default.Messages.TWO_FA_DOWNLOAD_CODES,
            text: v.default.Messages.TWO_FA_BACKUP_CODES_WARNING.format(),
                ...
                children: [
                  (0, r.jsx)(l.Heading, {
                    ...
                    children: f.default.parse(
                      v.default.Messages.TWO_FA_SUCCESS_HEADER
                    ),
                  }),
                  (0, r.jsx)(l.Text, {
        ...
        renderConfirmModal(e) {
          ...
          return (0, r.jsx)(l.DeclarativeConfirmModal, {
            dismissable: !0,
            header: v.default.Messages.TWO_FA_CONFIRM_TITLE,
            confirmText: v.default.Messages.TWO_FA_CONFIRM_CONFIRM,
        ...
        renderTotp() {
          ...
          return (0, r.jsxs)(l.ModalRoot, {
            ...
            children: [
              this.renderHeader(
                v.default.Messages.MFA_SMS_ENABLE_SHOULD_DO.format()
              ),
              (0, r.jsxs)(l.ModalContent, {
                className: A.modalInner,
                children: [
                  this.renderSMSSection(),
                  (0, r.jsx)(l.FormDivider, { className: A.divider }),
                  this.renderBackupCodesSection(),
                ],
              }),
              t &&
                this.renderConfirmModal(v.default.Messages.TWO_FA_CONFIRM_BODY),
            ],
          });
        }
        renderWebAuthn() {
          ...
          return (0, r.jsxs)(l.ModalRoot, {
            ...
            children: [
              this.renderHeader(
                v.default.Messages.TWO_FA_WEBAUTHN_SHOULD_DO.format()
              ),
              ...
              t &&
                this.renderConfirmModal(
                  v.default.Messages.TWO_FA_CONFIRM_WEBAUTHN_BODY
                ),
            ],
          });
        }
                  ...
                  .map(e => {
                    ...
                    return "* "
                      ...
                      .concat(
                        t
                          ? "(".concat(
                              v.default.Messages.TWO_FA_BACKUP_CODE_USED,
                              ")"
                            )
                          : ""
                      );
    ...
    270161: function (e, t, n) {
      ...
      let o = s.Permissions.VIEW_CHANNEL,
        a = r.default.combine(o, s.Permissions.CONNECT),
        l = r.default.combine(o, i.MODERATE_STAGE_CHANNEL_PERMISSIONS);
    },
    649844: function (e, t, n) {
      ...
      function _(e) {
        let {
          ...
          V = (0, f.isPremiumExactly)(L, h.PremiumTypes.TIER_2);
        (0, s.openModalLazy)(
          async () => {
      ...
      let d = {
        ...
        h = e => {
          let [t, n] =
            ...
            S = r.useCallback(e => f(e, p, _, h), [_, h, p]);
          return null == e
            ? d
            : {
    ...
    300322: function (e, t, n) {
      ...
      function x(e) {
        return (0, o.useStateFromStores)([E.default], () => b(e, E.default));
      }
      function w(e) {
        let t = (0, l.default)(),
    ...
    931138: function (e, t, n) {
      ...
      function c(e) {
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [
            (0, r.jsx)(l.default, { ...d, className: o(c, u.flowerStar) }),
            (0, r.jsx)("div", {
      ...
      let E = {
        ...
        h = e => {
          let {
            ...
            { enabled: I } = (0, c.useRedesignIconContext)(),
            v = t;
          if ((!0 === S ? (v = E.DOWN) : !1 === S && (v = E.RIGHT), I)) {
            let e = {
...
//# sourceMappingURL=0f0f06426c28e374dd5e.js.map
