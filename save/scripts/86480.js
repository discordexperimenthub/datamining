(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["86480"],
  {
    ...
    862013: function (e, t, i) {
      ...
      function o() {
        [
          { id: a, text: "," },
          { id: l, text: "," },
          { id: r, text: s.default.Messages.REACTIONS },
          {
            id: u,
      ...
      var s = i("414456"),
        ...
        A = function (e) {
          let {
            ...
            H = (0, l.useStateFromStores)([m.default], () =>
              m.default.getCurrentUser()
            ),
            F = (0, l.useStateFromStores)([T.default], () =>
              T.default.isFocused()
            ),
            Y = (0, l.useStateFromStores)([I.default], () =>
              I.default.getPremiumTypeSubscription()
            ),
            { analyticsLocations: z } = (0, o.default)(),
            K = e => {
              ...
              if (
                (null == A || A(e),
                (null == Y ? void 0 : Y.status) ===
                  _.SubscriptionStatusTypes.ACCOUNT_HOLD)
              ) {
                (0, c.trackPremiumSettingsPaneOpened)(),
                  u.default.open(_.UserSettingsSections.PREMIUM),
                  null == C || C(!1);
                return;
              }
              !(function (e) {
                ...
                if (!t) {
                  (0, r.openModalLazy)(async () => {
                    let { default: e } = await i
                      .el("984599")
                      .then(i.bind(i, "984599"));
                    return t => {
                      let { onClose: i, ...s } = t;
                      return (0, n.jsx)(e, { ...s, onClose: i });
                    };
                  });
                  return;
                }
                ...
                null != u
                  ? (T = _.AnalyticsObjectTypes.TRIAL)
                  : a && (T = _.AnalyticsObjectTypes.GIFT),
                  (0, d.default)({
                    isGift: a,
                    initialPlanId: null,
                    subscriptionTier: l,
          ...
          if (P)
            return (0, n.jsxs)(r.Button, {
              ...
              ...W,
              children: [
                U && (0, n.jsx)(S.default, { className: b.premiumIcon }),
                (0, n.jsx)("span", {
                  className: a(b.buttonText, L),
                  children:
                    null != O
                      ? O
                      : y.default.Messages.PREMIUM_TRIAL_CTA_BUTTON_VARIANT,
                }),
              ],
            });
          if (t)
            return (0, n.jsxs)(r.Button, {
              ...
              ...W,
              children: [
                (0, n.jsx)(h.default, { className: b.giftIcon }),
                (0, n.jsx)("span", {
                  className: a(b.buttonText, L),
                  children:
                    null != O ? O : y.default.Messages.PREMIUM_GIFTING_BUTTON,
                }),
              ],
            });
          let V = y.default.Messages.APPLICATION_STORE_GET_PREMIUM,
            ...
            Z =
              null != X
                ? E.default.getPremiumType(X.planId)
                : null == H
                  ? void 0
                  : H.premiumType,
            q =
              s === N.PremiumSubscriptionSKUs.TIER_2 &&
              null != Z &&
              [N.PremiumTypes.TIER_0, N.PremiumTypes.TIER_1].includes(Z);
          q && (V = y.default.Messages.BILLING_SWITCH_PLAN_UPGRADE);
          let J =
              null != Y &&
              Y.status !== _.SubscriptionStatusTypes.ACCOUNT_HOLD &&
              !(0, p.isNoneSubscription)(Y.planId) &&
              !q,
            Q = J
              ? null != k
                ? k
                : (function (e) {
                    let { ctaSubscriptionSkuId: t, currentPremiumType: i } = e,
                      n = null,
                      s = null;
                    if (
                      null != t &&
                    ...
                    let a =
                        null != t
                          ? N.PremiumSubscriptionSKUToPremiumType[t]
                          : null,
                    ...
                    return (
                      null != r && null != l && l < r
                        ? ((n =
                            y.default.Messages.APPLICATION_STORE_GET_PREMIUM),
                          (s =
                            y.default.Messages
                        ...
                        : null != a && null != i && a === i
                          ...
                          : null == a &&
                            null != i &&
                            i === N.PremiumTypes.TIER_2 &&
                            (s =
                              y.default.Messages
                                .PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP),
                      { disabledButtonText: n, disabledButtonTooltipText: s }
                    );
          ...
          function $(e) {
            ...
            return (0, n.jsxs)(g.default, {
              ...
              innerClassName: b.premiumSubscribeButton,
              color:
                s === N.PremiumSubscriptionSKUs.TIER_1
                ...
                (0, n.jsx)("span", {
                  ...
                  children:
                    null !==
                      (i =
                        null !==
                          (t = null == Q ? void 0 : Q.disabledButtonText) &&
                        void 0 !== t
                          ? t
                          : O) && void 0 !== i
                      ? i
          ...
          return (null == Q ? void 0 : Q.disabledButtonTooltipText) != null
            ? (0, n.jsx)(r.Tooltip, {
    ...
    504439: function (e, t, i) {
      ...
      var n = i("723251");
      function s(e) {
        let { detail: t = 1, pop: i = 1 } =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          { PI: s, min: a, max: l, cos: r, round: u } = Math,
          o = e[0] | (e[1] << 8) | (e[2] << 16),
          c = e[3] | (e[4] << 8),
          d = (63 & o) / 63,
          f = ((o >> 6) & 63) / 31.5 - 1,
          ...
          _ = (t, i, n) => {
            let s = [];
            for (let a = 0; a < i; a++)
              for (let l = a ? 0 : 1; l * i < t * (i - a); l++)
                s.push(
                  (((e[E + (N >> 1)] >> ((1 & N++) << 2)) & 15) / 7.5 - 1) * n
                );
            return s;
          },
          y = _(T, g, ((o >> 18) & 31) / 31 / 2),
          b = _(3, 3, (((c >> 3) & 63) / 63) * i),
          A = _(3, 3, (((c >> 9) & 63) / 63) * i),
          R = m ? _(5, 5, S) : [],
          x = (0, n.thumbHashToApproximateAspectRatio)(e),
          M = u(x > 1 ? 32 : 32 * x),
          P = u(x > 1 ? 32 / x : 32),
          O = new Uint8Array(M * P * 4),
          L = [],
          v = [];
        for (let e = 0, i = 0; e < P; e++)
          for (let n = 0; n < M; n++, i += 4) {
            let u = d,
              ...
              c = p,
              I = h;
            for (let e = 0, t = l(T, m ? 5 : 3); e < t; e++)
              L[e] = r((s / M) * (n + 0.5) * e);
            for (let t = 0, i = l(g, m ? 5 : 3); t < i; t++)
              v[t] = r((s / P) * (e + 0.5) * t);
            ...
            if (m)
              for (let e = 0, t = 0; e < 5; e++)
                for (let i = e ? 0 : 1, n = 2 * v[e]; i < 5 - e; i++, t++)
                  I += R[t] * L[i] * n;
            let S = u - (2 / 3) * o,
              E = (3 * u - S + c) / 2,
              N = E - c;
    ...
    594098: function (e, t, i) {
      ...
      var n,
        ...
        E = i("140802");
      function N(e) {
        let { size: t, mediaLayoutType: i, alt: n } = e,
          a = (0, c.default)();
        return (0, s.jsx)("div", {
      ...
      ((n = class extends a.PureComponent {
        render() {
          ...
          if (
            ...
            } else e = (0, s.jsx)(N, { size: k, mediaLayoutType: x, alt: p });
          }
          if (c) {
            let t = 0 !== k.width ? k.width / k.height : 1;
            null != a && "" !== a && n !== T.ImageReadyStates.ERROR
              ? (e = v({
                  src: a,
                  size: k,
                  alt: p,
              ...
              : n !== T.ImageReadyStates.LOADING &&
                (e = (0, s.jsx)(N, { size: k, mediaLayoutType: x, alt: p })),
                ...
                style: (function (e, t, i, n, s) {
                  return s === I.MediaLayoutType.MOSAIC
                    ? {
                        ...
                        margin: "auto",
                        width:
                          !i && e.width <= I.MEDIA_MOSAIC_MAX_WIDTH
                            ? e.width
                            : "100%",
                        height: "100%",
                      }
        ...
        zoomable: !0,
        children: e => {
          let { src: t, size: i, alt: n, className: a, mediaLayoutType: l } = e;
          return (0, s.jsx)("img", {
        ...
        switch (t) {
          case I.MediaLayoutType.MOSAIC:
            return {
              ...
              minWidth: "100%",
              minHeight: "100%",
              maxWidth: 1 === (0, p.default)() ? "calc(100% + 1px)" : "100%",
            };
          case I.MediaLayoutType.RESPONSIVE:
            return y(e);
          default:
    ...
    193513: function (e, t, i) {
      ...
      function m(e) {
        let {
          ...
          h = t === o.ImageReadyStates.LOADING,
          [S] = s.useState(() => Date.now()),
          [E] = s.useState(h),
          [N, _] = s.useState(!1),
          y = s.useMemo(() => {
            if (E && 1 === I && null != m) {
