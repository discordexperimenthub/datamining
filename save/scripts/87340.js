          ...
          return (0, i.jsxs)(u.ModalRoot, {
            ...
            children: [
              (0, i.jsxs)(u.ModalHeader, {
                separator: !1,
                children: [
                  (0, i.jsx)(g.default, { className: L.headerIcon, size: 24 }),
                  (0, i.jsx)(u.Heading, {
                    variant: "text-md/medium",
                    color: "header-primary",
                    children: x.default.Messages.CONNECTIONS_ROLES_CHANNEL_NAME,
                  }),
              ...
              (0, i.jsxs)(u.ModalContent, {
                ...
                children: [
                  (0, i.jsx)(u.Heading, {
                    ...
                    color: "header-primary",
                    children:
                      x.default.Messages.CONNECTIONS_ROLES_CHANNEL_CALL_TO_ACTION_LEARN_MORE.format(
                        {
                              ...
                              a =
                                (null == r ? void 0 : r.bot) != null
                                  ? (0, i.jsx)("img", {
                                      ...
                                      alt: "",
                                      className: l(L.botAvatar, P.avatar),
                                    })
                                  : null;
                            } else {
