(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["88755"],
  {
    977934: function (a, l, h) {
      ...
      ((t = e || (e = {})).PREMIUM_ACTIVATED = "PREMIUM_ACTIVATED"),
        (t.PREMIUM_UPDATED = "PREMIUM_UPDATED"),
        (t.PREMIUM_UPGRADED = "PREMIUM_UPGRADED"),
        (t.GUILD_BOOST_APPLIED = "GUILD_BOOST_APPLIED"),
        (t.PREMIUM_PAYMENT_STARTED = "PREMIUM_PAYMENT_STARTED");
      class L extends r.PureComponent {
        ...
        animate() {
          ...
          n.default
            .timing(this.animation, {
              toValue: 1,
              delay: p.DELAY[a],
              duration: p.DURATION[a],
            })
            .start();
        }
        getContainerStyle() {
          let { flashColor: a } = this.props,
            l = p.FLASH_TIME_PERCENT,
            h = p.FLASH_DURATION_PERCENT,
            e = (0, C.hexWithOpacity)(a, 0);
          return {
        ...
        render() {
          ...
          return (0, s.jsxs)("div", {
            className: c(u.container, a),
            children: [
              this.renderSvgBorder(),
              (0, s.jsxs)(n.default.div, {
        ...
        constructor(...a) {
          super(...a), (this.animation = new n.default.Value(0));
        }
      }
      function T(a) {
        let { theme: l, ...h } = a,
          e = (0, m.useToken)(d.default.unsafe_rawColors.WHITE_500).hex(),
          t = (0, m.useToken)(d.default.unsafe_rawColors.BRAND_500).hex(),
          r = (0, o.isThemeDark)(l) ? e : t;
        return (0, s.jsx)(L, { ...h, theme: l, flashColor: r });
      }
      (L.Types = e), (T.Types = e);
    },
  },
]);
//# sourceMappingURL=88755.bfb94e941c04c6fd995b.js.map
