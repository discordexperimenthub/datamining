    ...
    354588: function (e, t, r) {
      ...
      var i = r("414456"),
        ...
        d = e => {
          ...
          let { redeemableInDays: R = 0, tenureRewardSkuId: f } = C,
            S =
              o.TenureRewardSKUs.FREE_GUILD_BOOST_1_MONTH === f
                ? o.NUM_DAYS_REQUIRED_1_MONTH_VARIANT
                : o.NUM_DAYS_3_REQUIRED_MONTH_VARIANT,
            T = Math.min(S, Math.max(S - R, 0));
          return (0, n.jsx)("div", {
            ...
            children: (0, n.jsx)(a.default, {
              ...
              progressCircleStrokeSize: E,
              percentage: null != i ? i : (100 * T) / S,
              initialPercentage:
                null != i ? i : (100 * Math.max(T - 0.25 * S, 0)) / S,
...
//# sourceMappingURL=92719.a876aab3b13a198b6661.js.map
