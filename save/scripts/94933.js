      ...
      function g(e, t) {
        ...
        let i = d.default.getGuilds(),
          l = c.default.entries(i).some(e => {
            let [t, n] = e,
              i = (0, E.isGuildOnboardingSettingsAvailable)(t),
              s = n.hasFeature(T.GuildFeatures.GUILD_ONBOARDING_EVER_ENABLED);
            return i && s;
          });
        ...
        if (!A) return !1;
        let { showLifecycleUpsells: N } = f.default.getCurrentConfig(
      ...
      class o extends l.default {
        ...
        drainBuffer() {
          for (let e of this.batchBuffer)
            a.default.track(r.AnalyticEvents.ANNOUNCEMENT_MESSAGE_VIEWED, {
...
//# sourceMappingURL=94933.3bf4ec1f3331bd737b88.js.map
