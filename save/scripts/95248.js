  ...
  ["95248"],
  {
      ...
      function a(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            ...
            t &&
              o &&
              (0, i.jsx)(l.default, { onClick: n, className: r.removeButton }),
          ],
        });
      }
    },
    ...
    270161: function (e, t, n) {
      ...
      let r = l.Permissions.VIEW_CHANNEL,
        ...
        o = i.default.combine(r, s.MODERATE_STAGE_CHANNEL_PERMISSIONS);
    },
        ...
        E = e => {
          let [t, n] =
              e instanceof r.default
                ...
                : h(e),
            [s, u, E, C] = (0, l.useStateFromStoresArray)([a.default], () => [
    ...
    38766: function (e, t, n) {
      ...
      function u(e) {
        let {
          ...
          h = (0, i.useCallback)(() => {
            null != t && (0, r.initGuildIdentitySettings)(t, null != c ? c : f),
              s.default.open(
    ...
    300322: function (e, t, n) {
      ...
      function g(e) {
        return (0, r.useStateFromStoresObject)([C.default, h.default], () => {
          let t = C.default.getActiveJoinedThreadsForParent(e.guild_id, e.id),
            ...
            a = s(i).some(e => h.default.can(v.Permissions.VIEW_CHANNEL, e));
          return {
            hasActiveThreads: l || r || a,
            hasMoreActiveThreads: a || r,
          };
        });
      }
      function A(e) {
        let t = (0, r.useStateFromStores)([f.default], () =>
          ...
          i = (0, r.useStateFromStores)([d.default], () => d.default.getId());
        return (
      ...
      function M(e) {
        let t = (0, r.useStateFromStores)([h.default], () => L(e, h.default)),
          n = y(e);
        return x(e, t, n);
      }
      function R(e) {
      ...
      function y(e) {
        return (0, r.useStateFromStores)([h.default], () => j(e, h.default));
      }
      function w(e) {
        let t = (0, o.default)(),
          n = (0, r.useStateFromStores)([h.default], () =>
      ...
      var i = n("37983"),
        ...
        O = e => {
          ...
          let {
            ...
            Y = (0, l.useStateFromStores)([g.default], () => g.default.get(O)),
            K =
              null !==
                (n =
                  null == Y
            ...
            [J, X] = s.useState(!1);
          s.useEffect(() => {
            !r.default.get(L.WELCOME_EMOJI_TOOLTIP_STORAGE_KEY) &&
              setTimeout(() => X(!0), 300);
          }, []);
          let q = [];
          z.forEach(e => {
            let { channel: t } = e;
            I.default.canEveryoneRole(x.Permissions.VIEW_CHANNEL, t) &&
          ...
          let Q = () => {
            ...
            et = s.useCallback(() => {
              r.default.set(L.WELCOME_EMOJI_TOOLTIP_STORAGE_KEY, !0), X(!1);
            }, []);
          return (0, i.jsx)(u.default, {
            page: x.AnalyticsPages.CHANNEL_WELCOME_CREATE_MODAL,
    ...
    931138: function (e, t, n) {
      ...
      function c(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            (0, i.jsx)(o.default, { ...d, className: r(c, u.flowerStar) }),
            (0, i.jsx)("div", {
        ...
        o = (0, l.replaceIcon)(
          function (e) {
            let {
              ...
              foregroundColor: r = s.default.unsafe_rawColors.RED_400.css,
              foreground: o,
              background: u,
              ...c
            } = e;
    ...
    306160: function (e, t, n) {
      ...
      var i = n("281071"),
        ...
        l = n("50885");
      let r = (() => {
        if (s.isPlatformEmbedded) return null != l.default.copy;
        try {
          return (
      ...
      function a(e) {
        return (
          !!r && (s.isPlatformEmbedded ? (l.default.copy(e), !0) : i.copy(e))
        );
      }
    },
...
//# sourceMappingURL=0e5eacf33cde178e0300.js.map
