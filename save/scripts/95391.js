    ...
    145079: function (e, t, n) {
      ...
      var C = e => {
        ...
        return (0, i.jsx)(d.default, {
          ...
          botType: v(n),
          botVerified: n.isVerifiedBot(),
          discriminator: m || g !== _ ? null : null != o ? o : n.discriminator,
          ...h,
        });
      };
    },
    ...
    152475: function (e, t, n) {
      ...
      function E(e) {
        ...
        let { guild_id: h, channel_id: E } = e,
          ...
          m = C ? t.getDefaultChannel(e.guild_id) : n.getChannel(E),
          _ = i.getGuild(h),
          p = d.getStageInstanceByChannel(E);
        return (
          !!(0, l.canViewInviteModal)(o.default, _, m, p) &&
          null != m &&
          v(e, [n])
        );
      }
    ...
    833843: function (e, t, n) {
      ...
      function b(e) {
        let {
          ...
          m = (0, p.useIsChannelPublic)(null == l ? void 0 : l.id, t.id),
          _ = (0, M.default)({
            guild: n,
            channel: l,
      ...
      var P = e => {
        let {
          ...
          { guild: D, isMember: V } = (0, C.default)(w, P),
          O = (0, a.default)(n),
    ...
    360538: function (e, t, n) {
      ...
      function b(e) {
        let {
          ...
          { startTime: A, endTime: b } = (0, p.default)(t.id, E),
          P = (0, g.default)(t.guild_id, t.id, E),
          w = l.useCallback(
            e => {
              e.stopPropagation(),
          ...
          D = (0, _.default)(t);
        l.useEffect(() => {
          m.default.getGuildEventUserCounts(n.id, t.id, null != E ? [E] : []),
            m.default.getGuildEventsForCurrentUser(n.id);
        }, [n.id, t.id, E]);
        let V = (0, S.recurrenceRuleFromServer)(t.recurrence_rule);
        return (0, i.jsxs)("div", {
          ref: v,
          children: [
            (0, i.jsxs)("div", {
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                null != P && (0, i.jsx)(j, { userCount: P, onClick: c }),
                !h &&
                  null != D &&
    ...
    369404: function (e, t, n) {
      ...
      function M(e) {
        let {
          ...
          { scheduled_start_time: P, id: w, entity_type: D, guild_id: V } = L,
          { canManageGuildEvent: O } = (0, d.useManageResourcePermissions)(
            null != M ? M : t
          ),
          U = O(L),
          G = (0, p.default)(L),
          F = (0, S.useIsChannelPublic)(null == M ? void 0 : M.id, L.id),
                  ...
                  U &&
                    ...
                    (0, r.openModal)(e =>
                      (0, i.jsx)(r.ConfirmModal, {
                        ...
                        onConfirm: () => _.default.deleteGuildEvent(w, V),
            ...
            k || B
              ? function (e) {
                  if ((e.stopPropagation(), B)) {
                    null == b || b(), (0, u.openMemberVerificationModal)(V);
                    return;
                  }
                  (null == M ? void 0 : M.isGuildStageVoice())
                    ? ((0, f.connectAndOpen)(M), null == b || b())
              ...
              ? function (e) {
                  e.stopPropagation(),
                    (0, r.openModalLazy)(async () => {
                      ...
                      return t =>
                        (0, i.jsx)(e, { ...t, event: L, onSuccess: b });
                    });
                }
              : void 0,
          ...
          onEndClick:
            U && D === x.GuildScheduledEventEntityTypes.EXTERNAL && y
              ? function (e) {
                  ...
                  let t = () => {
                    _.default.endEvent(w, V), (0, r.closeAllModals)();
                  };
                  (0, r.openModal)(e =>
                    (0, i.jsx)(r.ConfirmModal, {
                      ...e,
      ...
      let c = {
        ...
        v = e => {
          let [t, n] =
            ...
            m = i.useCallback(e => f(e, C, o, l), [l, o, C]),
            _ = i.useCallback(e => f(e, C, E, v), [E, v, C]);
          return null == e
            ? c
            : {
      ...
      let h = {
        ...
        v = e => {
          let {
            ...
            S = t;
          if ((!0 === _ ? (S = h.DOWN) : !1 === _ && (S = h.RIGHT), g)) {
            let e = {
...
//# sourceMappingURL=4751acd012904194f978.js.map
