  ...
  ["968"],
  {
      ...
      var T = {
        initBasic() {
          f.addListener(this.handleSystemPrefersReducedMotionChanged),
            ...
            S.addListener(this.handleSystemPrefersContrastChanged),
        ...
        handleSystemColorPreferencesChanged() {
          ...
          h.matches
            ? (e = c.ThemeTypes.DARK)
            : _.matches && (e = c.ThemeTypes.LIGHT);
        ...
        handleSystemPrefersContrastChanged() {
          let e = "no-preference";
          E.matches ? (e = "more") : S.matches && (e = "less"),
            s.default.wait(() => {
        ...
        p = new l.default(
          function (e) {
            ...
            return (
              null != e.viewers && (t = 2),
              [
                C.BROADCASTS_BY_USER_ID(e.userId),
                C.BROADCASTS_BY_CHANNEL_ID(e.channelId),
                C.BROADCASTS_BY_VALIDITY(t),
              ]
            );
          },
          e => e.channelId
      ...
      var A = new g(u.default, {
        ...
        BROADCASTER_BUCKETS_RECEIVED: function (e) {
          ...
          Object.keys(t).forEach(e => {
            c.CAN_VIEW_BROADCASTS_BUCKETS.includes(t[e]) ? E.add(e) : S.add(e),
              h.clear(),
              (_ = [...h]);
            let n = p.get(e);
        ...
        BROADCAST_VIEWERS_UPDATE: function (e) {
          ...
          Object.entries(t).forEach(e => {
            let [t, n] = e,
              a = p.get(t);
            null != a && p.set(t, { ...a, viewers: n });
          });
        },
        CHANNEL_RECIPIENT_ADD: function (e) {
          let { channelId: t, user: n } = e,
            a = p.values(C.BROADCASTS_BY_CHANNEL_ID(t))[0];
          if (
            null == a ||
            null == a.viewers ||
            ...
            return !1;
          p.set(a.userId, { ...a, viewers: [...a.viewers, new o.default(n)] });
        },
        ...
        CHANNEL_CREATE: function (e) {
          var t;
          let { channel: n } = e,
            a = p.values(C.BROADCASTS_BY_CHANNEL_ID(n.id))[0];
          if (null == a) return !1;
    ...
    836087: function (e, t, n) {
      ...
      function I(e, t) {
        switch (e) {
          ...
          case T.ParticipantTypes.STREAM:
            return A.default.Messages.SPECTATORS.format({ numViewers: t });
          default:
                ...
                children: t.map(e =>
                  (0, a.jsx)(
                    _.default,
                    {
                      ...
                      className: i(v.memberListItem, { [v.popoutDisabled]: n }),
      ...
      function M(e) {
        ...
        return (0, a.jsx)(c.TooltipContainer, {
          ...
          children: (0, a.jsxs)("div", {
            ...
            children: [
              (0, a.jsx)(C.default, { className: v.viewersIcon }),
      ...
      function L(e) {
        let {
          ...
          [I, L] = r.useState(!1),
          N = r.useRef(new d.DelayedCall(150, () => L(!1))),
          y = (0, o.useStateFromStoresArray)(
            ...
            () => {
              if (l.type === T.ParticipantTypes.STREAM) {
                ...
                return e.length > 0
                  ? e.map(e => h.default.getUser(e)).filter(p.isNotNullish)
                  : O;
              }
              return l.type === T.ParticipantTypes.ACTIVITY
        ...
        return (
          y.length > A &&
            (w[w.length - 1] = (0, a.jsxs)(
              "div",
              { className: v.overflow, children: ["+", y.length - A + 1] },
              "overflow"
            )),
          (0, a.jsx)(E.default, {
    ...
    976074: function (e, t, n) {
      ...
      function c(e, t, c) {
        ...
        let E = (0, l.useGetStreamApplication)(e),
          ...
          _ =
            null !== (f = o.default.getVideoStats(h)) && void 0 !== f ? f : {},
          C = {
    ...
    856343: function (e, t, n) {
      ...
      function p(e, t) {
        let {
          ...
          g = (0, s.useStateFromStores)([f.default], () =>
            f.default.getGoLiveSource()
          ),
          A = (0, s.useStateFromStores)([E.default], () =>
        ...
        let M =
            p === h.ApplicationStreamPresets.PRESET_DOCUMENTS
    ...
    967889: function (e, t, n) {
      ...
      function m() {
        let [e, t] = r.useState(!1),
          n = (0, s.useStateFromStores)([u.default], () => {
            var e;
            return (0, o.probablyHasBuildOverride)()
              ? null === (e = u.default.getCurrentBuildOverride().overrides) ||
                void 0 === e
                ? void 0
                : e.discord_web
              : null;
      ...
      class T extends r.PureComponent {
        ...
        triggerSoftCrash(e, t) {
          ...
          let a = S.default.captureCrash(e, { extra: t });
    ...
    160139: function (e, t, n) {
      ...
      let I = e => g.default.close(e),
        ...
        M = (e, t) => {
          (0, m.isMac)() && !t.altKey
            ? g.default.fullscreen(e)
            : g.default.maximize(e);
        },
        O = e => {
        ...
        L = e => {
          ...
          return (0, a.jsxs)(l.Clickable, {
            className: s(
              r ? v.typeMacOSWithFrame : v.typeMacOS,
              t ? v.focused : v.unfocused,
              (0, T.getThemeClass)(i),
            ...
            children: [
              o.default.window.USE_OSX_NATIVE_TRAFFIC_LIGHTS
                ? (0, a.jsx)("div", { className: v.macDragRegion })
                : (0, a.jsxs)("div", {
                    ...
                    children: [
                      (0, a.jsx)(l.Clickable, {
                        ...
                        "aria-label": A.default.Messages.TITLE_BAR_CLOSE_WINDOW,
                        tabIndex: -1,
                        children: (0, a.jsx)(S.default, { color: "#4c0000" }),
                      }),
                      (0, a.jsx)(l.Clickable, {
                        className: v.macButtonMinimize,
                        onClick: () => R(n),
                        "aria-label":
                          A.default.Messages.TITLE_BAR_MINIMIZE_WINDOW,
                        tabIndex: -1,
                        children: (0, a.jsx)(p.default, { color: "#975500" }),
                      }),
                      (0, a.jsx)(l.Clickable, {
                        className: v.macButtonMaximize,
                        onClick: e => M(n, e),
                        "aria-label":
                          A.default.Messages.TITLE_BAR_FULLSCREEN_WINDOW,
                        tabIndex: -1,
                        children: (0, a.jsx)(_.default, { color: "#006500" }),
                      }),
                    ],
                  }),
              r
          ...
          e => {
            !(function (e, t) {
              ...
              let s =
                ...
                e.altKey ||
                e.metaKey ||
                (e.key !== h.KeyboardEventKey.Tab && e.shiftKey);
              if (s) return;
              let i = (function (e) {
                ...
                if (null != a) {
                  let e = E.keyToCode(a);
                  if (null != e)
                    return [[S.KeyboardDeviceTypes.KEYBOARD_KEY, e]];
                }
                return null;
              })(e);
              null != i &&
    ...
    51545: function (e, t, n) {
      ...
      let f = (0, u.filterThrottle)({ maxBudgetMinute: 1, maxBudgetHour: 3 });
      function E(e, t) {
        var n, a, i, u;
        if (
          (null != (n = e).exception &&
      ...
      function S() {
        ...
        a.init({
          ...
          a.setTag("buildNumber", ((e = "266893"), "266893")),
          a.setTag("builtAt", String("1708037559984"));
    ...
    448881: function (e, t, n) {
      ...
      var a = n("872717"),
        ...
        u = n("49111");
      async function o() {
        r.default.dispatch({ type: "QUESTS_FETCH_CURRENT_QUESTS_BEGIN" });
        try {
          let e = await a.default.get({
      ...
      async function d(e) {
        ...
        try {
          let e = await a.default.post({
            ...
            body: { stream_key: n, application_id: i },
          });
          r.default.dispatch({
      ...
      async function c(e) {
        ...
        if (!t) {
          r.default.dispatch({ type: "QUESTS_ENROLL_BEGIN", questId: e });
          try {
            let t = await a.default.post({ url: u.Endpoints.QUESTS_ENROLL(e) });
            r.default.dispatch({
              type: "QUESTS_ENROLL_SUCCESS",
              enrolledQuestUserStatus: (0, l.questUserStatusFromServer)(t.body),
            });
          } catch (t) {
            r.default.dispatch({ type: "QUESTS_ENROLL_FAILURE", questId: e });
          }
        }
      }
    ...
    2973: function (e, t, n) {
      ...
      function E(e, t) {
        ...
        if (null != r && null == r.claimedAt) {
          let n = { userStatus: { ...r, claimedAt: t.claimedAt } };
          f(e, n);
        }
      }
      function S(e) {
      ...
      var _ = new h(r.default, {
        ...
        QUESTS_ENROLL_SUCCESS: function (e) {
          ...
          f(t.questId, { userStatus: t }), S(t.questId);
        },
      ...
      function o(e) {
        ...
        return {
          ...
          config: {
            ...
            colors: { primary: (r = t.colors).primary, secondary: r.secondary },
    ...
    928741: function (e, t, n) {
      ...
      function c(e) {
        let { children: t } = e,
          ...
          { saturation: E, contrast: S } = (0, r.useStateFromStoresObject)(
            [i.default],
            () => ({
    ...
    951691: function (e, t, n) {
      ...
      function v(e) {
        ...
        let {
          ...
          M = f.default.supports(T.Features.DESKTOP_CAPTURE_APPLICATIONS),
          O =
            null !==
        ...
        return (0, a.jsx)(i.default, {
          ...
          children: (0, a.jsxs)(s.Menu, {
            ...
            "aria-label":
              null != O
                ? g.default.Messages.STOP_STREAMING
                : g.default.Messages.SHARE_YOUR_SCREEN,
            children: [
              (0, a.jsx)(s.MenuGroup, {
                children: L.map(e => {
    ...
    211019: function (e, t, n) {
      ...
      function C(e) {
        let { participant: t, width: n, noArt: r = !1, selected: C = !1 } = e,
          p = n < 195,
          m = (0, i.useStateFromStores)([o.default, d.default], () =>
        ...
        return (0, a.jsx)("div", {
          className: s(h.content, h.streamHidden, { [h.small]: p }),
          children: (0, a.jsx)(E.default, {
            ...
            description: C
              ? null
              : (0, a.jsxs)("div", {
                  className: s(h.streamHiddenCTA, { [h.largePaddingTop]: !p }),
                  children: [
                    (0, a.jsx)(f.CallTileCTA, {
                      ...
                      children: (0, a.jsx)(l.Text, {
                        ...
                        children:
                          n < 175
                            ? S.default.Messages.WATCH
                            : S.default.Messages.WATCH_STREAM,
                      }),
                    }),
                    m
                      ? (0, a.jsx)(f.CallTileCTA, {
                          className: h.addCTA,
                          tooltip:
                            S.default.Messages.STREAM_WATCH_MULTIPLE_TOOLTIP,
                          onClick: e => {
                            e.stopPropagation(),
    ...
    799808: function (e, t, n) {
      ...
      var r = n("77078"),
        ...
        S = n("686298");
      function h(e, t, h) {
        let _ = u.default.getWindowOpen(E.PopoutWindowKeys.CHANNEL_CALL_POPOUT)
          ? E.PopoutWindowKeys.CHANNEL_CALL_POPOUT
          : null;
        if (((0, l.default)(_), f.isPlatformEmbedded))
          (0, r.openModalLazy)(async () => {
            let { default: t } = await n.el("451863").then(n.bind(n, "451863"));
            return n =>
              (0, a.jsx)(t, { ...n, guildId: e, analyticsLocation: h });
          });
        else {
          var C;
          let n = (0, i.default)(
            S.ApplicationStreamPresets.PRESET_CUSTOM,
            S.ApplicationStreamResolutions.RESOLUTION_1080,
            S.ApplicationStreamFPS.FPS_30,
    ...
    54727: function (e, t, n) {
      ...
      function d(e) {
        let { centerButton: t = !1, channel: n, onClick: d, ...c } = e,
          ...
          S = (0, i.useIsBroadcastingInChannel)(n.id);
        return (0, a.jsx)(f, {
          ...c,
          onClick: () => {
            S && (0, s.stopBroadcast)(),
        ...
        let {
          ...
          h = r.useCallback(
            e => {
              let { className: t } = e;
              return s
                ? (0, a.jsx)(S, { className: t, isVertical: u })
    ...
    116439: function (e, t, n) {
      ...
      function E(e) {
        let {
          ...
          m = _ ? d.CenterControlButton : d.default;
        return (0, a.jsx)(f, {
          enabled: t,
          join: n,
          channel: r,
          ...
          children: e => {
            ...
            return (0, a.jsx)(m, {
              ...
              ...p,
              isActive: t,
              className: s(E, { [c.fauxDisabled]: n }),
              onPopoutClick: C,
            });
          },
        });
    ...
    457112: function (e, t, n) {
      ...
      var a = n("37983"),
        ...
        c = n("578549"),
        f = n("678016");
      let E = { top: 80, bottom: 132, left: 80 };
      class S extends r.PureComponent {
        ...
        getPosition(e) {
          ...
          let {
            ...
            S = Math.round(a),
            h = Math.round(i - s - this._width),
            _ = (0, u.getPlatform)(),
            C = _ !== u.PlatformTypes.WEB && this.inPopout ? 22 : 0;
          if (null != c) {
            var p, m;
            return {
              y:
                (null !== (p = null == c ? void 0 : c.y) && void 0 !== p
                  ? p
                  : 0) - C,
              x:
                null !== (m = null == c ? void 0 : c.x) && void 0 !== m ? m : 0,
            };
          }
          switch (e) {
      ...
      S.defaultProps = { hidden: !1, roundCorners: !0 };
      var h = r.memo(e => {
        let {
          selectedPIPWindow: t,
          pipWindows: n,
      ...
      var a = n("37983"),
        ...
        S = function (e) {
          let {
            ...
            m = null != S ? S : n,
            T = (0, l.default)(m, s.default.unsafe_rawColors.PRIMARY_800.css),
            g = (0, u.useCallBannerBackgroundExperiment)(
              !0,
              "VideoBackground-web"
            ).enabled,
            A = (0, c.default)(null != h ? h : ""),
            v =
              null == A
                ? void 0
                : A.getBannerURL({
          ...
          if (
            (r.useEffect(() => {
              null != h && g && (0, d.default)(h, void 0, { dispatchWait: !0 });
            }, [g, h]),
            null == n)
          )
            return null;
          let I = (0, a.jsx)(i.Avatar, {
            ...
            R = { ...t, backgroundColor: T };
          return (
            null != v &&
              C &&
              g &&
              ((R.backgroundImage = "url(".concat(v, ")")),
              (R.backgroundSize = "cover")),
            (0, a.jsx)("div", {
              style: R,
              className: E.background,
              children: _
                ? (0, a.jsx)(o.default, { shouldAnimate: C, children: I })
                : I,
            })
          );
        };
...
//# sourceMappingURL=968.561b421df809560d86f8.js.map
