  ...
  ["97895"],
  {
    ...
    152475: function (e, t, n) {
      ...
      function E(e) {
        ...
        let { guild_id: h, channel_id: E } = e,
          C = e.entity_type === f.GuildScheduledEventEntityTypes.EXTERNAL,
          _ = C ? t.getDefaultChannel(e.guild_id) : n.getChannel(E),
          m = i.getGuild(h),
          S = d.getStageInstanceByChannel(E);
        return (
          !!(0, l.canViewInviteModal)(o.default, m, _, S) &&
          null != _ &&
          v(e, [n])
        );
      }
    ...
    466148: function (e, t, n) {
      ...
      function o(e, t, n) {
        ...
        let o =
          null !==
            (i = (0, r.useStateFromStores)([s.default], () =>
              s.default.getGuildScheduledEvent(e)
            )) && void 0 !== i
            ? i
            : n;
        l(null != o, "Event must be defined"),
          (t = null != t ? t : (0, u.getNextRecurrenceIdInEvent)(o));
        let d = (0, a.default)(t, e);
        return c(o, d, t);
      }
      function d(e, t) {
    ...
    833843: function (e, t, n) {
      ...
      function P(e) {
        let {
          ...
          _ = (0, S.useIsChannelPublic)(null == l ? void 0 : l.id, t.id),
          m = (0, M.default)({
            guild: n,
            channel: l,
      ...
      var b = e => {
        let {
          ...
          { guild: D, isMember: V } = (0, C.default)(w, b),
          O = (0, a.default)(n),
          ...
          F = (0, d.useUID)(),
          [H, k] = l.useState(L.EventDetailSections.EVENT_INFO),
          B = (0, m.default)(b, I),
          Z = (0, _.default)(w, b, I),
        ...
        if (
          ...
          return null;
        let q = e => {
            e !== H && (e === L.EventDetailSections.RSVP_LIST && z(), k(e));
          },
          Q = null != I ? I : (0, g.getNextRecurrenceIdInEvent)(M);
                    ...
                    (0, i.jsx)(s.Slide, {
                      ...
                      children: (0, i.jsx)(R.default, {
                        ...
                        onClickInterestedCount: () =>
                          q(L.EventDetailSections.RSVP_LIST),
                        isHub: O,
                        containerRef: X,
                        recurrenceId: Q,
                        setRecurrenceId: T,
    ...
    360538: function (e, t, n) {
      ...
      function L(e) {
        var t;
        let { creator: n, guildId: l } = e,
          r = (0, a.useStateFromStores)(
            [c.default],
            () => c.default.getMember(l, n.id),
            [n, l]
          );
        return (0, i.jsxs)("div", {
          className: M.row,
          ...
          children: [
            ...
            (0, i.jsx)(u.Clickable, {
              ...
              children: (0, i.jsx)(u.Text, {
                ...
                variant: "text-sm/normal",
                children:
                  A.default.Messages.GUILD_EVENT_INTERESTED_COUNT.format({
                    count: t,
                  }),
              }),
            }),
      ...
      function P(e) {
        let {
          ...
          { startTime: A, endTime: P } = (0, S.default)(t.id, E),
          b = (0, g.default)(t.guild_id, t.id, E),
          w = l.useCallback(
            e => {
              e.stopPropagation(),
        ...
        let V = (0, p.recurrenceRuleFromServer)(t.recurrence_rule);
        return (0, i.jsxs)("div", {
          ref: v,
          children: [
            (0, i.jsxs)("div", {
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                null != b && (0, i.jsx)(j, { userCount: b, onClick: c }),
                !h &&
                  null != D &&
                  (0, i.jsx)(L, { creator: D, guildId: n.id }, D.id),
                null != t.description &&
                  (0, i.jsx)("div", {
            ...
            null != V && (0, i.jsx)("hr", { className: M.divider }),
            null != V &&
              (0, i.jsx)(N.default, {
                guildId: n.id,
                recurrenceRule: V,
    ...
    586403: function (e, t, n) {
      ...
      function c(e) {
        ...
        let { IconComponent: E, locationName: C } = v,
    ...
    403901: function (e, t, n) {
      ...
      function N() {
        return (0, i.jsx)(I, {
          children: (0, i.jsx)(a.Heading, {
            ...
            className: p.title,
            children:
              g.default.Messages.GUILD_EVENT_DETAILS_USER_LIST_EMPTY_TITLE,
          }),
        });
      }
      function T() {
        return (0, i.jsx)(I, {
          children: (0, i.jsx)(a.Heading, {
            ...
            children:
              g.default.Messages.GUILD_EVENT_DETAILS_USER_LIST_FETCH_ERROR,
          }),
        });
      }
      function x(e) {
        ...
        return (0, i.jsx)(i.Fragment, {
          children: (0, i.jsxs)("div", {
            ...
            children: [
              (0, i.jsx)("div", {
                className: r(p.listRowCircle, p.listAvatar),
                children: (0, i.jsx)(_.default, {
                  height: 14,
                  width: 14,
                  className: p.icon,
              ...
              (0, i.jsx)(a.Text, {
                ...
                children:
                  g.default.Messages.GUILD_EVENT_DETAILS_USER_LIST_REMAINING.format(
                    { userRemainCount: t }
                  ),
              }),
            ],
          ...
          : (0, i.jsx)(a.Popout, {
              ...
              children: (e, t) => {
                ...
                return (0, i.jsxs)(a.Clickable, {
                  className: r(p.listRow, p.interactiveRow, {
                    [p.selected]: c,
                  }),
      ...
      function y(e) {
        let {
          ...
          c = (0, m.default)(t.guild_id, t.id, l);
        if (s && 0 === r.length)
          return (0, i.jsx)(L, {
            height: d,
        ...
        if (null != o && 0 === r.length)
          return (0, i.jsx)(L, { height: d, children: (0, i.jsx)(T, {}) });
        let f = 0;
        return (
          r.length >= S.MAX_RSVP_USER_DISPLAY_COUNT &&
            c > S.MAX_RSVP_USER_DISPLAY_COUNT &&
            (f = Math.max(c - r.length, 0)),
          0 === r.length
            ? (0, i.jsx)(L, { height: d, children: (0, i.jsx)(N, {}) })
            : (0, i.jsx)(M, {
                children: (0, i.jsx)(A, {
                  eventUsers: r,
    ...
    369404: function (e, t, n) {
      ...
      function M(e) {
        let {
          ...
          { scheduled_start_time: b, id: w, entity_type: D, guild_id: V } = L,
          { canManageGuildEvent: O } = (0, d.useManageResourcePermissions)(
            null != M ? M : t
          ),
          U = O(L),
          G = (0, S.default)(L),
          F = (0, p.useIsChannelPublic)(null == M ? void 0 : M.id, L.id),
          ...
          B = (0, o.useShowMemberVerificationGate)(V),
          Z = (0, g.default)(j, w);
        function z(e) {
          e.stopPropagation(), (0, T.default)(w, j, V);
        }
        async function W(e) {
          e.stopPropagation(),
            await a.default.joinGuild(V),
            v.default.addConditionalChangeListener(() => {
              let t = v.default.getGuild(V);
              return null == t || (!y && z(e), Y(e), !1);
            });
        }
        function Y(e) {
          e.stopPropagation();
          let t = h.default.getDefaultChannel(V);
          (0, r.closeAllModals)(),
        ...
        return {
                  ...
                  U &&
                    ...
                    (0, r.openModal)(e =>
                      (0, i.jsx)(r.ConfirmModal, {
                        ...
                        onConfirm: () => m.default.deleteGuildEvent(w, V),
              ...
              ? function (e) {
                  e.stopPropagation(),
                    (0, r.openModalLazy)(async () => {
                      ...
                      return t =>
                        (0, i.jsx)(e, { ...t, event: L, onSuccess: P });
                    });
                }
              : void 0,
              ...
              if (!G || !F) {
                ...
                (0, _.copy)(e),
                  C.default.track(
                    ...
                    { guild_id: V, guild_scheduled_event_id: w }
                  );
                return;
              }
              (0, r.openModalLazy)(async () => {
          ...
          onEndClick:
            U && D === x.GuildScheduledEventEntityTypes.EXTERNAL && y
              ? function (e) {
                  if ((e.stopPropagation(), !U)) return;
                  let t = () => {
                    m.default.endEvent(w, V), (0, r.closeAllModals)();
                  };
                  (0, r.openModal)(e =>
                    (0, i.jsx)(r.ConfirmModal, {
                      ...e,
    ...
    649844: function (e, t, n) {
      ...
      function E(e) {
        let {
          ...
          O = (0, f.isPremiumExactly)(V, v.PremiumTypes.TIER_2);
        (0, r.openModalLazy)(
          async () => {
      ...
      let c = {
        ...
        v = e => {
          let [t, n] =
            ...
            _ = i.useCallback(e => f(e, C, o, l), [l, o, C]),
            m = i.useCallback(e => f(e, C, E, v), [E, v, C]);
          return null == e
            ? c
            : {
    ...
    300322: function (e, t, n) {
      ...
      function g(e) {
        let t = (0, s.useStateFromStores)(
          ...
          () =>
            h.default.can(
              r.default.combine(C.Permissions.CREATE_PRIVATE_THREADS),
              e
            ),
          [e]
        );
      ...
      function I(e, t, n) {
        return (
          !(
            ...
            (null != n &&
              (n.hasFlag(C.MessageFlags.HAS_THREAD) || (0, o.default)(n)))
          ) && !0
        );
      }
      function N(e) {
      ...
      let h = {
        ...
        v = e => {
          let {
            ...
            { enabled: g } = (0, d.useRedesignIconContext)(),
            p = t;
          if ((!0 === m ? (p = h.DOWN) : !1 === m && (p = h.RIGHT), g)) {
            let e = {
...
//# sourceMappingURL=3177ff6b212e53f2ac31.js.map
