      ...
      var I = new v(u.default, {
        ...
        BROADCASTER_BUCKETS_RECEIVED: function (e) {
          ...
          c.default.keys(t).forEach(e => {
            f.CAN_VIEW_BROADCASTS_BUCKETS.includes(t[e]) ? p.add(e) : E.add(e),
              C.clear(),
              (m = [...C]);
            let n = g.get(e);
    ...
    51545: function (e, t, n) {
      ...
      function u() {
        ...
        a.init({
          ...
          release: "discord_web-725fe7423a905af42d9b04c025bbc7a010321a5e",
          beforeSend: e => {
            var t, n;
            return !(
              (null != (t = e).exception &&
          ...
          a.setTag("buildNumber", ((e = "269296"), "269296")),
          a.setTag("builtAt", String("1709058694544"));
      ...
      var a = n("37983"),
        ...
        E = function (e) {
          let {
            ...
            I = (0, c.default)(null != C ? C : h.EMPTY_STRING_USER_ID),
            A =
              null == I
                ? void 0
                : I.getBannerURL({
...
//# sourceMappingURL=98346.464f75249a8cf0380615.js.map
