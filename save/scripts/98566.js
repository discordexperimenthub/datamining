    ...
    287850: function (e, t, r) {
      ...
      class z extends d.default.Store {
        initialize() {
          this.waitFor(m.default, b.default, A.default, E.default, y.default),
            this.syncWith([y.default, E.default], w);
        }
      ...
      var N = new z(f.default, {
        ...
        CHANNEL_UPDATES: function (e) {
          let { channels: t } = e;
          t.forEach(e => {
            ((0, _.isPrivate)(e.type) || C.has(e.id)) && C.set(e.id, x(e));
          });
        },
        ...
        MESSAGE_CREATE: function (e) {
          ...
          return null != s && C.set(t, x(s, r.id));
        },
...
//# sourceMappingURL=3afdda3a3483b0b9da2d.js.map
