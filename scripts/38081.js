(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["38081"],
  {
    ...
    629109: function (e, t, n) {
      ...
      m = n("412905");
      let { enable: E, isNotSupported: S, trackToggleSelfMute: g } = m;
      var A = {
        enable: E,
        toggleSelfMute() {
          let {
          ...
          return S()
            ? Promise.resolve()
            : (g({ usedKeybind: n }), d.default.isEnabled())
              ? s.default.dispatch({
        ...
        setQoS(e) {
          !S() && s.default.dispatch({ type: "AUDIO_SET_QOS", enabled: e });
        },
        reset() {
          !S() && s.default.dispatch({ type: "AUDIO_RESET" });
        },
        setSilenceWarning(e) {
          !S() &&
            s.default.dispatch({
                ...
                e => {
                  switch (e) {
                    ...
                    case l.UserMediaErrors.PERMISSION_DISMISSED:
                      ...
                      break;
                    default:
                      g(f.NativePermissionStates.ERROR),
                    ...
                    (s.src = n("89400")(
                      ...
                      (s.onloadeddata = () => {
                        (s.volume = Math.min(
                          ...
                          o.isPlatformEmbedded && s.setSinkId(p),
                          e(s);
                      }),
