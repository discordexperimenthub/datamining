(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
  ["94381"],
  {
        ...
        let i = d.default.getGuilds(),
          a = Object.entries(i).some(e => {
            let [t, n] = e,
              ...
              s = n.hasFeature(h.GuildFeatures.GUILD_ONBOARDING_EVER_ENABLED);
            return i && s;
          });
    ...
    427302: function (e, t, n) {
      ...
      class E extends s.Component {
        render() {
          let { popoutOpen: e } = this.state,
            ...
            l = {
              location: { ...n.location, object: h.AnalyticsObjects.LIST_ITEM },
            };
          return (0, i.jsx)(r.Popout, {
            preload: () =>
              (0, d.default)(t.id, t.getAvatarURL(a, 80), { guildId: a }),
            renderPopout: e =>
              (0, i.jsx)(c.default, {
                ...e,
                guildId: a,
          ...
          super(...e),
            ...
            (this.renderUserPopout = e => {
              ...
              return (0, i.jsxs)(f.default, {
                ...
                className: l(p.memberListItem, t, { [p.popoutDisabled]: n }),
                onContextMenu: s,
      ...
      E.defaultProps = { disablePopout: !1 };
      var T = (0, u.default)(E);
    },
